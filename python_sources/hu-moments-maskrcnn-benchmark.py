...
get_ipython().system('pip install ninja yacs cython matplotlib tqdm opencv-python')
...
os.chdir('apex')
get_ipython().system('python setup.py install --cuda_ext --cpp_ext')
os.chdir('..')

get_ipython().system('git clone https://github.com/facebookresearch/maskrcnn-benchmark.git')
