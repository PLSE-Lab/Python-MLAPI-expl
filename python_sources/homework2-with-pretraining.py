...
print(os.listdir('../working/cars_train_cut'))
...
PATH_TO_WEIGHTS = '../working/6-model-1.00-best_train_acc.pth'
...
import shutil
shutil.rmtree('../working/cars_test_cut')
# print(os.listdir('/kaggle/working/cars_test_cut/145'))

# print(os.path.isfile('/kaggle/working/cars_test_cut/145/05938.jpg'))

# im = cv2.imread('/kaggle/working/cars_test_cut/145/05938.jpg', 0)
# plt.imshow(im)
# plt.show()
