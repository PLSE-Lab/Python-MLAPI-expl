...
columns_to_drop = ["photos", "pred_0","pred_1", "pred_2", "description", "features", "created", "interest_level"]
X_train = X_train.drop(columns_to_drop, axis=1, errors="ignore")
