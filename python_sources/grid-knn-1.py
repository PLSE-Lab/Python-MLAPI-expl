...
def process_one_cell(df_train, df_test, grid_id, th):
    ...
    """   
    #Working on df_train
    df_cell_train = df_train.loc[df_train.grid_cell in [grid_id, grid_id+1, grid_id-1,grid_id-n_cell_x, grid_id-n_cell_x-1, grid_id-n_cell_x+1,grid_id+n_cell_x, grid_id+n_cell_x-1, grid_id+n_cell_x+1]]
