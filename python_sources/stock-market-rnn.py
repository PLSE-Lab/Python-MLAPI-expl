...
#  MinMaxScalar scales all the data to be in the region of 0 and 1. Reshape the training and test data to be in the shape [data_size, num_features].
...
# Different time periods of data have different value ranges, we normalize the data by splitting the full series into windows. If we don't do this, the earlier data will be close to 0 and will not add much value to the learning process. Here you choose a window size of 2500.
...
# 
# **Note:**  We should only smooth training data.
