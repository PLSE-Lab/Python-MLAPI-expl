...
# ### Thanks to this [notebook](https://www.kaggle.com/mgornergoogle/getting-started-with-100-flowers-on-tpu/) for support
...
# ## Maake sure that TPU is availible
...
# # For GPU go to the following link [Under Edit]
# https://www.kaggle.com/chekoduadarsh/resnet50-tpu-vs-gpu-benchmark-2?
