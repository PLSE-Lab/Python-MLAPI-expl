...
get_ipython().system('kaggle competitions download -c 2020-ai-exam-fashionmnist-2')
...
get_ipython().system('kaggle competitions submit -c 2020-ai-exam-fashionmnist-2 -f submission.csv -m "Message"')
