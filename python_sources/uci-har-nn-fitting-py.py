...
input_github_repository_path = "../input/repository/liushiyu1994-human_activity_detection-2b132af"

class config(object):
    data_direct = "{}/data".format(input_github_repository_path)
    ...
    nn_model_dir = "{}/nn_model".format(output_model_dir)
    if not os.path.isdir(nn_model_dir):
        os.mkdir(nn_model_dir)
