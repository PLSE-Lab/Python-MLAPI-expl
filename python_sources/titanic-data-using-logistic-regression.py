...
titanic_data['Embarked']=titanic_data['Embarked'].replace(np.nan,mode)
...
predicting=pd.DataFrame({'PassengerId':titanic_data["PassengerId"].iloc[:179,],'predictions':predictions})
predicting.head(20)
