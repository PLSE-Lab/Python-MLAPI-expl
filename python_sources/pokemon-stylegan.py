...
get_ipython().system('cd /kaggle/input/pokemon-ab-merged/pokemon-merged/pokemon-merged/')
...
path ="/kaggle/input/pokemon-ab-merged/pokemon-merged/pokemon-merged/"
# path ="/kaggle/input/oneshotpokemon/kaggle-one-shot-pokemon/kaggle-one-shot-pokemon/pokemon-a/"
...
# Note: increased max training epoch to 20k, increased dataset to work with AB
