...
# In this kernel, I will demonstrate the classification of chest X-ray images for pneumonia or normal. This is a binary image classification dataset. I will use TensorFlow Hub ResNet-50 transfer learning.
# 
...
# # Deep Learning Model with TF Hub
...
for epoch in range(epochs):
    ...
    for i in range(0, df_test.shape[0], 16):
        ...
        test_batch_logits = sess.run([logits], feed_dict={X:test_images[start_index:end_index],                                                    Y:test_labels[start_index:end_index], is_train:False})
