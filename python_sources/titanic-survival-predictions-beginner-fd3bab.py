...
# uiAs predicted, people with higher socioeconomic class had a higher rate of survival. (62.9% vs. 47.3% vs. 24.2%)
...
# The `simplify_ages` function above I got from [here](http://https://www.kaggle.com/jeffd23/scikit-learn-ml-from-start-to-finish).
# 
...
train[train["Embarked"] == "S"].shape[1]
...
# I decided to use the Support Vector Machines model for the testing data.
