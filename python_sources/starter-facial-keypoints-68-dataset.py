...
# 
# ![facial keypoints](https://github.com/tarunk04/P1_Facial_Keypoints/blob/master/images/key_pts_example.png?raw=true)
# Facial keypoints (also called facial landmarks) are the small magenta dots shown on each of the faces in the image above. In each training and test image, there is a single face and 68 keypoints, with coordinates (x, y), for that face. These keypoints mark important areas of the face: the eyes, corners of the mouth, the nose, etc. These keypoints are relevant for a variety of tasks, such as face filters, emotion recognition, pose recognition, and so on. Here they are, numbered, and you can see that specific ranges of points match different portions of the face.
# 
# <img width="500"   src="https://github.com/tarunk04/P1_Facial_Keypoints/blob/master/images/landmarks_numbered.jpg?raw=true">
...
keypoints_dict = {f: np.asarray(df_keypoints[df_keypoints["Unnamed: 0"] == f]                                .iloc[:,1:])                                .reshape([ 68, 2])
...
# ### Let's check 1st file: /kaggle/input/test_frames_keypoints.csv
...
# ### Let's check 2nd file: /kaggle/input/training_frames_keypoints.csv
