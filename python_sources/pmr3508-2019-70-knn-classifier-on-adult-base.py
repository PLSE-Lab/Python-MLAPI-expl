...
# ### Bonus : my resultst for the costa Rica base :

# In[ ]:


costaRicaResults = pd.read_csv('../input/pmr3508-2019-70-costarica/results.csv', names=["Id","Target"])
costaRicaResults.head(21)


# In[ ]:


myDf = pd.DataFrame(costaRicaResults) 
myDf.to_csv('costaRicaResults.csv',
             index=False, sep=',', line_terminator = '\n', header = ["Id","Target"])
