...
# im fixing the stupid NAN problem for sex LOL
...
# **SOOO apparently adding the fmaily size will increase the accuracy on the training set? LOL well theres no crossvalidation so idk**
