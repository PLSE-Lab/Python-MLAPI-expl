...
get_ipython().system('wget https://github.com/samrelins/tanda_search_qa_tool/archive/master.zip')
get_ipython().system('unzip master.zip')
get_ipython().system('wget https://wqa-public.s3.amazonaws.com/tanda-aaai-2020/models/tanda_roberta_base_asnq.tar')
get_ipython().run_line_magic('mkdir', 'tanda_roberta_base_asnq')
get_ipython().system('tar xvf tanda_roberta_base_asnq.tar')
get_ipython().run_line_magic('mv', '/kaggle/working/models /kaggle/working/tanda_roberta_base_asnq/')
get_ipython().run_line_magic('mv', '/kaggle/working/tanda_search_qa_tool-master/* /kaggle/working/')
get_ipython().run_line_magic('rm', '-rf tanda_roberta_base_asnq.tar master.zip')
...
get_ipython().run_line_magic('rm', '-rf *')

get_ipython().run_line_magic('cp', '../input/hospital-infrastructure-to-prevent-outbreaks/what_are_ways_to_create_hospital_infrastructure_to_prevent_nosocomial_outbreaks.csv /kaggle/working')
get_ipython().run_line_magic('cp', '../input/management-of-patients-who-are-underhoused/management_of_patients_who_are_underhoused_or_otherwise_lower_social_economic_status.csv /kaggle/working')
get_ipython().run_line_magic('cp', '../input/methods-to-control-spread-in-communities/methods_to_control_the_spread_in_communities.csv /kaggle/working')
get_ipython().run_line_magic('cp', '../input/modes-of-communicating-with-target-communities/modes_of_communicating_with_target_high_risk_populations.csv /kaggle/working')
