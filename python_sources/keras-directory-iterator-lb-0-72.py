...
# ## Some statistics about the training/validation files
...
# We can now create a submission file.
...
# Let us view the first 20 predictions:
...
# and listen to a couple of them.
