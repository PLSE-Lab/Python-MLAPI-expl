...
# Test different alphas
alphas = np.logspace(start=-4,stop=1,base=10,num=30)
...
p_dict = {'colsample_bytree': 0.8, 'gamma': 0, 'learning_rate': 0.03, 'max_depth': 5, 'min_child_weight': 4, 'n_estimators': 1000, 'objective': 'reg:linear', 'silent': 1, 'subsample': 0.7}
