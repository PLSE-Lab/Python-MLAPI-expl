...
dt = RandomForestClassifier(criterion = "gini", random_state = 123)
params = {"n_estimators": [450], "max_depth": [21]}
grid = GridSearchCV(dt, params, scoring = "log_loss", cv = 1, n_jobs = -1)

grid.fit(train, label)
del train, label, params
