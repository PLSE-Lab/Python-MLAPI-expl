...
# ## In this kernel minor change was made 
# boosting type *gbdt* to *dart*

# ## Please upvote the original kernel [Simple LightGBM LB 1.24](https://www.kaggle.com/isaienkov/lightgbm-fe-1-19) by [Kostiantyn Isaienkov](https://www.kaggle.com/isaienkov)
...
params = {
            'boosting_type': 'dart', #'boosting_type': 'gbdt', #-> 1.19
