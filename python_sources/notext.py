...
print(os.listdir( "../input/level_1_test/kaggle_level_1"))
...
print(os.listdir("../input/'sample_submission_level_1.csv'"))
...
sn_mse.fit(X_scaled_train, Y_train, epochs=1000, learning_rate=0.025, loss_fn="mse", display_loss=True)
...
sn_ce = SigmoidNeuron()
sn_ce.fit(X_scaled_train, Y_train, epochs=1000, learning_rate=0.025, loss_fn="ce", display_loss=True)
