...
myquery = """SELECT COUNT(consecutive_number), 
...
accidents_by_hour = accidents.query_to_pandas_safe(myquery)
...
myquery1 = """SELECT registration_state_name, COUNT(hit_and_run) 
...
hit_run_bystate = accidents.query_to_pandas_safe(myquery1)
print (hit_run_bystate)
