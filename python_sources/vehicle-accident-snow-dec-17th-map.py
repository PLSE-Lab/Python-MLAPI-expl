...
# Just this year
d=d[(d.timeStamp >= "2016-12-17 00:00:00") & (d.timeStamp < "2016-12-18 00:00:00")]
# Cheltenham
...
<html>
  ...
  <body>
    ...
    <div id="pano" class="main-container"></div>
    <script>

      function initialize() {
        var myloc = { lat: 40.072560, lng: -75.123096};
...
tailV = """
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA0wJsknjKk5pkO2aOqsIGkSNcELPjc830&callback=initialize">
    </script>
  </body>
</html>
