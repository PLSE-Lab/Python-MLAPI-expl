...
print(os.listdir("../input/xr_wrist_train"))


# In[ ]:


TRAIN_DIR = "../input/xr_wrist_train/XR_WRIST_TRAIN"
TEST_DIR = "../input/xr_wrist_valid/XR_WRIST_VALID"
...
vgg_con = VGG19(weights='imagenet', include_top=False, input_shape=(IMG_SIZE, IMG_SIZE, 3))
...
model.fit(x, y, validation_split=0.2, epochs=80)
