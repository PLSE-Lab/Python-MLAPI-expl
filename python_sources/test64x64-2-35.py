...
def create_model(inputSize):
    ...
    model.add(Convolution2D(24, 3, 3, activation='relu', dim_ordering='th', init='he_uniform'))
    model.add(Dropout(0.5))
    model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2), dim_ordering='th'))
    model.add(ZeroPadding2D((1, 1), dim_ordering='th'))
    model.add(Convolution2D(48, 3, 3, activation='relu', dim_ordering='th', init='he_uniform'))
    model.add(Dropout(0.5))
    model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2), dim_ordering='th'))
...
if __name__ == '__main__':
   ...
   #----------------------------------------------------------------------------------------------------
    ...
    model.fit(train_data, train_target, batch_size=14, nb_epoch=16,validation_split=1/15)
