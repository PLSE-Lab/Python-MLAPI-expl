...
# Below framework helps you in defining and streamlining forward, loss computing and early stopping functions among others. Helps you incorporate other models of your choice.

# # References:
# 1. Abhishek Thakur's youtube video: https://youtu.be/WaCFd-vL4HA
# 2. WTFML library: https://github.com/abhishekkrthakur/wtfml
# 3. EfficientNet: https://github.com/lukemelas/EfficientNet-PyTorch
...
# 
# 3. Incorporate patient data as well with this
