...
# **Map of Food Carts in San Francisco**
...
# end secret_token
train = pd.read_csv('../input/sf-mobile-food-facility-permit-and-schedule/mobile-food-facility-permit.csv', nrows = 300_000)
train2 = pd.read_csv('../input/sf-mobile-food-facility-permit-and-schedule/mobile-food-schedule.csv', nrows = 300_000)
...
target = train['FacilityType']
data = [go.Histogram(x=target)]
layout = go.Layout(title = "Number of Food Trucks per Type")
