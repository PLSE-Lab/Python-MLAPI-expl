...
def read_train_test():
    ...
    app['app_active_sum'] = app.groupby(['event_id'])['is_active'].transform('sum')
    app_small = app[['event_id', 'appcounts','app_active_sum']].drop_duplicates('event_id', keep='first')
    ...
    e1.loc[e1.isnull()['app_active_sum']==True,'app_active_sum'] = 0
    e1['appcounts1'] = e1.groupby(['device_id'])['appcounts'].transform('sum')
    e1['app_sum_active'] = e1.groupby(['device_id'])['app_active_sum'].transform('sum')
    e1['app_active_rate'] = e1['app_sum_active'] /e1['appcounts1']
    e1_small = e1[['device_id', 'appcounts1','app_sum_active','app_active_rate']].drop_duplicates('device_id', keep='first')
