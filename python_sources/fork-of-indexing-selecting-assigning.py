...
pd.Series(reviews.description.iloc[0:10])
...
get_ipython().system('[](http://)![[](http://)](http://)![[](http://)](http://)![](http://)![](https://i.imgur.com/sHZvI1O.png)')
...
reviews.country[((reviews.country =='France')| (reviews.country == 'Italy')) & (reviews.points>=90)]
