...
test = test.drop(['Sex', 'Embarked', 'Title', 'AgeGroup'], axis=1)
...
train = train.drop(['Survived', 'Ticket', 'Cabin', 'Fare', 'Name', 'PassengerId', 'Age'], axis=1)
test = test.drop(['Ticket', 'Cabin', 'Fare', 'Name', 'PassengerId', 'Age'], axis=1)
