...
# # Visualization
# In order to visualizate data we are going to use seaborn plots . Do not forget we are not selecting feature, we are trying to know data like looking at the drink list at the pub door.
