...
dir_data = "/kaggle/input/dataset1/dataset1"
dir_seg = dir_data + "/annotations_prepped_train/"
dir_img = dir_data + "/images_prepped_train/"

VGG_Weights_path = "/kaggle/input/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5"

## seaborn has white grid by default so I will get rid of this.
sns.set_style("whitegrid", {'axes.grid' : False})
  
# specifying the zip file name 
#file_name = "/content/dataset1.zip"
