...
# **FE & EDA from the kernel [Location EDA with rusher features](https://www.kaggle.com/dandrocec/location-eda-with-rusher-features)**
# 
# **Technology for feature importance building from the my kernel [Feature importance - xgb, lgbm, logreg, linreg](https://www.kaggle.com/vbmokin/feature-importance-xgb-lgbm-logreg-linreg)**
...
# Thanks to [Location EDA with rusher features](https://www.kaggle.com/dandrocec/location-eda-with-rusher-features)
