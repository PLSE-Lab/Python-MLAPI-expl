...
# If you consider training a classification approach on a patch level, one possible way is to prepare patch coordinates and targets in advance. Than use this data as an input into Dataset.
