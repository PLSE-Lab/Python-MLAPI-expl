...
df_train = pd.read_csv('../input/train.csv', encoding="ISO-8859-1") #remove limits
df_test = pd.read_csv('../input/test.csv', encoding="ISO-8859-1") #remove limits
df_pro_desc = pd.read_csv('../input/product_descriptions.csv') #remove limits
