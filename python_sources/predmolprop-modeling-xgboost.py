...
model_1JHN,_,_=SingleRun(train_sample,features,test_size=0.2,model_fn=XGBRegressor,includeType=False,early_stopping_rounds=5,
...
ax=xgboost.plot_importance(model_1JHN,importance_type='weight',show_values=False,log=True)
fig = ax.figure
fig.set_size_inches(5, 10)
...
ax=xgboost.plot_importance(model_1JHN,importance_type='cover',show_values=False,log=True)
fig = ax.figure
fig.set_size_inches(5, 10)
