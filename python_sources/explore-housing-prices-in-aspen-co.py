...
#                           'City_Zhvi_SingleFamilyResidence','City_Zhvi_Condominum']
    final_df.columns = ['City_Zhvi_2bedroom',
                          'City_Zhvi_4bedroom','City_Zhvi_AllHomes',
                          'City_Zhvi_SingleFamilyResidence','City_Zhvi_Condominum']
    final_df['Date'] = final_df.index
    return final_df

def plot_two_columns_using_plotly_regular(dataframe,column_one,column_two,title):    
    '''
    This function plots two numerical columns against a date column.
...
def plot_two_columns_using_plotly_express(dataframe,column_one,column_two,title):    
    '''
    This function plots two numerical columns against a date column.
    It using the plotly express library instead of the normal plotly library.
    '''
    df_melt = dataframe.melt(id_vars='Date', value_vars=[column_one,column_two])
...
aspen_df = load_zillow_data(state='CO',county='Pitkin County',
                              region='Aspen',city='Glenwood Springs')
...
aspen_df[['City_Zhvi_SingleFamilyResidence','City_Zhvi_AllHomes']].plot(title='Median Prices of Homes in Aspen,CO',figsize=(12,9), grid=True)


# *Step 5: Plot median house prices*
...
plot_two_columns_using_plotly_regular(aspen_df,'City_Zhvi_SingleFamilyResidence',
                                        'City_Zhvi_AllHomes','Median Home Prices in Aspen, CO')
...
plot_two_columns_using_plotly_express(aspen_df,'City_Zhvi_SingleFamilyResidence','City_Zhvi_AllHomes','Median Home Prices in Aspen, CO')
