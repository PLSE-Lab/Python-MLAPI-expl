...
# # INTRODUCTION
# 
# We have a data which classified if patients have heart disease or not according to features in it. We will try to use this data to do exploratory data analysis and create a model which tries predict if a patient has this disease or not. We will use logistic regression (classification) algorithm. Thanks to Caner Dabakoglu for his kernel which I have used. 
