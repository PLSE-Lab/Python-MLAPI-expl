...
# opt_parameters = {'colsample_bytree': 0.90, 'min_child_samples': 90, 'num_leaves': 17, 'subsample': 0.94}
...
# {'colsample_bytree': 0.88, 'min_child_samples': 90, 'num_leaves': 16, 'subsample': 0.98} # 0.44

# {'colsample_bytree': 0.88, 'min_child_samples': 90, 'num_leaves': 16, 'subsample': 0.94}
#                  'bagging_fraction': 0.8, 'lambda_l1': 5.0, 'lambda_l2': 3.0, 'max_depth': 9,
#                  'min_child_weight': 49.99999998574813,'min_split_gain': 0.09999999442117728}
...
for i in range(24):
    clf = lgb.LGBMClassifier(max_depth=-1, learning_rate=0.1, objective='multiclass',
                             ...
                             n_jobs=4, n_estimators=8000, class_weight='balanced')
