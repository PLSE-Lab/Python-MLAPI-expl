...
# This kernel is a copy of captcha with pytorch from Gakki
...
print(len(os.listdir("../input/kaggle/Train/")))
...
class Mydataset(Dataset):
    def __init__(self, path, is_train=True, transform=None):
        self.path = path
        if is_train: self.img = os.listdir(self.path)[:250]
        else: self.img = os.listdir(self.path)[251:]
