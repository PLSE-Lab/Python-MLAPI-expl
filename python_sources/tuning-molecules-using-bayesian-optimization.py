...
# The Entire credit goes to Sergii for this kernel: (Please upvote his kernel. I am trying to use Bayesian Optimization to tune in hyper parameters
# 
...
# #### lets add Bayesian Optimization for Hyper parameters.
...
#Now we have optimized Hyper params
Random_Seed = 4520
LGB_PARAMS = {
