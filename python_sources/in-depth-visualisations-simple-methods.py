...
# This notebook presents a profound exploratory analysis of the dataset in order to demonstrate different visualization techniques as well as provide understanding of the dependencies and interesting facts. 
# 
# 
# Four ML techniques are used to do prediction: RandomForest, LogisticRegression, KNeighbours and the Ensemble.
# 
# Logistic Regression performed the best with a score of 0.799.
# 
# 
# UPDATE1: XGBoost was added
# 
# UPDATE2: The calculation of the values to be imputed should ONLY be done on train set and not on test set or both.  
# 
# *****************
