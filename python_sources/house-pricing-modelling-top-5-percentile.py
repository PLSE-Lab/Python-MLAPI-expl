...
# 
# 
# This code has been developed with the help of lot of kernels available public in this competition. Thanks you all for the contributions.
...
#'MSSubClass',
catcols
# these columns are used for label encoding
...
#data_input_drop_out.GarageYrBlt
...
#V51 - 0.0622346286049821 added quality
...
results.to_csv('../working/submissionslassooutlierremoval6.csv',index=False)
