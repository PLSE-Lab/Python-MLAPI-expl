...
fashion_model.compile(loss=keras.losses.categorical_crossentropy, optimizer='adam',metrics=['accuracy'])# Your code to compile the model in this cell
...
fashion_model.fit(x,y,batch_size=100, epochs=4, validation_split=0.2)# Your code to fit the model here
