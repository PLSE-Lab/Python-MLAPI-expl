...
# In this kernel I've added log-transform for some skewed distance features and encoder for atom_index features
...
input_features = atom_features + distance_features
...
for mol_type in mol_types:
    ...
    input_data = FeatureTransformer().transform(
        dataset=pd.concat([df_train_.loc[:,input_features], df_test_.loc[:,input_features]]),
        ohe_features=atom_features,
        continuous_features=distance_features
    )
