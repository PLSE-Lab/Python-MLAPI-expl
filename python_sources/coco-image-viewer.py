...
instances_json_path = "/kaggle/input/cocosynth-for-here-we-grow/cocosynth-master/cocosynth-master/datasets/box_dataset_synthetic_complete/output/coco_instances.json"
