...
df_train = pd.read_csv('../input/dsacompdec/dataset_treino.csv')
df_test = pd.read_csv('../input/dsacompdec/dataset_teste.csv')
...
submission1 = pd.read_csv('../input/dsacompdec/dataset_teste.csv')
...
submission2 = pd.read_csv('../input/dsacompdec/dataset_teste.csv')
...
submission = pd.read_csv('../input/dsacompdec/dataset_teste.csv')
