...
# Your code here
df = chess_games['winner'].value_counts() / len(chess_games)
print(df)
check_q1(df)
...
# Your code here
df = (chess_games.assign(n=0).groupby(['white_id', 'victory_status']).n.apply(len).reset_index())
print(df)
print(check_q3(df))
...
# Your code here
df = kepler.assign(n=0).groupby(['koi_pdisposition', 'koi_disposition']).n.count()
print(df)
print(check_q5(df))
...
# Your code here
df = (((wine_reviews['points'].dropna() - 80) / 4)
    .value_counts()
    .sort_index()
