...
import shutil
shutil.copy("../input/helper.py","helper.py")
shutil.copy("../input/problem_unittests.py","problem_unittests.py")
...
# load in data
import helper
data_dir = '../input/Seinfeld_Scripts.txt'
...
def token_lookup():
    ...
    """
    # TODO: Implement Function
    punctuation_map = {".":"||Period||",",":"||Comma||","\"":"||Quotation_Mark||",
...
# * initially I started with sequence length = 15, batch_size = 32, epoch = 15, learning_rate = 0.001, vocab_size = toal number of unique-vocabulary in text, output_size = 1, hidden_dim and output_size = 256 but i faced some error.
# * after that i change the number of output to vocab_size, and kept rest of the parameters unchanged, but the 
