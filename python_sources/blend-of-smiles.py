...
# **THIS KERNAL IS BLEND OF VGGs**
# 
# kernal used for blends are:-
# 1. https://www.kaggle.com/shivamsarawagi/wildimagedetection-0-875
# 2. https://www.kaggle.com/hsinwenchang/vggface-baseline-197x197
# 3. https://www.kaggle.com/arjunrao2000/kinship-detection-with-vgg16
# 4. https://www.kaggle.com/leonbora/kinship-recognition-transfer-learning-vggface
# 5. https://www.kaggle.com/janpreets/just-another-feature-extractor-0-824-lb
# 
# I will be blending same model with diffrent scores (somewhat) rather then diffrent models blends.
# 
# 
