...
# ### Let's check 1st file: /kaggle/input/googleplaystore_user_reviews.csv
...
df1 = pd.read_csv('/kaggle/input/googleplaystore_user_reviews.csv', delimiter=',', nrows = nRowsRead)
...
# ### Let's check 2nd file: /kaggle/input/googleplaystore.csv
...
df2 = pd.read_csv('/kaggle/input/googleplaystore.csv', delimiter=',', nrows = nRowsRead)
