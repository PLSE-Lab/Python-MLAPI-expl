...
# **Plot distribution plots of each feature for each class (0 and 1)**
...
# **Plot heatmaps representing the distribution of features in class 0**
...
# **Plot heatmaps representing the distribution of features in class 1**
