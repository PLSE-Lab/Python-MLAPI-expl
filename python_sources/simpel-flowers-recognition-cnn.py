...
image_path = "../input/flowers-recognition/flowers/flowers"
images_dict = {}
...
train_dir = Path('../input/flowers-recognition/flowers/flowers')
test_dir = Path('../input/flowers-recognition/flowers/flowers')
...
model.add(Dense(5, activation='softmax')) #softmax turns it into properbelities
...
fitting_model = model.fit_generator(train_generator,
                    steps_per_epoch = 3462//batch_size, #just a calulation (train size/batch size) also how many pictures we want to load each time
                    validation_data = test_generator, 
                    validation_steps = 861//batch_size, #just a calulation (validation size/batch size)
