...
def add_building_level(train_df, test_df):
	...
	for i in test_df['new_building_id'].values:
		if i not in building_level.keys():
			...
			b.append((building_level[i][0]*0.0 + building_level[i][1]*1.0 + building_level[i][2]*2.0) / occurance)
...
X_train, X_test = add_building_level(X_train, X_test)
