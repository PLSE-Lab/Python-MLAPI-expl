...
test_df['created_weekend'] = ((test_df['created_weekday'] == 5) & (test_df['created_weekday'] == 6))
test_df['created_wd'] = ((test_df['created_weekday'] != 5) & (test_df['created_weekday'] != 6))
#test_df['created'] = test_df['created'].map(lambda x: float((x - dt.datetime(1899, 12, 30)).days) + (float((x - dt.datetime(1899, 12, 30)).seconds) / 86400))
...
"num_photos", "num_features", "num_description_words","listing_id", "created_year", "created_month", "created_day", "created_hour", "created_weekday", "created_week", "created_quarter"]
...
out_df.to_csv("20170413_3try.csv", index=False)
print('done')