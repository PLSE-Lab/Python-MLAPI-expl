...
# <h1 align="center" style="color:#6699ff"> IEEE Frequency encode with preprocessing for LGBM </h1>
...
print(os.listdir('/kaggle/input/ieeedataminification'))
...
remove_features.to_pickle('/kaggle/working/remove_features.pkl')
