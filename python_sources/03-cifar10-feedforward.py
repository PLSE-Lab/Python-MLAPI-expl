...
all_labels = [label for img, label in dataset]
...
history += fit(25, .1, model, train_loader, val_loader)


# In[ ]:


history += fit(25, .01, model, train_loader, val_loader)


# In[ ]:


history += fit(20, .005, model, train_loader, val_loader)


# In[ ]:


history += fit(20, .001, model, train_loader, val_loader)
