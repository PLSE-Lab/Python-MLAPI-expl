...
tables = [pd.read_csv(f'{PATH}{fname}.csv', low_memory=False) for fname in table_names] +   [pd.read_csv(f'{PATH_EXTERNAL}{fname}.csv', low_memory=False) for fname in external_table_names]
