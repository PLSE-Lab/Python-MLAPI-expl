...
landslides['date_parsed'].head(20)
...
earthquakes['date_parsed'] = pd.to_datetime(earthquakes['Date'], infer_datetime_format=True) #let pandas handle the date format
print(earthquakes['date_parsed'].head(20))
...
# remove na's
day_of_the_month_landslides = day_of_month_landslides.dropna()
...
day_of_the_month_earthquakes = day_of_the_month_earthquakes.dropna()
sns.distplot(day_of_the_month_earthquakes, kde = False, bins = 31)
