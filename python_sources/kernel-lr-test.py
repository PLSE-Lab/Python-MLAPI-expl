...
cols = ['OverallQual', 'YearBuilt', 'MasVnrArea', 'TotalBsmtSF', '1stFlrSF', 'GrLivArea', 'GarageCars', 'Fireplaces', 'GarageArea', 'FullBath',
       'YearRemodAdd', 'TotRmsAbvGrd', 'TotalBsmtSF']
...
print(mean_absolute_error(y_valid_list,y_pred))
