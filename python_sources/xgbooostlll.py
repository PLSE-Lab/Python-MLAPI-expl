...
train['SA'] = train['diameter']*3.1415*train['length']
train['volume'] = 3.1415*((train['diameter']/2)**2)*train['length']-3.1415*(((train['diameter']-2*train['wall'])/2)**2)*train['length']
...
test['SA'] = test['diameter']*3.1415*test['length']
test['volume'] = 3.1415*((test['diameter']/2)**2)*test['length']-3.1415*(((test['diameter']-2*test['wall'])/2)**2)*test['length']
