...
# fit model
model.fit(X_train, train.target, epochs=4, verbose=1, validation_split=0.1, class_weight={1:0.6, 0:0.4})
...
# This kernel scored 0.604 on the public leaderboard!
