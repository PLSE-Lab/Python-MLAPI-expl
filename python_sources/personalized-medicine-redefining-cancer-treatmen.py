...
# <h3>This kernel (notebook) is for learning pourposes</h3>
...
# Can think of workaround when there are not alot of important features present<br />
# May come back later to this
...
# Here on is my personal playground
