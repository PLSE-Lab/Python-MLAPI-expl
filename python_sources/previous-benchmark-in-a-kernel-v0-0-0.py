...
# attempt 1 to get the inception benchmark working
# code is from : https://github.com/macaodha/inat_comp_2018
# very premature modifications to work with torch v1 and the current dataset, wip, or I should say, not yet working...in progress
