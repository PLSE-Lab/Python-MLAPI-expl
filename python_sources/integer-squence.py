...
def predict_last(N, inputfilepath):
    ...
    for i in range(len(data)):
        ...
        if len(seq) < 2:
            ...
            continue
        print ([seq[i:i + number_of_points] for i in range(len(seq) - number_of_points)])
        print(seq[number_of_points:])
        clf.fit([seq[i:i + number_of_points] for i in range(len(seq) - number_of_points)], seq[number_of_points:])
