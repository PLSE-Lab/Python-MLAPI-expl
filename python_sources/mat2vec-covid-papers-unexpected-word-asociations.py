...
# I used Mat2Vec to create embeddings of the COVID papers dataset found here on Kaggle.  
# One by one, I searched for all the terms on the tasks page.
# What the program returned was a list of words in the COVID documents closely 
# associated with the one I searched for.
# 
# What came up was interesting to me.
# I removed any words in the search results that seemed generic.
# 
