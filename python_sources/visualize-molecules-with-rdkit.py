...
# In this kernel, I will explain how to visualize molecules using [RDKit](https://www.rdkit.org/docs/GettingStartedInPython.html) library.
# 
# It provides many kinds of data preprocessing used in chemistry.
...
# But it can be installed via conda, so let's install it at first.
...
# ## rdkit explanation: visualize via mol instance
# 
# We can visualize molecules via rdkit `Mol` instalce 
...
# Below code is referenced from the repository [chainer-chemistry](https://github.com/pfnet-research/chainer-chemistry), [tox21_dataset_exploration notebook](https://github.com/pfnet-research/chainer-chemistry/blob/master/examples/tox21/tox21_dataset_exploration.ipynb).
...
# For example, let's visualize CO2. Molecules can be represented by [SMILES](https://en.wikipedia.org/wiki/Simplified_molecular-input_line-entry_system) string notation.
...
# ## visualize from xyz file
# 
# Now, we know how to visualize molecule from RDKit `Mol` instance, but how to create mol instance of kaggle data?
# 
# I found a nice repository, [xyz2mol](https://github.com/jensengroup/xyz2mol) by jensengroup, which provides a code to convert xyz file to RDKit mol instance under MIT license.
