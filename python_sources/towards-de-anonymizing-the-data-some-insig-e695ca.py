...
import math
train['target_new2'] = np.log10(train['target_new'])/np.log10(2)
...
np.log10( 0.566331)/np.log10(2)


# In[ ]:


train[(train['target'] < -30)]


# In[ ]:


train['target_new2'] = math.pow(10,(train['target_new2']))
