...
# ![](http://)This distribution depicts the majority of restaurants have less than 2500 votes
...
# Vote Count for first 30 restaurant in the data. we can create more insight through the data after converting our categorical to one hot encoding and cleaning our data further . for now it was a starting attempt to create plots for the first time.
# 
# At last i will like to thank you kaggle for creating such a beautiful course.
