...
import numpy as np
import cv2 
from yolov3_utility_file import *

## Creating a Replica of Darknet Model 
...
# CONSTRUCTING THE CONFIGURATION OF NETWORK
...
# # Decomment the cell to test the model with randomly initialised values
# num_classes = 80
# classes = load_classes('../input/yolo-coco-data/coco.names') 

# model = net('../input/yolo-coco-data/yolov3.cfg')
# model.load_weights("../input/yolo-coco-data/yolov3.weights")
