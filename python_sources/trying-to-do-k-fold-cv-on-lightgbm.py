...
# For some reason, when I use a script, LightGBM.cv ignores 'verbose':0 and prints out info for every tree, but when I use a notebook, it only provides the information I want.
