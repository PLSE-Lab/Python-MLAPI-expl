...
# # Acknowledgements
# 
# - Original kernel: https://www.kaggle.com/golubev/mip-optimization-preference-cost
# - Edits: changed NUM_SECONDS to 18000 to get this kernel's best LB in version 2
# - Purpose of this kernel is solely to show the effects of manipulating the time
# - Please upvote this kernel including the original author's if you find it insightful!
...
# 
# We setup ***MAX_BEST_CHOICE = 5*** and ***NUM_SWAP = 2500***, how result we get 5*2500 variables and it is enough for get some result in resonable time:
