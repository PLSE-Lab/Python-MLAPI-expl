...
# # Introduction and EDA for Abstraction and Reasoning Challenge 2020

# ## Written by Sergei Issaev

# ### Please upvote if you found this code useful!

# ## Kaggle Boilerplate code
