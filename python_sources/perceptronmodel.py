...
class Perceptron:
    ...
    def fit(self,X,Y,epochs=5,lr=0.1):
        self.w=np.random.randint(low = -1,high= 1,size =X.shape[1])
        self.b=0
...
wt_matrix=perceptron.fit(X_train,Y_train,1800,lr=0.0001)
...
Y_pred_test=perceptron.predict(test_new.drop(['PhoneId'],axis=1).values)
