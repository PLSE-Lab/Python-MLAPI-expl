...
if __name__ == '__main__':
    ...
    clf = Pipeline([('v',TfidfVectorizer(min_df=5, max_df=5000, max_features=None, strip_accents='unicode', analyzer='word', token_pattern=r'\w{1,}', ngram_range=(1, 2), use_idf=True, smooth_idf=True, sublinear_tf=True, stop_words = 'english')), 
