...
#Price per ...
df_train["price_bed"] = df_train["price"]/(df_train["bedrooms"]+1)
df_train["price_bath"] = df_train["price"]/(df_train["bathrooms"]+1)
df_train["price_bath_bed"] = df_train["price"]/(df_train["bathrooms"] + df_train["bedrooms"]+1)
#***
df_train["bedPerbath"] = (df_train["bedrooms"]/(df_train["bathrooms"]+1))
df_train["bedDiffbath"] = (df_train["bedrooms"]-df_train["bathrooms"])
df_train["bedPlusbath"] = (df_train["bedrooms"]+df_train["bathrooms"])
df_train["bedPerc"] = (df_train["bedrooms"]/(df_train["bathrooms"]+df_train["bedrooms"]+1))
#***
df_train.fillna(-1,inplace=True)

df_test["price_bed"] = df_test["price"]/(df_test["bedrooms"]+1)
df_test["price_bath"] = df_test["price"]/(df_test["bathrooms"]+1)
df_test["price_bath_bed"] = df_test["price"]/(df_test["bathrooms"] + df_test["bedrooms"]+1)
#***
df_test["bedPerbath"] = (df_test["bedrooms"]/(df_test["bathrooms"]+1))
df_test["bedDiffbath"] = (df_test["bedrooms"]-df_test["bathrooms"])
df_test["bedPlusbath"] = (df_test["bedrooms"]+df_test["bathrooms"])
df_test["bedPerc"]     = (df_test["bedrooms"]/(df_test["bathrooms"]+df_test["bedrooms"]+1))
#***
