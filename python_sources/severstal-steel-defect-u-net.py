...
# We will be using popular U-net architecture in keras. Broken down in following sections:
# - **Preprocessing** -  Expand train data to include Image ID.
# - **Utlility** Functions - Used from Paul's kernel and starter code.
# - **Sample Test** - Simply visualizing a sample image and its masks.
# - **Data generator** - Very long and possibly complex.
# - **Model Architecture**
# - **Training**
