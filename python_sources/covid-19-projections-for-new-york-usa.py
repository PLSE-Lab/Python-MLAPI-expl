...
# # COVID-19 Projections for New York, USA
...
df_ny = df[df.location_name=='New York']
df_ny = df_ny[['date', 
                           'allbed_mean',
                           'ICUbed_mean', 
                           'InvVen_mean',  
...
title = 'Mean of Upper and Lower Predictions from IHME for New York as of '+todays_date
df_ny.plot(title=title,figsize=(12,9), grid=True)
...
plot_eleven_columns_using_plotly_regular(dataframe=df_ny,
...
plot_eleven_columns_using_plotly_express(dataframe=df_ny,
                                        column_one='allbed_mean',
                                        column_two='ICUbed_mean',
                                        column_three='InvVen_mean',
                                        column_four='deaths_mean',
