...
Source code for Early Stopping callback with heldout validation for structured tabular data surgical csv file binary classification with deepneural nets tensorflow, pandas and keras
Results:
...
model.add(tf.keras.layers.Dense(512, activation='relu', kernel_regularizer=regularizers.l1_l2(l1=0.001, l2=0.001), input_shape=X_train[21].shape))

#Add dropout
#model.add(tf.keras.layers.Dropout(0.5))

# Add one hidden layer 
model.add(tf.keras.layers.Dense(512, activation='relu', kernel_regularizer=regularizers.l1_l2(l1=0.001, l2=0.001)))
...
keras.callbacks.ModelCheckpoint(filepath='tf-sept03-Smodel-v2-sgd.h5',monitor='val_loss',save_best_only=True,)
]
