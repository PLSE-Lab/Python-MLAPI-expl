...
# - Augmentation, we augment the datasets a bit to make the model less sensitive to small changes
...
# # Add augmentation
# We do not want to get too intense on the augmentation step since these are not photos of dogs and the processed results shouldn't lose too much structural information
