...
# /kaggle/input/siim-isic-melanoma-classification/jpeg/train/ISIC_2913917.jpg
...
# # Model
# 
# We resize the image, only take the first color layer, and flatten to create a reasonable number of features to run through a 0 hidden layer MLP which is essentially logistic regression.
