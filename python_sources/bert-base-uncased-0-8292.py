...
preproccesed=clean_text(df)


# In[ ]:


df['text_new']=preproccesed
...
test_pre=clean_text(test)


# In[ ]:


test['text_new']=test_pre
...
sub.to_csv('submit_bert_base_Uncased.csv',index=False)
