...
# # Examples: Below is a snapshot of some of the answers against questions related to Task 9
# ![task-9-1.jpg](attachment:task-9-1.jpg)
# ![task-9-2.jpg](attachment:task-9-2.jpg)
...
# # Read papers Selected for Task-9

# In[ ]:


Task='Task 10'
data=pd.read_excel("/kaggle/input/task3covid/task9_results_summary.xlsx")

qadata=pd.read_excel("/kaggle/input/covid-task-qa-answer/task9_results_summary_QA.xlsx")
