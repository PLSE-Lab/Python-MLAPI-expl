...
# # All post processing credit to @cdeotte for his kernel below:-
# 
# https://www.kaggle.com/cdeotte/private-leaderboard-0-703/comments
...
#   
# I used this trick during the competition to increase Public LB score. But it wasn't until after the competition's end that I learned how to increase Private LB score.
...
# We notice that the probabilities before and after the sampling window should be lower. So we will correct them.
...
# The original submission file had Public/Private LB 0.698/0.635. The new updated file has Public/Private LB 0.693/0.703. Using this trick, one can correct the top Kaggle Microsoft Malware public kernel submission files, ensemble them, and score over 0.700 Public LB (and over 0.700 Private LB).
...
# ![image](http://playagricola.com/Kaggle/private231419.png)
