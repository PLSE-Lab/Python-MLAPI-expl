...
get_ipython().system(' unzip ../input/jigsaw-toxic-comment-classification-challenge/sample_submission.csv.zip;')
get_ipython().system(' unzip ../input/jigsaw-toxic-comment-classification-challenge/test.csv.zip;')
