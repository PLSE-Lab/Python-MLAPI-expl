...
def main():
    ...
    lr.fit(lootrain[['group_1', 'char_2','char_36', 'char_38']], train['outcome'])
    preds = lr.predict_proba(lootrain[['group_1', 'char_2','char_36', 'char_38']])[:, 1]
    ...
    preds = lr.predict_proba(lootest[['group_1', 'char_2','char_36', 'char_38']])[:, 1]
