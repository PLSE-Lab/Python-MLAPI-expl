...
get_ipython().run_cell_magic('time', '', 'df_train = features_engineering(df_train)')
...
# # Submission Validation UCF Site0 (bld 0-104)
...
# # Submission Validation UCL Site1 (bld 105-155)
