...
# # CenterNet starter codes in Pytorch!
# 
# ## Why CenterNet?
# 
...
# 
# ### Please upvote if this notebook helps you, Thanks!!
...
# WHile the labels are given in COCO format, we need to convert them to heatmaps in order to train CenterNets.
...
# ## Make dataset
# Then, let's make a dataset and a dataloader for training.
...
# The model is based on [PKU centernets](https://www.kaggle.com/hocop1/centernet-baseline/data).
...
# ![](https://i.imgflip.com/26d7zv.jpg)
