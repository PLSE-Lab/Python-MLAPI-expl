...
# **Uploading pretrained BERT model**
...
# **Tokenization**
# 
# Load dictionary from BERT_PRETRAINED_DIR for tokenization
...
# **Preparing the input-data : Cleaning and Pre-processing**
# 
# 
