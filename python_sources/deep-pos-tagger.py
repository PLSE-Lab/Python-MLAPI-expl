...
model = DualLSTMTagger(WORD_EMBEDDING_DIM, WORD_HIDDEN_DIM, CHAR_EMBEDDING_DIM, CHAR_HIDDEN_DIM, DENSE_LAYER_DIM_1, DENSE_LAYER_DIM_2, word_vocab_size, char_vocab_size, tag_vocab_size)
...
#         print(indices == targets)
    ...
    if (epoch + 1) % 10 == 0:
        print("Epoch {}/{} Completed,\tLoss {}\tAccuracy: {}".format(epoch + 1, epochs, loss, acc))
