...
def get_images(n):
    ...
    all_image_files = os.listdir("/kaggle/input/open-images-2019-object-detection/")
...
image_path = "/kaggle/input/open-images-2019-object-detection/test/6ab7f704f96996e6.jpg"
