...
#  
#  Unfortunately, saving all the created features does not work in a Kaggle notebook. You will have to run the code on your personal machine. The main reference has run the code and uploaded the [entire datasets here](https://www.kaggle.com/willkoehrsen/home-credit-manual-engineered-features). I plan on doing some feature selection and uploading reduced versions of the datasets. Right now, they are slightly to big to handle in Kaggle notebooks or scripts. .
...
# # References Used  
# [EDA Classification | Credit Default](http://kaggle.com/davidrivasphd/eda-classification-credit-default#EDA-Classification-|-Credit-Default) by David Rivas, Ph.D.  
# [Feature Engineering I | Credit Default](http://kaggle.com/davidrivasphd/feature-engineering-i-credit-default#References-Used) by David Rivas, Ph.D.  
# [Introduction to Manual Feature Engineering P2](http://www.kaggle.com/willkoehrsen/introduction-to-manual-feature-engineering-p2) by Will Koehsen  
