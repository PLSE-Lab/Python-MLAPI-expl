...
def principal_component_analysis(x_train, normalize_axis=0):
    ...
    if normalize_axis != -1 :
        ...
        x_train_normalized = normalize(x_train, axis=normalize_axis)
    else :
...
# if normalize axis parameter is -1 no normalization is applied.
# if normalize axis parameter is 1 normalization is applied along columns
# if normalize axis parameter is 0 normalization is applied along rows
...
# No normalization
principal_component_analysis(x_train, normalize_axis=-1)
...
principal_component_analysis(x_train, normalize_axis=0)
