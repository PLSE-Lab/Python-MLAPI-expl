...
rf_model = RandomForestRegressor(random_state=1, n_estimators=111, max_features=17)
...
# **Best MAE of our RF Model: 16,157**
...
rf_model_on_full_data = RandomForestRegressor(random_state=1, n_estimators=111, max_features=17)
...
# imputing missed values in dataset 
imp = SimpleImputer(strategy="most_frequent")
test_X_imputed = pd.DataFrame(imp.fit_transform(test_X))
