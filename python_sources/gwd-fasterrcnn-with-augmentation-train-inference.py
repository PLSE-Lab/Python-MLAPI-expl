...
num_epochs = 15 #Increase it for better results
...
# This output can be used for submitting to the competition. Train a little longer and use more augmentation data for better results.
# ## TODO
