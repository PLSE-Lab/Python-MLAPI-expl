...
# # How to Query USPTO OCE Patent Litigation Docket Reports Data (BigQuery)
...
# ## Example SQL Query
# What are some of the causes that resulted in a case?
...
# Interpretting this number, this means my query scanned about ~0.002 GB (or 2 MB) of data in order to return a table of 20 unique case causes from the dataset.
