...
# Visualize the data and check for any null values
...
# Visualize to compare the number of people who were granted access to the number of people who weren't
...
# ****Thus, we can use the Random Forest model as it gives the highest accuracy
