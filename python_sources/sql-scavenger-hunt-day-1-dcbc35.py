...
query1 = """SELECT DISTINCT country
            ...
            WHERE pollutant !='ppm'
            """
otherthanppm = open_aq.query_to_pandas_safe(query1)
otherthanppm.head()
otherthanppm.to_csv("otherthanppm.csv")
...
query2 = """SELECT DISTINCT pollutant
            ...
            WHERE value = 0.00
"""
zerovaluespollutants = open_aq.query_to_pandas_safe(query2)
zerovaluespollutants.head()
zerovaluespollutants.to_csv("zerovaluespollutants.csv")
