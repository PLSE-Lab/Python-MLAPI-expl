...
#    df = df.loc[(day<val_start_day)].copy()
    df = df.loc[(day>=val_start_day-365) & (day<val_start_day)].copy()
    return df, df_val
...
fw = [141., 3.0, 64.4, 26., 2300, 5625, 55.6]
off = [444, 931, 421]
...
x_border_aug = 0.05 * fw[4] # expansion of x border on train 
y_border_aug = 0.05 * fw[5] # expansion of y border on train
time_aug = 2.9
n_neighbors = 0
