...
get_ipython().system('unzip /kaggle/input/denoising-dirty-documents/train.zip')
get_ipython().system('unzip /kaggle/input/denoising-dirty-documents/test.zip')
get_ipython().system('unzip /kaggle/input/denoising-dirty-documents/train_cleaned.zip')
get_ipython().system('unzip /kaggle/input/denoising-dirty-documents/sampleSubmission.csv.zip')
...
# Let's visualize few images that we are going to deal with.
...
# Let's load our train an test images and preprocess them to make them appropriate for modelling
...
# Creating a autoencoder using keras
...
# Let's define the callbacks for our model
