...
dcm_files = {f.split("/")[-1]:f for f in list(glob('../input/siimacr-pneumothorax-segmentation-downloaded-file/siim/train/*/*/*.dcm'))             +list(glob('../input/siimacr-pneumothorax-segmentation-downloaded-file/siim/test/*/*/*.dcm'))}
...
# ### show training data
# 
# mask image is 270 rotated. Put the mask image on the 50% train image.
