...
get_ipython().run_cell_magic('time', '', "# Tokenize valid regular processing\nx_valid = regular_encode(valid.comment_text.values, max_len=MAX_LEN)\n\ny_valid = valid.toxic.values\ny_valid = np.asarray(y_valid).astype('float32').reshape((-1,1)) ")


# In[ ]:


get_ipython().run_cell_magic('time', '', 'x_test = regular_encode(test.content.values, max_len=MAX_LEN)')
