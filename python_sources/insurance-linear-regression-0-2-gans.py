...
your_name = 'Debshila' # at least 5 characters
...
# TensorDataset allows access to rows from inputs and targets as tuples, 
...
all_loss = [result] + history1 + history2 + history3 + history4 + history5
