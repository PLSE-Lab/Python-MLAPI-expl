...
get_ipython().run_cell_magic('time', '', 'gan.train(epochs=10, batch_size=1, sample_interval=200)\n# training logs are hidden in published notebook')
...
Image('/kaggle/working/images/facades/0_0.png')


# In[ ]:


Image('/kaggle/working/images/facades/0_200.png')


# In[ ]:


Image('/kaggle/working/images/facades/5_200.png')


# In[ ]:


Image('/kaggle/working/images/facades/9_200.png')
