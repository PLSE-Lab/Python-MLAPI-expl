...
# 
k=d[d.parent_incident_type.str.match(r'Community Polic*')]
t=k[['title','timeStamp','lat','lng','desc','twp']]
t=t[(t['timeStamp'] >= '2017-03-15 00:00:00') & (t['timeStamp'] <= '2017-03-20 00:00:00')]
...
for i in range(0,len(lat)):
    ...
    s+="['%s ', %s, %s, %s,'https://storage.googleapis.com/montco-stats/images/violation.png'],\n" % (displayTitle,lat[i],lng[i],i)
