...
# **Problem**
# the employee attrition rate should be predicted based on various given different factors placed in the data sets.We need to analyze the factors which i s involved in this attrition rate. hence it is an sensitive prediction to be find out the attrition rate of the employee so that organization can make a decision to get reduced in future.
...
# confusion_matrix: helper method to show to number of correct predictions for positive and negative cases
...
# From the above results,there is no null values
