...
# # Titanic Data Survival Predictions
...
# Now that we've filled in the missing values at some extent, it's time to map each age group to a numerical value.
...
test = test.fillna({"Embarked": "S"}) # as we did for train data
...
print('logreg accuracy score is:',acc_logreg)
...
print('linear svc accuracy score is:',acc_linear_svc)
...
print('perceptron accuracy score is:',acc_perceptron)
...
print('decision tree accuracy score is:',acc_decisiontree)
...
print('random forest accuracy score is:',acc_randomforest)
...
print('stochastic gradient descent accuracy score is:',acc_sgd)
...
print('gradient boosting accuracy score is:',acc_gbk)
