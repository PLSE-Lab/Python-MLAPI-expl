...
df_train['weekday'] = (df_train['weekday']%7+1)*3.11
df_train['month'] = (df_train['month']%12+1)*2.11
...
del minute
df_test['weekday'] = (df_test['weekday']%7+1)*3.11
df_test['month'] = (df_test['month']%12+1)*2.11
...
def process_one_cell(df_cell_train, df_cell_test):
    ...
    mask = (place_counts[df_cell_train.place_id.values] >= 6).values
    ...
    df_cell_train.loc[:,'x'] *= 465.0
    df_cell_train.loc[:,'y'] *= 975.0
    df_cell_test.loc[:,'x'] *= 465.0
