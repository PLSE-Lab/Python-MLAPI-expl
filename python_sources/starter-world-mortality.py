...
# ## Introduction
# This is a basic intro into the dataset on [World Mortality Rates](https://www.kaggle.com/navinmundhra/world-mortality). "Edit Notebook" or "Fork Notebook" button at the top of this kernel to begin editing.
...
# ### Let's check 1st file: /kaggle/input/Adult mortality.csv
...
# ### Let's check 2nd file: /kaggle/input/Maternal mortality.csv
...
df2 = pd.read_csv('/kaggle/input/Maternal mortality.csv', delimiter=',', nrows = nRowsRead)
...
# ### Let's check 3rd file: /kaggle/input/Number of deaths (thousands).csv
...
df3 = pd.read_csv('/kaggle/input/Number of deaths (thousands).csv', delimiter=',', nrows = nRowsRead)
...
# ## Conclusion
# This concludes the starter analysis! To go forward from here, click "Edit Notebook" button at the top of the kernel. This will create a copy of the code and environment for you to edit. Delete, modify, and add code as you please. :)
