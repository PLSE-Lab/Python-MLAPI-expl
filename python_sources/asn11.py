...
ROOT_DIR = os.path.abspath("../input/mask-rcnn-files/mask_rcnn-master/Mask_RCNN-master/")
...
IMAGE_DIR = os.path.join("/input/2019-fire171-asn11-image-segmentation-challenge-v2/train_images/")

config = os.path.join(ROOT_DIR, "/mrcnn/config/")
