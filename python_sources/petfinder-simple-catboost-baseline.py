...
# **EAS** - I replaced the LGBM with CatBoost which was working great until a few days ago when, overnight, the same code that had previously scored well suddenly scored very poorly, with no changes being made. I have no explanation for why this happened, maybe Kaggle upgraded the version of CatBoost? I spent a few days re-tuning the parameters to try to get the performance back up with no luck. Maybe someone else will be able to figure it out...
# 
...
#  * v2 - reducing number of boosting rounds to 1000
#  * v7 - reverting to best baseline
#  * v10 - reverting to baseline again, restarting tuning of params - removing learning rate
#  * v15 - we need to go deeper
#  * v20 - back to baseline again, tuning lambda
#  * v21 - fold related error with coefficients
...
print("Overall QWK:", quadratic_weighted_kappa(target, train_predictions))
