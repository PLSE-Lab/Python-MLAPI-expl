...
# This is the 1st out of 3 notebooks where I have plotted the **meter_reading over the year 2016 (duration of training data) for different types of meters for all the buildings across sites 6 to 10**. The goal is to quickly refer to the meter_reading for all the sites to identify outliers and gaps.
# 
...
# # meter_reading site 6

# In[ ]:


plot_meter_reading_for_site(train_df, 6)


# # meter_reading site 7

# In[ ]:


plot_meter_reading_for_site(train_df, 7)


# # meter_reading site 8

# In[ ]:


plot_meter_reading_for_site(train_df, 8)


# # meter_reading site 9

# In[ ]:


plot_meter_reading_for_site(train_df, 9)


# # meter_reading site 10

# In[ ]:


plot_meter_reading_for_site(train_df, 10)
