...
#all_data['Wt_Age'] = all_data['Wt'] * all_data['Ins_Age']
#all_data['BMI_EmpInfo1'] = all_data['BMI'] * all_data['Employment_Info_1']
#all_data['BMI_EmpInfo6'] = all_data['BMI'] * all_data['Employment_Info_6']
#all_data['BMI_InsHistory5'] = all_data['BMI'] * all_data['Insurance_History_5']
#all_data['ProInfo3_4'] = all_data['Product_Info_3'] * all_data['Product_Info_4']
