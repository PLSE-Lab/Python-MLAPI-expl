...
# # Attempt D6: Time-wise mean input + all possible augmentation
# I introduce one of my approach to handle the spectrum mean data.
# This scored about val_acc 0.76, but what's important is that this looks at data from spectrum point of view only, very different from the others.
# 
# Mean is calculated at the first layer of model:
# ```Python
...
# This is the model.
# 
# It takes time-wise mean first; (40, 501) -> (40, 1). Following part is a kind of AlexNet.
