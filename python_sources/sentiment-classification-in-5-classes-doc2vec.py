...
# ## Predictive Analysis##
# We are trying to predict the sentiment of the comments recorded with people into 5 classes. The idea is to use Doc2Vec to improve the accuracy of the system.
# 
# 
