...
print(os.listdir("../input/test set/"))
...
def test(file, i):
  ...
  with Image.open(file) as f:
      ...
      with torch.no_grad():
          ...
          print("File Name: ", i, "\tPredicted Label: ", class_name, "\tAnd Label in Number: ",top_class.item())
