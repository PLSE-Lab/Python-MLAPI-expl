...
# The purpose of this notebook is to expand on the basic training provided by Kaggle and add some more in depth data analyis and preparation activities.   I took some insight from a number of other Kernels.  The main two are listed here.
# 
# Credits: 
# 
...
# 
# [Stacked Regressions](https://www.kaggle.com/serigne/stacked-regressions-top-4-on-leaderboard) - By Serigne
...
#Check if there are any "object" types left (RandomForest doesnt like Object type.)
train.info()
...
# First we need to pick a model, for this is have used a RandomForest from SciKit.  Once we have selected the model we must fit the previously created X and y variables to it.   This is just for training data, you will not re-run this when it comes to submitting your test data. 
