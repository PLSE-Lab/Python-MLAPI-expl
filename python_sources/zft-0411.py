...
all = itertools.combinations(hashes_important_indexes, 3)
hashes_indexes = random.sample(list(all), 10)
...
def get_hashes(arr):
   ...
   # if 1:
    ...
    #sub.append((12, pais_residencia,ncodpers, fecha_alta,antiguedad,tipodom, sexo, age, segmento))
    #else:
        # Random set
