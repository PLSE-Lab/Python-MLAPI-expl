...
knn_m = knn(10, algorithm = "auto", leaf_size = 50, n_jobs = -1)
knn_m = knn_m.fit(train_data[0::, 1::], train_data[0::, 0])

print(knn_m.score(train_data[0::, 1::], train_data[0::, 0]))

print('Predicting...')
output = knn_m.predict(test_data).astype(int)
