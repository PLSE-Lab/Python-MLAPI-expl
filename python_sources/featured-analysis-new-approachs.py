...
# <h1><center><font size="6">Feature analysis LANL Earthquake New Approach EDA  </font></center></h1>
# 
# <br>
# 
# # <a id='0'>Content</a>
...
X_test=scaled_test_X.values.reshape(test_X.shape[0],14,2)
print(X_test.shape)
