...
# # Tutorial: Word2Vec
# This is a basic guide to efficiently training a Word2Vec model on the English Wikipedia dump using Gensim.
...
# Now let's train a Word2Vec. Ideally, we'd split the section text into sentences, but feeding section text as a block performs well. 
