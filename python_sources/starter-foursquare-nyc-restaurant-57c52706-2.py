...
df2 = pd.read_csv('/kaggle/input/NY_Restauraunts_tags.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/NY_Restauraunts_tips.csv', delimiter=',', nrows = nRowsRead)
