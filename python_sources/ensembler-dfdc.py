...
# ## Credit to Wei Hao and Navi

# ## A  brief introduction
# 
# So, what I've done is use `%%writefile` to avoid Notebook Exceeded Allowed Compute.
# 
# Thanks to Sergei Fironov and Mont3z Claro 5.

# ## Epochs, Factor, Learning Rates & Patience (IMPORTANT EXPERIMENTAL NOTES)
# 
# I have attempted to use my own pretrained weights for Xception. I hope you enjoy this kernel.
# 
# ### Stats:
# * LR: 0.001
# * Epochs: 20

# *I'm really not a huge fan of PyTorch (a TF guy). But, I want to expand and this seems like a good way to do so.*
...
submission_df_one = pd.DataFrame({"filename": test_videos, "label": predictions})
