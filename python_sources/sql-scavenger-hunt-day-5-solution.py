...
# **Solution starts here!** Our query for how many commits have been made in Python repos, making sure to select distinct Python repos (as there are several files per repo in the sample_files table):
...
# Hooray, we finished the Scavenger Hunt! Thanks, Kaggle!
