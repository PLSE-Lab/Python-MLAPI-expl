...
# 
# > Here I implement a resnet model from this paper (https://arxiv.org/abs/1512.03385) in Keras. This model generates about 0.27M parameters
...
# After experimenting with different number of epochs, I chose 200 where the accuracy stabilizes and we implement the depth as 20 as described in the paper.
