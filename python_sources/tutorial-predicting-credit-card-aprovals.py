...
# ## Predicting Credit Card Aprovals
# ![CRedit Cards](https://cdn.pixabay.com/photo/2015/12/22/23/00/credit-card-1104960_960_720.jpg)
...
# </ul>
# <p>Now, let's temporarily replace these missing value question marks with NaN.</p>](http://)
...
# ## 13. Finalizing
# Wow! A positive result. Now we can start work on analyzing real requests!

# If you liked the code and are useful to you, I am grateful for your upvote :)
