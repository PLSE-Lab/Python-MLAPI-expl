...
ax = sns.boxplot(x="Victim Sex", y="Victim Age", data=database_df,hue="Weapon",color='#666666', palette="tab20")
...
ax = sns.stripplot(x='Victim Sex', y='Victim Age', data=database_df, color="orange", jitter=0.5, size=5,alpha=0.02)
...
plt.ylim(0,100)
#plt.text(3, 60, 'Courtesy: https://seaborn.pydata.org/examples/grouped_boxplot.html', fontsize=13,alpha=0.2)
...
ax = sns.boxplot(x="Crime Solved", y="Victim Age", data=database_df,hue="Weapon",color='#666666', palette="tab20")
...
ax = sns.stripplot(x='Crime Solved', y='Victim Age', data=database_df, color="orange", jitter=0.5, size=5,alpha=0.02)
...
ax = sns.boxplot(x="Relationship", y="Victim Age", data=database_df,color='#666666', palette="tab20")
...
ax = sns.stripplot(x='Relationship', y='Victim Age', data=database_df, hue='Victim Sex', cmap='Dark2', jitter=0.5, size=5,alpha=0.02)
...
ax = sns.boxplot(x="Year", y="Victim Age", data=database_df,color='#666666', palette="Purples")
...
ax = sns.stripplot(x='Year', y='Victim Age', data=database_df, color="orange", jitter=0.5, size=5,alpha=0.02)
...
pivot = database_df.groupby(['Weapon','State','Year','Crime Solved'])['Incident'].agg(['sum'])
