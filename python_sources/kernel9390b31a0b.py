...
class KaggleDataset(Dataset):
    ...
    def load_image(self, image_id, color):
        ...
        path = self.train_path + info['img_name'] +             '/images/' + info['img_name'] + '.png'
    ...
    def load_mask(self, image_id):
        ...
        path = self.train_path + info['img_name'] +             '/masks/' + info['img_name'] + '.h5'
...
def train_validation_split(train_path, seed=10, test_size=0.1):
    ...
    train_list, val_list = train_test_split(train_path, test_size=test_size,
                                            random_state=seed)
