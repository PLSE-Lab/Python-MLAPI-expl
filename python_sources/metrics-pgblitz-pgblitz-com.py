...
REPOSITORY = 'PGBlitz/PGBlitz.com'
...
for metrics in ['delta', 'process', 'iac-process', 'iac-delta', 'delta-process']:
    ...
    # Train
    cv_results, best_index = walk_forward_release.learning(X_local, y, walk_forward_release.models['decision_tree'], walk_forward_release.search_params['decision_tree'])
