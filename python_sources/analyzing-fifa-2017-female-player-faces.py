...
# Analyzing FIFA 2017 Female Player Faces
# --------------------------------
# 
# Forked from the amazing [script][1] by Selfish Gene.
# 
# In this script we will explore a dataset of faces of approximately 139 top female soccer players and examine the main modes of variation in player appearance. The face images are conveniently almost perfectly aligned so the images turn out particularly nice.
# 
# Note that this is essentially the same code that I used in [visualizing PCA][2], but the data here is more interesting since it contains human faces.
# 
# 
#   [1]: https://www.kaggle.com/selfishgene/d/artimous/complete-fifa-2017-player-dataset-global/analyzing-fifa-2017-player-faces
#   [2]: https://www.kaggle.com/selfishgene/leaf-classification/visualizing-pca-with-leaf-dataset
...
#plt.figure(); 
#plt.subplot(1,2,1); plt.imshow(fullImageMatrix4D.mean(axis=3)); plt.title('mean Image'); plt.axis('off')
#plt.subplot(1,2,2); plt.imshow(fullImageMatrix4D.std(axis=3)); plt.title('stdev Image'); plt.axis('off')
...
# ----------
# 
# **Eigenvector 2: long blonde hair or short dark hair?**
# -------------------------------------------
...
# **Eigenvector 4: Regular or irregular pose?**
# -------------------------------------------
...
face_PCAModel.ShowSingleComponentVariation(X, listOfComponents=[3])


# **Eigenvector 7: Frown or Smile?**
# -------------------------------------------
...
face_PCAModel.ShowSingleComponentVariation(X, listOfComponents=[6])


# **Eigenvector 9: dim or bright lighting? (perhaps indoor vs outdoor)**
# ------------------------------------------
...
face_PCAModel.ShowSingleComponentVariation(X, listOfComponents=[8])


# **Eigenvector 12: Wide (square/circular) or Narrow (oval/rectangular) face?**
# ------------------------------------------
...
face_PCAModel.ShowSingleComponentVariation(X, listOfComponents=[11])
