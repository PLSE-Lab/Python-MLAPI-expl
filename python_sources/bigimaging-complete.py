...
# ## Loading Patients
# * Load all patients using the Patient class above
...
# ## Fourier Transform
# * Used for identifying regions with movement over time, in this case the left heart ventricle
...
# ### Compare calculated min and max volumes to ground truth
...
# ### Correlation between ground truth and predicted values
...
# ## Linear model for predicting volume
...
# ### Compare linear model to ground truth
