...
# Your code here
fashion_model.add(Conv2D(12, (3,3), activation='relu', input_shape=(img_rows, img_cols, 1)))
____
q_2.check()
...
fashion_model.fit(x, y, batch_size=100, epochs=4, validation_split=.2)
____
q_5.check()
...
second_fashion_model = Sequential([
    Conv2D(20, 3, activation='relu', input_shape=(img_rows, img_cols, 1)),
...
second_fashion_model.compile(loss="categorical_crossentropy", 
                      optimizer="adam", 
                      metrics=["accuracy"])
second_fashion_model.fit(x, y, batch_size=100, epochs=4, validation_split=.2)
