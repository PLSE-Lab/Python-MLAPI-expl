...
# [Reference notebook 1](https://www.kaggle.com/ipythonx/keras-global-wheat-detection-with-mask-rcnn/data?select=mask_rcnn_coco.h5)
# 
...
model = modellib.MaskRCNN(mode='inference', 
                              config=inferconfig,
                              model_dir='/kaggle/working')
model.load_weights('../input/pneumonia-wgts/pneumonia_wg.h5',
                  by_name = True)
