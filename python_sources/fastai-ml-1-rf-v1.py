...
# [fastai.tabular.transform Categorify](https://docs.fast.ai/tabular.transform.html#Categorify)
...
# We're still not quite done - for instance we have missing values, which we can't pass directly to a random forest.
...
# [fastai.tabular.transform FillMissing](https://docs.fast.ai/tabular.transform.html#FillMissing)
...
# let's save this file for now, since it's already in format can we be stored and accessed efficiently.
