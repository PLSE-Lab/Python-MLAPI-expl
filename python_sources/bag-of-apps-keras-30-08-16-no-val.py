...
print('Shape of train_sp:', train_sp.shape)
print('Shape of test_sp:', test_sp.shape)
...
def baseline_model():
    # create model
    model = Sequential()
    model.add(Dense(256, input_dim=X_train.shape[1], init='normal'))
    model.add(PReLU())
    model.add(Dropout(0.4))
    model.add(Dense(64, input_dim=X_train.shape[1], init='normal'))
    model.add(PReLU())
