...
class ConfigStats:
    ...
    def __str__(self):
        ...
        return f'''Accuracy            {samples_correct() / max(samples_num, 1)} ({samples_correct()} / {samples_num})
...
main(parse_args(['-s', 'test', '--load-confidence', 'confidence_model.pickle', '--seed', '3', '--save-all-predictions', '1']))
