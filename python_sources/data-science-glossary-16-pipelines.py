...
# - Here's the link to the official document of <a href='https://scikit-learn.org/stable/modules/generated/sklearn.pipeline.Pipeline.html'>SkLearn's Pipeline</a>
...
# 
# You have a modeling process that uses an Imputer to fill in missing values, followed by a Random Forest Regressor to make predictions.  These can be bundled together with the **make_pipeline** function as shown below.
...
# 
# Eventually you need  to apply more transformers and combine them more flexibly. 
