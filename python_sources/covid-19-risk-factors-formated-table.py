...
# # **COVID-19 risk factors with formatted table**
# 
...
def search_focus(df):
    ...
    dfe = df[df['abstract'].str.contains('cov2')]
...
for search_words in tasks:
    df_table = pd.DataFrame(columns = ["pub_date","title","link","journal","severe","sever sig.","severe age adj.","fatality","fatality sig.","atality age adj.","design","sample","study pop."])
    str1=''
    ...
    for index, row in df1.iterrows():
        ...
        if pub_sentence!='':
            ...
            to_append = [row['publish_time'],title,linka,row['journal'],'severe','sever sig.','severe age adj.','fatality','fatality sig.','fatality age adjusted','design','sample','study pop.']
