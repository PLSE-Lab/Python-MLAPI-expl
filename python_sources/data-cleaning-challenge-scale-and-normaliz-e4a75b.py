...
# 
# > ANS: This variable should be normalized.
# 
# * You're still working on your grades study, but you want to include information on how students perform on several fitness tests as well. You have information on how many jumping jacks and push-ups each student can complete in a minute. However, you notice that students perform far more jumping jacks than push-ups: the average for the former is 40, and for the latter only 10. Should you scale or normalize these variables?
# 
# > ANS: Since these variables( forms of exercises) all contribute towards the same target fitness albeit differently(different calory burn), these are best scaled.
...
#>>The goal column is in different currencies. The rows of the column should be scaled to convert them into 
#one currency.
...
#We can easily confirm this by plotting the ratio of these columns(taking care not to divide by 0)
ratio_pledged = kickstarters_2017.pledged.loc[index_of_positive_pledges]/kickstarters_2017.usd_pledged_real.loc[index_of_positive_pledges]
sns.distplot(ratio_pledged)

# We can print out the currencies for a few cases wherein the ratio != 1
NonUSD_index = abs(kickstarters_2017.usd_pledged_real - kickstarters_2017.pledged) > 0
NonUSD_Pledge_currency = kickstarters_2017.currency.loc[NonUSD_index]
print(NonUSD_Pledge_currency[:10])
