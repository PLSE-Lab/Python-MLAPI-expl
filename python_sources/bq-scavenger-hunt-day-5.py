...
query = ("""
        SELECT sf.repo_name, COUNT(*) AS number_of_files
...
python_file_count_by_repo = github.query_to_pandas_safe(query, max_gb_scanned=6)
python_file_count_by_repo.head()
