...
rfr = RandomForestRegressor(n_estimators = 220, n_jobs = -1, random_state = 2016, verbose = 1)
...
pd.DataFrame({"id": id_test, "relevance": y_pred}).to_csv('rf_py_1602_01.csv',index=False)
