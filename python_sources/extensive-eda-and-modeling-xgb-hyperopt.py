...
# ### As other kernals are running slow i used seaborn and matplotlib
# 
...
# # Importing train datasets(identity and transaction)
...
# ***in try to learn and working on this karnel 
# **. * * * please vote for this karnel.thank you:)
