...
# 
# [Anomaly Detection Techniques Comparison](https://scikit-learn.org/0.20/auto_examples/plot_anomaly_comparison.html)
...
# ![anomaly_comparison](https://scikit-learn.org/0.20/_images/sphx_glr_plot_anomaly_comparison_001.png)
