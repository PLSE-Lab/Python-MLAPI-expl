...
X_train.drop(columns_to_drop, axis=1, errors="ignore").to_csv("train_python.csv", index=False, encoding='utf-8')
X_test.drop(columns_to_drop, axis=1, errors="ignore").to_csv("test_python.csv", index=False, encoding='utf-8')