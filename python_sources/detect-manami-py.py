...
copyfile(src = "../input/gleasonyolo/Detectx-Yolo-V3-master-manami/Detectx-Yolo-V3-master-manami/util.py", dst = "../working/util.py")
from util import *
...
from shutil import copyfile
copyfile(src = "../input/dnmodel/dnmodelmanami-py.py", dst = "../working/dnmodelmanami-py.py")
from DNModel import net

#img_process file import
...
if __name__ ==  '__main__':
    ...
    num_classes = 6
    classes = load_classes('../input/gleasonyolo/Detectx-Yolo-V3-master-manami/Detectx-Yolo-V3-master-manami/data/gleason.names') 
