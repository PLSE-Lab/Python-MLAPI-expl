...
# * Average of female is higher than average of male. Still it cannot be true that the reason of taking low grade can be being male. 
# 
...
# There can be the probability that students scored less as they were abscent more than seven days.
# The results we got are for these two only. Other students might have been abscent for more than seven days still have scored more marks.This condition might not be true for others.
