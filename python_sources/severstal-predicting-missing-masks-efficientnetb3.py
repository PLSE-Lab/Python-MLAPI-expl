...
# # <a id='2'>Loading and Rearranging DataFrame</a> 
...
# Each image is repeated 4 times in the dataset, one time for each class. 
...
# There are 23608 images which have no mask at all. Number of training images to train on later will decrease by significant amount. 
...
# # <a id='4'>Original vs Augmented Images</a> 
...
# # <a id='5'>Build and Train Model </a> 
