...
get_ipython().system('python pytorch-xla-env-setup.py --version 20200610 --apt-packages libomp5 libopenblas-dev > /dev/null')
get_ipython().system('pip install catalyst > /dev/null')
get_ipython().system('pip install --no-deps albumentations --force-reinstall > /dev/null')
get_ipython().system('pip install -q efficientnet_pytorch > /dev/null')
get_ipython().system('pip install --no-deps timm > /dev/null')
get_ipython().system('git clone https://github.com/4uiiurz1/pytorch-auto-augment > /dev/null')
