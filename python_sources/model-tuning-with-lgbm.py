...
# Based entirely on Abishek's, Bluefool's and Bojan's kernels, with the latest version by  Eric Antoine Scuccimarra. I tip my hat to you folks.
# 
# Like Eric Antoine Scuccimarra, I also have added little than tuning the lambda and have done no original contribution to the logic at this time.
# 
# But I give you 0.411, your welcome.
# 
...
#  
#  LIC - Thinking I may need to change error from rmse to AUC to see if model improves, also examine why LGB was used and if another model makes sense.
#  ** Lost_in_crossentropy-changelog **
#  * v3 - lowered lambda to 0.045, changed Nsplit to 5, early stop to 200 - (.411 result)
#  * v4 - raised lambda to 0.055, early_stop to 400 trying to avoid local maxima (.410 result)
#  * v5 - lowered lambda to 0.04,  (.410 result)
#  * v6 - raised lambda to 0.0425 with intend on v7 to go to 0.0476, move early stop to 600
#  * v7 - raise lambda 0.0475
#  * v8 - raise learn_rate=0.01, depth=9
#  
