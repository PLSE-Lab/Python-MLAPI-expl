...
param_grid = {'rfr__n_estimators' : [380],# 300 top
              'rfr__max_depth': [6], #list(range(4,10,2))
            }
model = grid_search.GridSearchCV(estimator = clf, param_grid = param_grid, n_jobs = -1, cv = 7, verbose = 150, scoring=RMSE)
