...
# 
# 
# - **White/Asian** dominant schools have an Average **Math Score** of  **3.04**.
...
safety = safety.rename(columns={'Location Name':'School Name'})
safe = safety[['School Name', '# Schools', 'AvgOfMajor N', 'AvgOfOth N', 'AvgOfNoCrim N', 'AvgOfProp N', 'AvgOfVio N', 'Borough Name', 'Register']]

safe_merge = pd.merge(safe, df, on='School Name', how='left')
safe_merge.head(3)
