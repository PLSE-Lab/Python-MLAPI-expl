...
data = pd.read_csv('/kaggle/input/cas-data-science-hs-19/houses_train.csv', index_col=0)
test_data = pd.read_csv('/kaggle/input/cas-data-science-hs-19/houses_test.csv', index_col=0)
