...
get_ipython().run_line_magic('time', "df_train = pd.read_csv('../input/train.csv', dtype = {'acoustic_data': np.int16, 'time_to_failure': np.float32} ) # float32 is enough :)")
...
get_ipython().run_line_magic('time', "np.savez_compressed('train_acoustic_data.npz', acoustic_data=df_train['acoustic_data'].values)")
get_ipython().run_line_magic('ls', '-lh')
