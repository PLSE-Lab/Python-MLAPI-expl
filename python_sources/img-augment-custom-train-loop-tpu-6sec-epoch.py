...
# # About
# Kernel contains image augmentation function which can 
# + rotate
# + crop
# + shear
# + shift
...
# + adjust gamma.
# 
# Since, the functions are implemented using tf and hence can be added to computational graph and prevents data augmentation or input pipeline from being the bottleneck.
# 
# It also has [custom training loop](https://www.kaggle.com/c/flower-classification-with-tpus/discussion/135443) making it much faster than **keras.fit** method. This reduces time taken for an epoch from 3 hrs to few seconds.
# 
# ![image](https://drive.google.com/uc?export=view&id=14lXZOqN49chDLhqDnSH1AkLNiilO7zFE)
# 
# Along with that, it has [concat tile dataset](https://www.kaggle.com/iafoss/panda-16x128x128-tiles-data) to improve scores. [This kernel](https://www.kaggle.com/iafoss/panda-16x128x128-tiles) has more information about the pre-processing pipeline of the dataset.
...
# train = train.head(512)
# valid = valid.head(128)
