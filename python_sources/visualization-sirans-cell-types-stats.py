...
# ## Type Wide Comparision(Same Channel)
# Comparision Over same channel and different type of images
...
# ## Count if there is any cell type that any siran type does not encounter
# The result shows that all types of the sirans are included in all kinds of cell types
...
# ## draw the histgram of different cell types over sirans
