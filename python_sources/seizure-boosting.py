...
# Version of ZFTurbo's excellent Seizure Boost script that:  
# a) Can actually run on the full data more than 10% of the time (by virtue of being a notebook)   
# b) Has some experimental additional features added me
