...
# # Regression with Optimized Rounder
# 
...
# ## Rounding and Prediction

# ### OptimizedRounder class to choose thesholds that result in best F1 score based on validation set
...
# ### We fit the optimizedRounder with our training data. We will then use those optimized coeffients for our test predictions
...
# ### F1 Score on validation set with standard numpy round() function
...
# ### F1 Score on validation set using optimized rounder
