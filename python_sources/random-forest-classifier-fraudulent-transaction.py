...
# ## About
# This notebook contains a very fast fundamental random forest classifier example in Python.
# 
...
# What we're trying to do here is to classify whether a credit card transaction is fraudulent.
