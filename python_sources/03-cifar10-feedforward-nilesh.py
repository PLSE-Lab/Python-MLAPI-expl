...
test_dataset_size = len(dataset)-len(test_dataset)
test_dataset_size
...
model = to_device(CIFAR10Model(input_size , 128 , 64 , 32 , output_size), device)
model
...
history += fit(25, 0.01, model, train_loader, val_loader)
