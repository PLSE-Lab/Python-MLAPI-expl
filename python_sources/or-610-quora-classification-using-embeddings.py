...
# 
# Now second we are training a Bidirectional LSTM model. We will not use any pre-trained word embeddings for this model and the embeddings will be learnt from scratch. Please check out the model summary for the details of the layers used. 
...
# 
# * In this section, let us use the Glove embeddings and rebuild the LSTM model.
...
# 
# Now let us use the FastText embeddings trained on Wiki News corpus in place of Glove embeddings and rebuild the GRU model.
...
# 
# Now let us use the FastText embeddings trained on Wiki News corpus in place of Glove embeddings and rebuild the LSTM model.
