...
# 
# Comments from this link: https://www.kaggle.com/serigne/stacked-regressions-top-4-on-leaderboard#231486  
...
data_imputed_lot_frontage = pd.read_csv('../input/housing-data-with-imputed-lotfrontage/housing_data_with_imputed_LotFrontage.csv')
data_imputed_lot_frontage.shape
...
'''RMSE on the entire Train data when averaging and trying 2 lgb models'''

print('RMSLE score on train data:')
print(rmsle(y_train,stacked_train_pred*0.55 +
               xgb_train_pred*0.15 + lgb_train_pred*0.15 + lgb_train_pred2*0.15 ))
