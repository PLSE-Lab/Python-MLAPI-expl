...
# Use of imbalanced-learn library to handle imbalanced datasets
# 
...
# Preprocess dataset to extract features and target value
...
# Additional advanced sampling like SMOTE and ADASYN can be explored to see its effect on this dataset as well
