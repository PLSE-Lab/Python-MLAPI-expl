...
# Kita memiliki data penjualan online hingga 30 november 2017, Pak Bos meminta untuk melakukan prediksi berapa penjualan kita untuk 2 minggu ke depan (1 Desember -14 Desember) Dari data penjualan online :
# 
# Olah data hingga mendapat total revenue per hari [sudah]
# Tambahkan data yang akan diprediksi [sudah]
# Persiapan data prediksi dan training
# Training dan testing (modelling)
