...
# * v7:Used efficientnet b1 instead of b0 with the early stopping patience changed to 8 from 5.Gave a macro f1 score of 0.82 for validation 
...
get_ipython().system('ls /kaggle/input/flower-classification-with-tpus')
