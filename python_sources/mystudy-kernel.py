...
get_ipython().system("cp ../input/mymodel/'how_to_train_effnet_b2_to_get_LB_0.88_best_fold0 (1).pth' how_to_train_effnet_b2_to_get_LB_0.88_best_fold0.pth")
...
#]
model_files = ['how_to_train_effnet_b2_to_get_LB_0.88_best_fold0.pth']
