...
# ******  for Missing Value You can also Use Simple Imputer but it consume too much time
# 
...
# 
# Each algo may be diff feature_importances col on that basis we can set particular threshold value and eliminate weak column
