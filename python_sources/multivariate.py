...
df = pd.read_csv("../input/fifa-18-demo-player-dataset/CompleteDataset.csv", index_col=0, low_memory=False)
...
#print(footballers.loc[footballers['Position'].isin(['ST', 'RW', 'LW'])].head())
