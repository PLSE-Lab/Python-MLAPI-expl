...
kgoal = kickstarters_2017.goal
scaled_goal =  minmax_scaling(kgoal, columns=[0])
fig, ax=plt.subplots(1,2)
...
indexOfPositive_pledged = kickstarters_2017.pledged > 0

positive_pledged = kickstarters_2017.pledged.loc[indexOfPositive_pledged]
