...
# This code is a modified version of my previous baseline kernel. Here I downsample training data heavily, using only
# 5% of 0 labels, and all 1 labels. Difference between LB scores achieved when training on the full data and on the downsampled data is rather small, though robust CV is important to confirm this conclusion.
# 
# > My previous kernel: https://www.kaggle.com/artkulak/ieee-fraud-simple-baseline-0-9383-lb
