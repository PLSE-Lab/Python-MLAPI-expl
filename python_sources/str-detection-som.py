...
# lable map
lable_map = som.labels_map(train_x,train_y)
lable_map


# **Quantixation error approach**

# In[ ]:


# training MiniSom with 2x1 map
som = MiniSom(2, 1, train_x.shape[1], sigma=1, learning_rate=0.5, neighborhood_function='triangle', random_seed=10)
som.train_random(train_x, 1000000)  # random training


# In[ ]:


# calculation of quantixation_errors
...
# STR detection with threshold
np.unique(train_y[quantization_errors>1.3], return_counts=True)
