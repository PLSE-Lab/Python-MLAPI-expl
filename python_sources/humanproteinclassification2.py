...
get_ipython().system('wget -O /root/.cache/torch/checkpoints/ https://storage.googleapis.com/kaggle-data-sets/751420%2F1299086%2Fcompressed%2Fresnet34-333f7ec4.pth.zip?GoogleAccessId=gcp-kaggle-com@kaggle-161607.iam.gserviceaccount.com&Expires=1593920252&Signature=BW9aZVB%2FlCtKwEQWGyGNPqLfG9Gb63pvno0qxbEIzuXUNbzZstZelqUtmWyH9Jj16TW0o6krHXuQhisEHFD53Bs%2BG4mklb3n5vS%2BeNxythzsH%2BYNWHHbZlxI07VsH2VZR0wIjhiKY5dybsLcV39oqcNlIAWMfwHiG7NxlWe9E8av2dwO72xNMp8wB6HPATxM2l0hR1LMYNFvpM6hLU8Xpr0MUVbCXsDJpVS%2BnDwn%2BJQtbAxv3RTXLzNRoTO3t7HUMgBCJ4gFNAFp86JWbKUZTwsrQgOu7SRFH%2BwI1rwByrYhYwfe5psqhJFKTZkNjrouT6w3sPb63EWt7Zk8T0%2BP9g%3D%3D')


# In[ ]:


get_ipython().system('cp ../input/resnet34333f7ec4pth/resnet34-333f7ec4.pth /root/.cache/torch/checkpoints/')


# In[ ]:


get_ipython().system('ls /root/.cache/torch/checkpoints/')
...
#kaggle competitions submit -c jovian-pytorch-z2g -f submission.csv -m "Predicted submission.csv file."
...
get_ipython().system('python -m pip install jovian --upgrade')
...
jovian.commit(project='zerogans-human-protein-competition')
