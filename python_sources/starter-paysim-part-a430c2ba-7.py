...
# ### Let's check 1st file: /kaggle/input/PS_20174392719_1491204439457_log.csv
...
df1 = pd.read_csv('/kaggle/input/PS_20174392719_1491204439457_log.csv', delimiter=',', nrows = nRowsRead)
