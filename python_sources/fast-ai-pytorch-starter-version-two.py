...
get_ipython().run_line_magic('time', 'df, df_valid = preprocess_fast_ai(df_to_nn_train, df_to_nn_valid, cat_vars)')
...
get_ipython().run_line_magic('time', 'train_df, test_df = preprocess_fast_ai(df_train, df_test, cat_vars)')
...
train_embeddings = get_embeddings(m.embs, train_df, train_ids, cat_vars)
