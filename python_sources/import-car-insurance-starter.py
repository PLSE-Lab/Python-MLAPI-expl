...
# # Column types
# If it is `object`, then it may contains some missing values.
...
# # Selecting features and converting to NumPy
# I only use the numeric features, that does not include missing values.
