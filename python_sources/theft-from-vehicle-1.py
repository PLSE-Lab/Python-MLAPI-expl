...
#
k=d[d.parent_incident_type.str.match(r'Theft from Vehicle*')]
t=k[['title','timeStamp','lat','lng','desc','twp']]
t=t[(t['timeStamp'] < '2016-01-01 00:00:00') ]
...
for i in range(0,len(lat)):
    ...
    s+="['%s ', %s, %s, %s,'https://storage.googleapis.com/montco-stats/images/tfvG.png'],\n" % (displayTitle,lat[i],lng[i],i)
...
k=d[d.parent_incident_type.str.match(r'Theft from Vehicle*')]
t=k[['title','timeStamp','lat','lng','desc','twp']]
t=t[(t['timeStamp'] >= '2016-01-01 00:00:00') & (t['timeStamp'] < '2017-01-01 00:00:00')]
title=t.title.tolist()
desc=t.desc.tolist()
twp=t.twp.tolist()
timeStamp=t.timeStamp.tolist()
...
for i in range(0,len(lat)):
    displayTitle="%s %s %s %s" % (title[i],desc[i],twp[i],timeStamp[i])
    displayTitle=displayTitle.replace('\n',' ')
    s+="['%s ', %s, %s, %s,'https://storage.googleapis.com/montco-stats/images/tfvY.png'],\n" % (displayTitle,lat[i],lng[i],i)
...
k=d[d.parent_incident_type.str.match(r'Theft from Vehicle*')]
t=k[['title','timeStamp','lat','lng','desc','twp']]
t=t[(t['timeStamp'] >= '2017-01-01 00:00:00')]
title=t.title.tolist()
desc=t.desc.tolist()
twp=t.twp.tolist()
timeStamp=t.timeStamp.tolist()
...
for i in range(0,len(lat)):
    displayTitle="%s %s %s %s" % (title[i],desc[i],twp[i],timeStamp[i])
    displayTitle=displayTitle.replace('\n',' ')
    s+="['%s ', %s, %s, %s,'https://storage.googleapis.com/montco-stats/images/tfvR.png'],\n" % (displayTitle,lat[i],lng[i],i)
