...
# # Global Wheat Detection - K-Fold Ensemble
# 
...
# * Use k-fold cross validation and ensemble
...
get_ipython().system('ln -snf /kaggle/input/weighted-boxes-fusion/ensemble_boxes && ls -lh')
