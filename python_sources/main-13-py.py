...
train = train.drop(['Name', 'Sex', 'Ticket', 'Cabin', 'PassengerId', 'Embarked'], axis=1)
...
test = test.drop(['Name', 'Sex', 'Ticket', 'Cabin', 'PassengerId', 'Embarked'], axis=1)
...
print('Training...')
forest = rfc(n_estimators = 3000, n_jobs = -1, random_state = 777, max_features = None)
