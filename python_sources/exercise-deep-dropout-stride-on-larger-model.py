...
fashion_model_1.add(Dense(128, 
                          activation='relu'))
fashion_model_1.add(Dense(num_classes, 
                          activation='softmax'))
...
fashion_model_2.add(Dense(128, 
                          activation='relu'))
fashion_model_2.add(Dense(num_classes, 
                          activation='softmax'))
...
fashion_model_3.add(Dense(128, 
                          activation='relu'))
fashion_model_3.add(Dense(num_classes, 
                          activation='softmax'))
