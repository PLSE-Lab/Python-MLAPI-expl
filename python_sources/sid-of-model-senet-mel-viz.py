...
op = pd.read_csv("sub/senet_mel.csv")
...
print(len([name for name in os.listdir('../test') if os.path.isfile(name)]))
...
for folder in (os.listdir('../train')):
    print(folder)
    sum += len(os.listdir("../train/"+folder))
