...
copyfile(src = "../input/script/my_answers.py", dst = "../working/my_answer.py")
from my_answer import *
...
import sys
sys.path.append('../input/my-script')
import numpy as np
import pandas as pd
...
from my_answer import NeuralNetwork
...
from my_answer import iterations, learning_rate, hidden_nodes, output_nodes
