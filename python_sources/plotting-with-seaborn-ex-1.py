...
#or
sns.distplot(pokemon.HP,kde=True,color='purple')


# In[ ]:


sns.jointplot(x='Attack', y='Defense', data=pokemon,color='red',kind='scatter')


# In[ ]:


sns.jointplot(x='Attack', y='Defense', data=pokemon, kind='hex',color='blue')#,ratio=5,space=0.06)
