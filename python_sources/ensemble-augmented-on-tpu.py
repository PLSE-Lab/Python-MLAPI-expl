...
# - [CutMix and MixUp on GPU/TPU](https://www.kaggle.com/cdeotte/cutmix-and-mixup-on-gpu-tpu) version 7
# - [Rotation Augmentation GPU/TPU[0.96+]](https://www.kaggle.com/cdeotte/rotation-augmentation-gpu-tpu-0-96) version 1
# 
# ### This Notebook
# 
# *     Image augmentation
#     -  Rotate, shear, zoom, shift from Rotation Augmentation GPU/TPU - [0.96+]
...
get_ipython().system('pip install -q efficientnet tensorflow_addons')
