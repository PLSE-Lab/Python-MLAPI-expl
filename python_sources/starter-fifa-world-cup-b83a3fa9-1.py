...
df1 = pd.read_csv('../input/WorldCupMatches.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/WorldCupPlayers.csv', delimiter=',', nrows = nRowsRead)
...
nRowsRead = 1000 # specify 'None' if want to read whole file
df3 = pd.read_csv('../input/WorldCups.csv', delimiter=',', nrows = nRowsRead)
