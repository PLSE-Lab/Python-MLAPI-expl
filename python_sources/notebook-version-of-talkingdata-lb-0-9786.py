...
# To get the public LB: 0.9786, please run the version: 10.
# I made cosmetic changes in the [code](https://www.kaggle.com/aharless/kaggle-runnable-version-of-baris-kanber-s-lightgbm/code). Added some new features. Ran for 25mil chunk rows. i have another 2 kernels on same dataset. You can look if you want. 
# My scripts are : 
# 1. [TalkingData: Added new features in LightGBM](https://www.kaggle.com/asraful70/talkingdata-added-new-features-in-lightgbm): This one is just script version of Notebook version, it runs faster than notebook version.
# 2.  [TalkingData XGBoost implementation](https://www.kaggle.com/asraful70/talkingdata-xgboost-implementation) : This one is developed on XGBoost algorithm.
# 

# Importing required libraries . Check before running whether it is in debug=0 or 1.  If dubug=0 then it will run for submitting in competition. Otherwise it will run only for checking.

# In[ ]:


FILENO= 24 #To distinguish the output file name3
