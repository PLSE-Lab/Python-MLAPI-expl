...
clf = MLPClassifier(hidden_layer_sizes=(128, 64, 128, 8), activation='relu', 
     beta_1=0.9, beta_2=0.999, alpha = 0.01, early_stopping = True, validation_fraction = 0.25,
     learning_rate_init=0.001, max_iter = 8000, random_state = 88889, #1235, 
     learning_rate='adaptive')
...
submission.to_csv("z_submission_NN_v4_Apr7.csv", index=False)
