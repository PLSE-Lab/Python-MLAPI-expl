...
# # We loaded the modules necessary for pre-processing and analysis
# 
# # Project by 16BCB0001 and 16BCB0092
# 
# # First step: Load the data and clean it using inbuilt functions
# ****
...
# # Second Step: Analysis of the Dataset
...
# On analysis it was found that many people send mails to themselves.
...
ax1.hist(dict(G.in_degree(weight='count')).values(), log=True, bins=20)
ax1.set_xlabel('In-degrees', fontsize=18)

ax2.hist(dict(G.out_degree(weight='count')).values(), log=True, bins=20)
