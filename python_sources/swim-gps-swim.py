...
ax = sns.scatterplot(x="distance", y="time",                      hue="favorite", legend="full", palette = "BuGn_r", data=df1)
...
# Is that a violinplot above? Maybe Vin Diesel smashed my violins. Sniff, sniff.
