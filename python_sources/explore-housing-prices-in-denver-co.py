...
def load_zillow_data(state=None,county=None,region=None,city=None):
    ...
    for row in filtered_dataframe:
        final_df = filtered_dataframe[['2008-01', '2008-02', '2008-03', '2008-04', '2008-05', '2008-06',
               ...
               '2020-01','2020-02','which_measurement']]
...
denver_df = load_zillow_data(state='CO',county='Denver County',
...
denver_df.plot(title='Median Prices of Homes and Rental Units in Denver, CO',figsize=(12,9), grid=True)
...
plot_four_columns_using_plotly_regular(denver_df,'City_MedianRentalPrice_Studio', 
                                       'City_MedianRentalPrice_1Bedroom','City_MedianRentalPrice_2Bedroom',
                                       'City_MedianRentalPrice_3Bedroom','Median Rental Prices in Denver, CO',
                                      '2011-12-01','2020-02-01')
...
plot_four_columns_using_plotly_express(denver_df,'City_MedianRentalPrice_Studio','City_MedianRentalPrice_1Bedroom',
                                       'City_MedianRentalPrice_2Bedroom','City_MedianRentalPrice_3Bedroom',
                                       'Median Rental Prices in Denver, CO','2011-12-01','2020-02-01')
...
plot_seven_columns_using_plotly_regular(denver_df,'City_Zhvi_Condominum', 'City_Zhvi_SingleFamilyResidence',
                                        'City_Zhvi_1bedroom','City_Zhvi_2bedroom','City_Zhvi_3bedroom',
                                        'City_Zhvi_4bedroom','City_Zhvi_5BedroomOrMore','Median Home Prices in Denver, CO')
...
plot_seven_columns_using_plotly_express(denver_df,'City_Zhvi_Condominum', 'City_Zhvi_SingleFamilyResidence',
                                        'City_Zhvi_1bedroom','City_Zhvi_2bedroom','City_Zhvi_3bedroom',
                                        'City_Zhvi_4bedroom','City_Zhvi_5BedroomOrMore','Median Home Prices in Denver, CO')
