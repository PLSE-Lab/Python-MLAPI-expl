...
train = pd.read_csv("../input/volcano-dataset/train_images.csv",header=None)

train_labels = pd.read_csv("../input/volcano-dataset/train_labels.csv")
...
classifier.fit(X_train,train_labels,batch_size=10,nb_epoch=10)

###### testing the model on test dataset

# read test data
test = pd.read_csv("../input/volcano-dataset/test_images.csv",header=None)
...
# read test labels
test_labels = pd.read_csv("../input/volcano-dataset/test_labels.csv")
