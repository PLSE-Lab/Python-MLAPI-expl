...
# #### this was one reason I created this notebook - it appeared that the ratio was very different for some countries (example Italy and Germany) and I wanted to check other countries
...
# ## deaths / population
# #### this is the main reason I created this notebook - to look at number of deaths when taking into account a country's population (will add more countries later)
...
df_temp = df_cov_country[['Country/Region', 'deaths_' + str_current_date, 'PopulationMillions', 'deaths_population' ]]
df_temp.head(300)
