...
data_train_split,data_validation,labels_train_split,labels_validation = train_test_split(data_train,labels_train, test_size = 0.1, random_state = 123456)
...
def preprocess_text(text):
    ...
    import string
    string.punctuation
    sw = ['to', 'the', 'a'] + [x for x in string.punctuation]
...
def preprocess(train_data,validation_data,test_data):
    ...
    # vectorize data
    vectorizer = CountVectorizer(max_df = 0.95, min_df = 0.001)
