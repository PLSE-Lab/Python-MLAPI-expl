...
get_ipython().system('cp ../input/my-kaggle-json/kaggle.json /root/.kaggle/')
...
data = '''{
  "title": "Panda_Dataset_medium_256_256",
  "id": "micheomaano/panda-dataset-medium-256-256",
  "licenses": [
    {
      "name": "CC0-1.0"
    }
...
OUT_TRAIN = '/tmp/panda_dataset/train_medium_256_256.zip'
OUT_MASKS = '/tmp/panda_dataset/masks_medium_256_256.zip'
sz = 256
N = 48
...
get_ipython().system('unzip -q /tmp/panda_dataset/train_medium_256_256.zip -d /tmp/train_images')
...
get_ipython().system('kaggle datasets create -p /tmp/panda_dataset -u')
