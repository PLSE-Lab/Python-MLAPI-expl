...
# 1. [Start data-preparation process](#start_data_preparation_process)
# 1. [Save prepared train data](#save_prepared_train_data)
...
# Hi everyone!
# 
# I just join this wonderful competition and thanks to `@timesler`'s [*Facial recognition model in pytorch*](https://www.kaggle.com/timesler/facial-recognition-model-in-pytorch) kernel, now I have something to start with. Although the idea in `@timesler`'s kernel is pretty simple and there are still many parts that need to be improved, I have chosen this as the starting point and tried to reproduce the whole process from `data preparation` to `inference`. I hope that by doing so I will have a better understanding of the data and be able to improve the whole pipeline or even create the new ones.
# 
# I will use sample data to demonstrate the approach I used in this baseline.
# 
# ---
# ## Baseline's diagram
...
# 1. *Data Preparation* <- **you're here**
...
# <a id="save_prepared_train_data"></a>
# # Save prepared train data
# [Back to Table of Contents](#toc)
...
# <a id="conclusion"></a>
# # Conclusion
# So, we have done the first step in the whole pipeline. Let's move on to the next step -> [*Deepfake Detection - Training*](https://www.kaggle.com/phunghieu/deepfake-detection-training-baseline).
# 
