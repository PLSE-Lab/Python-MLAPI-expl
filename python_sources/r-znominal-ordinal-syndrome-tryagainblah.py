...
train_s["New1"] = train_s["T2_V2"] ^ 5
test_s["New1"] = test_s["T2_V2"] ^ 5
train_s["New2"] = train_s["T1_V1"] ^ 3
test_s["New2"] = test_s["T1_V1"] ^ 3
train_s["New3"] = train_s["T1_V2"] ^ 8
test_s["New3"] = test_s["T1_V2"] ^ 8
train_s["New4"] = np.where(train_s["T1_V10"] * train_s["T2_V1"] < 450,1,0)
test_s["New4"] = np.where(test_s["T1_V10"] * test_s["T2_V1"] < 450,1,0)
...
train_s.drop('T2_V2', axis=1, inplace=True)
train_s.drop('T1_V6', axis=1, inplace=True)
train_s.drop('T1_V9', axis=1, inplace=True)
train_s.drop('T2_V1', axis=1, inplace=True)
train_s.drop('T1_V2', axis=1, inplace=True)
...
test_s.drop('T2_V2', axis=1, inplace=True)
test_s.drop('T1_V6', axis=1, inplace=True)
test_s.drop('T1_V9', axis=1, inplace=True)
test_s.drop('T2_V1', axis=1, inplace=True)
test_s.drop('T1_V2', axis=1, inplace=True)
