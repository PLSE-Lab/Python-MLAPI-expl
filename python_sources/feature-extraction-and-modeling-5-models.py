...
#  3) modeling (Logistic,scv,Random forest,stacking,votingClassifier)<pre/>

# *upvote if you find anything helpful*
...
# There are 2 data files provided for solving this problem. So lets load them

# In[ ]:


# Loading training_variants. Its a comma seperated file
data_variants = pd.read_csv('/kaggle/input/msk-redefining-cancer-treatment/training_variants')
