...
# Was watching this [Learn With Me: Getting Started with Tensor Processing Units (TPUs) | Kaggle](https://youtu.be/1pdwRQ1DQfY) and decided to try it. 

# ![](http://)# A Simple TF 2.2 notebook
# 
...
# https://www.kaggle.com/mgornergoogle/getting-started-with-100-flowers-on-tpu/output
