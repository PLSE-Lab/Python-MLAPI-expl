...
# Preprocessing for numerical data
numerical_transformer = SimpleImputer(strategy='constant') # ____ # Your code here
...
# Define model
model = RandomForestRegressor(n_estimators=100, random_state=0) #____ # Your code here
