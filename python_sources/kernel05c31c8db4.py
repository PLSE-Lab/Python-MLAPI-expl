...
get_ipython().run_line_magic('env', 'KAGGLE_USERNAME=vels3113')
get_ipython().run_line_magic('env', 'KAGGLE_KEY=ed4d7da96041e1b6092151dc7ca72e5d')

# Verify
get_ipython().system('export -p | grep KAGGLE_')

# Submit (you can find this command from the section "My submissions" within the competition page)
get_ipython().system('kaggle competitions submit -c plates -f submission.csv -m "Test"')
