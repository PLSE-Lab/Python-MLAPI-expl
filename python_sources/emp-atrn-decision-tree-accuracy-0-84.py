...
# **We will implement Decision tree for this to see how accuracy varies**
...
# **With above set of computations, we computed hyper paramter value individually and find best one manually. By using Grid search, we automate this to get optimized hyper parameter value considering all the hyper parameter at once **
# 
