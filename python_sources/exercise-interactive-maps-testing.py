...
# # Keep going
# 
# **[Learn how to](https://www.kaggle.com/alexisbcook/manipulating-geospatial-data-testing)** convert names of places to geographic coordinates with geocoding.  You'll also explore special ways to join information from multiple GeoDataFrames.
