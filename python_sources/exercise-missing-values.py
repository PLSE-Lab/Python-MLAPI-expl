...
missing_cols = [cols for cols in X_train.columns if X_train[cols].isnull().any()] # Your code here
...
# > Drop methods has less MAE than Imputation, which means in this case drop method performed better.
