...
# - We'll be using the data from the competition <a href='https://www.kaggle.com/c/home-credit-default-risk'>Home Credit Default Risk</a>.
...
# Enjoy this kenel by creating a model with the above features selected.
