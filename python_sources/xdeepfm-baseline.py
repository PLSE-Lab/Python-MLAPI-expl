...
get_ipython().system('git clone https://github.com/guoday/ctrNet-tool.git')
get_ipython().system('cp -r ctrNet-tool/* ./')
get_ipython().system('rm -r ctrNet-tool data .git')
get_ipython().system('ls -all')
...
for i in range(hparam.kfold):
    ...
    model.train(train_data=(train.iloc[train_index][features],train.iloc[train_index]['HasDetections']),                dev_data=(train.iloc[dev_index][features],train.iloc[dev_index]['HasDetections']))
