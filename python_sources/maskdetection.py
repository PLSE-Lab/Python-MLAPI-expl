...
# From these generated files, i will generate weights for this dataset using Darknet/yoloV3 in colab due to training time issue. Then i will use those weights to get predictions on training images. Weights will be uploaded in this kernel.
...
# ## Predict Objects in some training images
...
images = os.listdir('../input/face-mask-detection-dataset/Medical mask/Medical mask/Medical Mask/images')[:10]
...
DATA_PATH='../input/face-mask-detection-dataset/Medical mask/Medical mask/Medical Mask/'
...
"""#iterating through first 10 images
for file in images:
...
df =  pd.read_csv('../input/face-mask-detection-dataset/submission.csv')
df.head()
...
df=pd.read_csv(os.path.join("../input/maskdec/result1.csv"))
df
