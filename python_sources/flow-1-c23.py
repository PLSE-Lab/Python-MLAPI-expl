...
data_x_raw=pd.read_csv("../input/data0709/data_csv_0608_x_notime_cp_all.csv")
...
train_x, test_x, train_y, test_y  = train_test_split(data_x_sel,data_y_sel[y_field],random_state=1,test_size=0.5,stratify=data_y_sel[y_field]) 
