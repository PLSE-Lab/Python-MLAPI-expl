...
class Sudoku:
    ...
    def check_location_is_safe(self, empty_index, num):
        ...
        return not self.used_in_row(empty_index, num) and not \
                   self.used_in_col(empty_index, num) and not \
                   self.used_in_box(empty_index, num)
    ...
    for filename in filenames:
        ...
        with open(path) as csv_file:
            ...
            for row in csv_reader:
                ...
                #print("\n"*4)
            print(f"20.000 sudoku puzzles solved in {time.time() - start} seconds.")