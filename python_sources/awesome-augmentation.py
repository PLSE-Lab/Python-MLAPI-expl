...
# 
# I hope this notebook will save someone's time.
...
# # Faster RCNN testing
# This is just a copy of [this notebook](https://www.kaggle.com/pestipeti/pytorch-starter-fasterrcnn-inference)

# In[ ]:


WEIGHTS_FILE = '/kaggle/input/yoloaugment/yoloaug_transfer_crmaug_epoch_9.pth'
