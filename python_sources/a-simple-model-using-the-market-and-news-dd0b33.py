...
def divide_assets(all_assets, parts):
    return_arr = []
...
def cross_validation(X, Y, parts, scoring):
    scores = []
...
# cross_validation(X, y, 5, sigma_score)
...
uniqueue_assets = X['assetCode'].value_counts()
uniqueue_assets = uniqueue_assets.sample(frac=1, random_state=173)
