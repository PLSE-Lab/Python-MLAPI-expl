...
# 
# The column "Employee Number" is also removed since it should not (logically) be a contributing factor to attrition.. unless there is some mystical numbers game going on?
# 
...
## Drop the Attrition_EmployeeNumber from attrition dataset as well
## This variable shouldn't be a contributing factor, unless.....
...
# 
# **GBM most important features**  : Monthly Income, Daily and Monthly Rate
# 
# Interestingly, the features that the Gradient Boosting model has placed its importance on differs quite greatly from that of the Random Forest. It has decided to rank features with a lot of economic significance highest such as the monthly income and the daily and monthly rate. However what is puzzling is the inclusion of the Employee number as an important feature. (EDIT: Since Employee number was removed earlier, this is no longer an important feature)
