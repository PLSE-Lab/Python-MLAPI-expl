...
# Let's get started!
# 
# I have forked the original version of this notebook and include my version.
...
# We see that in this dataset too,the date column is of the type object
...
# We get an error if we apply the function directly.This is because we see that some of the values in the date column has time component .Let us see how many are there like this.Credits to Kunal Kumar Shah and Kyle Livermore for helping me out to rectify this error.
...
# We see that there are 3 values that have time component included in the date column.We need to remove them and parse.
...
earthquakes_with_normal_dates.info()
...
earthquakes_1=earthquakes_with_normal_dates.copy()
earthquakes_1['date_parsed']=pd.to_datetime(earthquakes_1['Date'], format = "%m/%d/%Y")


# In[20]:


earthquakes_1['date_parsed'].dtype
...
day_of_month_earthquakes=earthquakes_1['date_parsed'].dt.day
