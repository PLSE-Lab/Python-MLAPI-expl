...
# ## Kaggle env
# https://www.kaggle.com/thisray/kaggle-submit-example-single-sentence-predict
...
data_path = "../input"
data_file = 'emotionpush_kaggle.json'
submit_file = 'emotionpush_kaggle_samplesubmit.csv'
