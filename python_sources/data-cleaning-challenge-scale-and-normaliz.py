...
# plot both together to compare, Create a figure and a set of subplots
...
sns.distplot(kickstarters_2017.goal, ax=ax1[0])
ax1[0].set_title("Original Data")
sns.distplot(scaled_data_goal, ax=ax1[1])
ax1[1].set_title("Scaled data")
...
sns.distplot(positive_pledged, ax=ax2[0])
ax2[0].set_title("Original Data")
sns.distplot(normalized_pledged, ax=ax2[1])
ax2[1].set_title("Normalized data")
