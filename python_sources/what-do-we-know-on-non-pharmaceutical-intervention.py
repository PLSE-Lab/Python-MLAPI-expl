...
#The patterns below generated by getting the simentically similar words with non-pharmaceutical (e.g non-pharmacological, therapeutical, non-chemical)  in en_core_web_lg dictionary.
