...
# <div style="text-align: center"><h2>Akash Gupta............ March madness men's</h2></div>

# ![](https://www.ncaa.com/sites/default/files/public/styles/focal_point_large/public-s3/images/2019/03/18/2019-NCAA-bracket-March-Madness.jpg?h=56158cc3&amp;itok=tr5l8Cl4)
...
sub[['ID', 'Pred']].to_csv('akash1.csv', index=False)
