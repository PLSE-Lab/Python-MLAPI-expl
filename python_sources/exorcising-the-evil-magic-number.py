...
#   https://www.kaggle.com/valadi/magic-numbers-new-change/code

# It should get the same result (LB 0.31038, if I'm following the link right), 
#   but without using the suspect number 1.054880504
#   which I earlier derived from luckyzhou's script 
#   that used house price index data from the test period

# Instead of using that number, I fit a substantive macro model 
#   and a naive macro model to the training data
#   and use a weighted average of their results to adjust the micro model output.

# Hopefully this is now within the rules of the competition

# See Alexey Matveev's reply to this discussion post:
#    https://www.kaggle.com/c/sberbank-russian-housing-market/discussion/35215
# Magic numbers as such are within the rules, but there seems to be a suggestion that
#    they would be unacceptable if they are traceable to 
#    external data related to ground truth

#  -- Andy Harless  2016-06-25
...
macro_humility_factor = 0.696526  #  I contend this is a legitimate tunable parameter,
                                  #    not a magic number
