...
df = pd.read_csv('/kaggle/input/2019_data.csv')


# In[ ]:


df2=pd.read_csv('/kaggle/input/PGA_Data_Historical.csv')
...
# ### Let's check 1st file: /kaggle/input/2019_data.csv
...
# ### Let's check 2nd file: /kaggle/input/PGA_Data_Historical.csv
...
plotPerColumnDistribution(df2,5,2)
