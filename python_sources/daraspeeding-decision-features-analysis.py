...
ax0=sns.barplot(y="predictors.columns", x="Model.Feature_Importances_Based_on_F", data=dfFemales,
             palette="Blues")
...
ax3=sns.barplot(y="predictors.columns", x="model.feature_importances_", data=dfFemales,
             palette="Blues")
