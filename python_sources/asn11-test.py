...
#  BEFORE RUNNING THIS:
#
# FROM THE CONSOLE: RUN THE COMMAND '!git clone https://github.com/matterport/Mask_RCNN.git'
# THEN RUN: 'os.chdir('Mask_RCNN')'
#
...
masks = pd.read_csv('kaggle/../input/train_masks.csv')
