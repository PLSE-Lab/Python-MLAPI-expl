...
# # SVM (Support Vector Machine) Implementation on Cancer Dataset
...
# ![](https://i.pinimg.com/originals/39/00/8d/39008de73cf4ba1787b3ff91b9fd1163.png)

# It is the technique that helps us draw the best line that separates the two classes given in the graph.

# <a id = "5"></a>
# # 5. SVM Code Implementation With Sklearn
