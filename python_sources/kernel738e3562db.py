...
history = model.fit_generator(mygenerator_batch(train_table, 8), steps_per_epoch = 1, epochs = 1, validation_data = mygenerator_batch(val_table, 8), validation_steps = 1, verbose = 1, shuffle = True)
