...
train = pd.read_csv('../input/hard-drive-data-and-stats/data_Q3_2019/data_Q3_2019/2019-07-19.csv')
train=train.append(pd.read_csv('../input/hard-drive-data-and-stats/data_Q3_2019/data_Q3_2019/2019-07-18.csv')  )
train=train.append(pd.read_csv('../input/hard-drive-data-and-stats/data_Q3_2019/data_Q3_2019/2019-07-17.csv')  )
train=train.append(pd.read_csv('../input/hard-drive-data-and-stats/data_Q3_2019/data_Q3_2019/2019-07-20.csv')  )

test = pd.read_csv('../input/hard-drive-data-and-stats/data_Q3_2019/data_Q3_2019/2019-07-25.csv')
test['failure']=np.nan
...
def clustertechniques2(dtrain,label,indexv):
    ...
    clanaam= ['rFor','Xtree','xgb','GrBo','Gauss','QDis']#,'KNN','rFor','Xtr','MLP','Decis','LinDis','QuadDis']#['Logi','KNN','rFor','SVC','MLP','SGD']
...
class Dummy( ):
    ...
    def fit_transform( self, X, y = None ):
        return X 
sub,sign=clustertechniques2(train.append(test),'failure','serial_number') #total[len(train):].fillna(0)
#enc
