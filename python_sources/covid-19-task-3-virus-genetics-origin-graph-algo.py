...
# ## Examples: Below is a snapshot of some of the answers against questions related to Task 3
# 
# ![image.png](attachment:image.png)
...
Task='Task 03'
data=pd.read_excel("/kaggle/input/task3covid/task3_results_summary.xlsx")

qadata=pd.read_excel("/kaggle/input/covid-task-qa-answer/task3_results_summary_QA.xlsx")
