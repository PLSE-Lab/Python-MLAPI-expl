...
if __name__ == "__main__":
    ...
    new_train_1=train.var15[train['TARGET']==1]
    new_train_0=train.var15[train['TARGET']==0]
    train_1=np.random.poisson(train.var15[train['TARGET']==1].mean(),train.var15[train['TARGET']==1].count())
    train_0=np.random.poisson(train.var15[train['TARGET']==0].mean(),train.var15[train['TARGET']==0].count())
    train.var15[train['TARGET']==1]=train_1
    train.var15[train['TARGET']==0]=train_0
