...
# ## This is a solution for [digit-recognizer(MNIST)](http://https://www.kaggle.com/c/digit-recognizer) using scikitlearn's SVM, it is very easy to implement and it gives a not bad score of **0.97542** on the official dataset
