...
def get_submission_df(predicts):
    ...
    for img_name, mask_prob in predicts.items():
        ...
        if len(class_dict) == 0:
            sub_list.append([img_name+ ".jpg", "1 1", 1])
        else:
...
# !ls ../input/resnet34fastai


# In[ ]:


# !rm -rf /tmp/.torch/models/resnet34-333f7ec4.pth
# !mkdir -p  /tmp/.torch/models/
# !cp ../input/resnet34fastai/resnet34.pth  /tmp/.torch/models/resnet34-333f7ec4.pth
# !ls -ltr /tmp/.torch/models/resnet34-333f7ec4.pth
...
# Crap I wasted 2 days thinking something is wrong in code & it is not downloading the resnet file. Issue was internet access was turned on.
...
# load by adding a data set output of 
# https://www.kaggle.com/nikhilikhar/fastai-imaterialist-224/

get_ipython().system(' cp ../input/fastai-imaterialist-224/models/stage-1-224.pth /kaggle/working/models/stage-1-224.pth')
# temp = learn.load("../input/fastai-imaterialist-224/models/stage-1-224")
temp = learn.load("stage-1-224")
