...
grid.map(sns.pointplot,'Pclass', 'Survived', 'Sex', alpha=0.5, bins=20)
grid.add_legend()
...
models = pd.DataFrame({
    'Model': ['Support vector mechines', 'KNN', 'Logist Regression', 'Random Forest', 'Naive Bayes', 'Perceptron', 
