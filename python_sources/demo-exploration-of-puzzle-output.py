...
# ### Defining Functions for Loading and Drawing Boards
...
class GameState(object):
    ...
    def _load_data(self):
        ...
        polygons = list()
        shape_csv_file_names =             [os.path.join(self._data_directory,
...
def generate_table(table_number):
    ...
    if table_number == 1:
        ...
        source_board_filename =             TABLE_FORMAT.format(TABLE_DIRECTORY,
                                table_number - 1,)
...
# ### Random Sample of Results from Table 3
...
boards = load_boards_from_csv('../input/puzzle-output/validation_table_9.csv')
