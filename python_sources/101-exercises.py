...
def starts_and_ends_with_vowel(string):
        if string[0] in 'aeiouAEIOU' and string[-1] in 'aeiouAEIOU':
            return True
        else:
            return False
...
def only_positive_numbers(seq):
    only_positive = [num for num in seq if num > 0] 
...
def only_negative_numbers(seq):
    only_negative = [num for num in seq if num < 0] 
