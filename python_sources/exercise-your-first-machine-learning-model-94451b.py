...
#Look here some information about data.
home_data.head()
...
print('description of target data')
X.describe()
...
print('Some rows of target data:')
X.head()
...
#Look here the prediction values for 10 houses
print(iowa_model.predict(X.head(10)))
