...
# I'm going to load a model trained in the original version of the kernel, so I comment lines corresponding to training. Please see the original kernel for more details.
