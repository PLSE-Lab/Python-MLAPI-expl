...
# Baseline predictions using [TFHub](https://tfhub.dev/google/faster_rcnn/openimages_v4/inception_resnet_v2/1)
...
# **More Helper functions for visualization of results**
# 
...
image_path = "../input/test/b797946840abf33c.jpg"
