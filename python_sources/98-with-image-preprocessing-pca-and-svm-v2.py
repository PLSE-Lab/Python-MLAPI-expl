...
clf = OneVsRestClassifier(svm.SVC(kernel='rbf', class_weight='balanced',C=10,gamma=.005))
...
for i in list(range(len_test_data)):      
    pred_rev=9 #For the predicted labels out of bound, just set it to a random label 9
