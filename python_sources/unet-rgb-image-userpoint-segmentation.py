...
trainPointNames=[]
for dirname, _, filenames in os.walk('/kaggle/input/Annotations/Point/'):
...
results = model.fit(train_x, train_mask_y, validation_data=(valid_x, valid_mask_y), epochs=50, batch_size=16, verbose=1)
