...
x_train = df_train.drop(['parcelid', 'logerror', 'transactiondate', 'propertyzoningdesc','poolcnt','decktypeid',
                         'pooltypeid10', 'basementsqft',
                         'yearbuilt','yardbuildingsqft26',
                        'yardbuildingsqft17','finishedsquarefeet6',
                         'poolsizesum', 'propertycountylandusecode'], axis=1)
