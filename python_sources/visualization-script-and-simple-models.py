...
# This is a modified version of the Kaggle kernel: https://www.kaggle.com/hnike25/best-machine-learning-model-on-the-dataset
...
get_ipython().system('pip install plotly==2.3.0')
