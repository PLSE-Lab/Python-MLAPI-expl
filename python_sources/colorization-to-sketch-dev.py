...
len(os.listdir('/kaggle/working/real-img-test'))
...
plt.imshow(Image.open('/kaggle/working/real-img/imgreal_1500.jpeg'))
...
import matplotlib.pyplot as plt
get_ipython().run_line_magic('matplotlib', 'inline')
plt.imshow(Image.open('/kaggle/working/sketch-img/img_1500.jpeg'))
...
get_ipython().system('pip3 install tensorlayer')
...
model1 = PaintsTensorFlowTrain()


# In[ ]:


model1.training(loadEpochs=loadEpochs)
