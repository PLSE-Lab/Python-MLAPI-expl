...
# # Read papers Selected for Task6 

# In[ ]:


Task='Task 07'
data=pd.read_excel("/kaggle/input/task3covid/task6_results_summary.xlsx")

qadata=pd.read_excel("/kaggle/input/covid-task-qa-answer/task6_results_summary_QA.xlsx")
...
def print_summary(query_i_text):
    ...
    display(HTML("-------End-----"*15))
def cluster_sentence(query_i_text):
    query_i_embed=model.encode([query_i_text],show_progress_bar=False)
