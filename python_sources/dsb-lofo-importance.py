...
# # Data Science Bowl 2019 LOFO Importance 

# This kernel is based off of a combination of the following kernels:
# 
# [https://www.kaggle.com/braquino/890-features](http://)
# 
# [https://www.kaggle.com/divrikwicky/nfl-lofo-importance](http://)
# 
# Leave One Feature Out (LOFO) Importance allows us to not only see which features are important for our model, but also the ones that are a detriment to model performance. Due to the large number of features generated in the '890 Features' public kernal, we can try to remove a lot of features that give us worse model performance.
...
# # Install lofo importance package
...
# # Setup Parameters for our model

# We will be using a LightGBM regressor model to perform our lofo importance analysis
...
# The importance dataframe can then be passed into the plot_importance method for data visualization. First plot shows 50 top features. Second plot shows 50 worst features
