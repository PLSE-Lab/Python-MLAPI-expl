...
# Create a process to find all the PDF files on the drive, write them to list and count the number of files.  *Revised to get data from Kaggle Drive rather than Kaggle API.
# 
...
# Run the extraction and token process (Read all the files and words and tokenize.)
