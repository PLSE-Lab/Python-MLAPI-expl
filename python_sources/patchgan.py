...
def train_cityscapes(d_model, g_model, gan_model,loss_model,shape, n_epochs=45, n_batch=1, n_patch=16):
    ...
    for i in range(n_steps):
        ...
        if i>15000 and i<35000 and i%10 == 0:
            show_images(X_realB[0],ans[1][0],X_realA[0])
...
# train pix2pix models
def train_facades(d_model, g_model, gan_model,loss_model,shape, n_epochs=20, n_batch=1, n_patch=16):
...
train_cityscapes(d_model,g_model,gan_model,loss_model,image_shape)
