...
if __name__ == "__main__":
	...
	skf = StratifiedKFold(n_splits=9, shuffle=False, random_state=777)
	...
	test_file.close()
	print(test_X.shape)
	skf_sp = skf.split(train_X, train_y)
	for i, (train0, val) in enumerate(skf_sp):
	    if i == 8:
	        train_X_f = train_X[train0,:]
	        train_y_f = train_y[train0]
	        break
	print("Building model..")
	model = runXGB(train_X_f, train_y_f, seed_val=0)
	del train_X, train_y
	print("Predicting..")
