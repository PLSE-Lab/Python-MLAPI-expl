...
def get_hashes(arr):
    ...
    if 1:
        ...
        sub.append((4, antiguedad))
        sub.append((5, ind_nuevo))
        sub.append((6, ind_actividad_cliente))
        sub.append((7, canal_entrada))
        sub.append((8, ind_nuevo,canal_entrada))
        sub.append((9, ind_empleado))
        sub.append((10,pais_residencia, sexo, renta1, age, segmento))
        sub.append((11,sexo, age, segmento))
        sub.append((12,pais_residencia, sexo, antiguedad, segmento, ind_empleado))
        sub.append((13,sexo, antiguedad, ind_empleado, ind_nuevo, canal_entrada ))
    else:
        # Random set
...
def date_is_important(date):
    ...
    koeff = 1
    score = 10 + koeff*possible_dates.index(date)
    return score
