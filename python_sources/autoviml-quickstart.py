...
'''
# comment out because the next routines use all the ram
...
# transform data into format we can perform regression on
...
dft = AV.AutoViz('', ',', 'accuracy_group', reduce_train, header=0, verbose=0, lowess=False, chart_format='svg', max_rows_analyzed=150000, max_cols_analyzed=30)
