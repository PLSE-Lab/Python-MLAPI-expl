...
usecols = ['ncodpers', 'ind_aval_fin_ult1', 'ind_cco_fin_ult1',
...
#df_train['sexo'] = df_train['sexo'].factorize()[0].astype('float16')
#df_train.loc[df_train['sexo'] == 1] = 0
#df_train.loc[df_train['sexo'] == 2] = 1
