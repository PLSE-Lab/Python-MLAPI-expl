...
# Note:  There are some variables in categorical_features which can be converted to fload and can be used as numeric variables, such as ['totals.bounces', 'totals.hits', 'totals.newVisits', 'totals.pageviews', 'totals.transactionRevenue',
# 'totals.visits'].
