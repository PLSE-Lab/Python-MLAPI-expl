...
feature_cols = ["ind_empleado","pais_residencia","sexo","age", "antiguedad", "nomprov", "segmento","conyuemp","canal_entrada"]
...
if __name__ == "__main__":
	...
	train_size = 13647309
	nrows = 1050000 # change this value to read more rows from train
