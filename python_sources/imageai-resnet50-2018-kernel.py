...
# <br>
# 
# This is is starter kernel, using a resnet50 pretrained model, based on the kernels shared by Miha Skalic: [Classifier as a bounding-box predictor](https://www.kaggle.com/mihaskalic/classifier-as-a-bounding-box-predictor) & Shivam Bansal : [Objects + Bounding Boxes using Resnet50 - ImageAI ](https://www.kaggle.com/shivamb/objects-bounding-boxes-using-resnet50-imageai)
# 
