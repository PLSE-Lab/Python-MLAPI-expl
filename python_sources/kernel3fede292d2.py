...
# Speical Thanks for getting ideas from this Kernel
...
get_ipython().system("cp '../input/resetnet50-weight/resnet50-19c8e357.pth' '/tmp/.cache/torch/checkpoints/resnet50-19c8e357.pth'")
