...
# 68 % of the titles in this dataset is of Movie type whereas 32 % is of TV show type.
...
# There has been a 5 % increase in TV shows in the year 2016.
...
# Maximum titles were added during the month of December.Lets check whether the trend is change is different between TV show and movie title.
