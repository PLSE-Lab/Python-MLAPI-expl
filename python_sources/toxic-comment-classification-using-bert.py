...
# This kernel has been adapated from another kernel. The main change is that the BERT model is accessed via the internet instead of locally saved files in Kaggle workspace.
