...
last_amount_italy = test.loc[(test['Country_Region']=='Italy')&(test['Date']==lb_date_pp),'ConfirmedCases_y']
last_fat_italy = test.loc[(test['Country_Region']=='Italy')&(test['Date']==lb_date_pp),'Fatalities_y']


# In[ ]:


last_amount_ny = test.loc[(test['Country_Region']=='US')&(test['Province_State']=='New York')&(test['Date']==lb_date_pp),'ConfirmedCases_y']
last_fat_ny = test.loc[(test['Country_Region']=='US')&(test['Province_State']=='New York')&(test['Date']==lb_date_pp),'Fatalities_y']
...
last_amount_spain = test.loc[(test['Country_Region']=='Spain')&(test['Date']==lb_date_pp),'ConfirmedCases_y']
last_fat_spain = test.loc[(test['Country_Region']=='Spain')&(test['Date']==lb_date_pp),'Fatalities_y']


# In[ ]:


last_amount_germany = test.loc[(test['Country_Region']=='Germany')&(test['Date']==lb_date_pp),'ConfirmedCases_y']
last_fat_germany = test.loc[(test['Country_Region']=='Germany')&(test['Date']==lb_date_pp),'Fatalities_y']
...
for date in dates_pp:
    k = k-1
    i = i + 1
    test.loc[(test['Country_Region']=='Spain')&(test['Date']==date),'ConfirmedCases_x'] =  last_amount_spain.values[0]+i*(6000-(80*i))
...
for date in dates_pp:
    k = k-1
    i = i + 1
    test.loc[(test['Country_Region']=='Germany')&(test['Date']==date),'ConfirmedCases_x'] =  last_amount_germany.values[0]+i*(6000-(80*i))
    test.loc[(test['Country_Region']=='Germany')&(test['Date']==date),'Fatalities_x'] =  last_fat_germany.values[0]+i*(400-(10*i))
...
for date in dates_pp:
    k = k-1
    i = i + 1
    test.loc[(test['Country_Region']=='US')&(test['Province_State']=='New York')&(test['Date']==date),'ConfirmedCases_x'] = 75833.0+i*(7000-(80*i))
    test.loc[(test['Country_Region']=='US')&(test['Province_State']=='New York')&(test['Date']==date),'Fatalities_x'] =  1550.0+i*(600-(10*i))
