...
current = pd.read_json("../input/tickerjson/ticker.json")
...
dec6 = pd.read_json("../input/coinmarket/api.coinmarketcap.com.json")
...
volatility = volatility.reset_index().dropna().set_index('id')
