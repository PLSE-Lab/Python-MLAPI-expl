...
boulder_df_rental = load_zillow_data_rental(state='CO',county='Boulder County',
                              region='Boulder',city='Boulder')
boulder_df_house = load_zillow_data_house(state='CO',county='Boulder County',
                              region='Boulder',city='Boulder')
...
plot_four_columns_using_plotly_regular(boulder_df_rental,'City_MedianRentalPrice_Studio', 
                                       'City_MedianRentalPrice_1Bedroom','City_MedianRentalPrice_2Bedroom',
                                       'City_MedianRentalPrice_3Bedroom','Median Rental Prices in Boulder, CO',
...
plot_four_columns_using_plotly_express(boulder_df_rental,'City_MedianRentalPrice_Studio','City_MedianRentalPrice_1Bedroom',
                                       'City_MedianRentalPrice_2Bedroom','City_MedianRentalPrice_3Bedroom',
                                       'Median Rental Prices in Boulder, CO','2011-12-01','2020-02-01')
...
plot_seven_columns_using_plotly_regular(boulder_df_house,'City_Zhvi_Condominum', 'City_Zhvi_SingleFamilyResidence',
                                        'City_Zhvi_1bedroom','City_Zhvi_2bedroom','City_Zhvi_3bedroom',
                                        'City_Zhvi_4bedroom','City_Zhvi_5BedroomOrMore','Median Home Prices in Boulder, CO')
...
plot_seven_columns_using_plotly_express(boulder_df_house,'City_Zhvi_Condominum', 'City_Zhvi_SingleFamilyResidence',
                                        'City_Zhvi_1bedroom','City_Zhvi_2bedroom','City_Zhvi_3bedroom',
                                        'City_Zhvi_4bedroom','City_Zhvi_5BedroomOrMore','Median Home Prices in Boulder, CO')
