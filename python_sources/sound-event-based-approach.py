...
# # Attempt E4: Sound event based approach
# This attempt  tried to extract sound events by preprocessing data, then model classifies based on what kind of events data have. This scored about val_acc 0.72, but it improved ensemble score much.
# 
# Model is something special, based on [TensorFlow Speech Recognition Challenge 2nd place solution](https://www.kaggle.com/c/tensorflow-speech-recognition-challenge/discussion/47715) by [Thomas O'Malley](https://www.kaggle.com/omalleyt). 
# I have created similar network before finding this, but this was found to be better and improved about 0.3-0.5.
# 
# My sound event extraction here is not strict one - just subtracting time-wise mean from the data. This is the part:
# 
# ```Python
...
# ```
# 
# OK now I have to start with importing dependent external modules.
...
# ## Load, pseudo background subtraction and confirm some of data.
...
epochs = 10 # CHANGE TO 250, 20 is just for Kaggle kernel
...
# ## Define model
# This is based on [TensorFlow Speech Recognition Challenge 2nd place solution](https://www.kaggle.com/c/tensorflow-speech-recognition-challenge/discussion/47715) by [Thomas O'Malley](https://www.kaggle.com/omalleyt). 
...
model = model_cnn7(X_train.shape[1:])
model.summary()
