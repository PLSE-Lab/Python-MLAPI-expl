...
sns.boxplot(x="Overall", y="Aggression", hue='Position', data=f, hue_order=['GK','ST'],linewidth=2)
...
sns.heatmap(f, annot=True,linecolor='white',linewidths=2)
...
sns.lmplot(x='Attack', y='Defense', hue='Legendary', 
           markers=['o', '1'],hue_order=[True,False],
