...
# # 1. Importing libraries and loading files
...
dev_data, valid_data, dev_labels, valid_labels =     train_test_split(train, train['requester_received_pizza'], test_size=0.2)
