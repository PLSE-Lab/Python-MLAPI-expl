...
clf = xgb.XGBClassifier(missing=np.nan, max_depth=5,  objective           = "binary:logistic",
                        
                        n_estimators=1000, learning_rate=0.01, 
                        subsample=0.6, colsample_bytree=0.85, seed=4242)

# fitting
clf.fit(X_fit, y_fit, early_stopping_rounds=70, eval_metric="auc", eval_set=[(X_eval, y_eval)])
