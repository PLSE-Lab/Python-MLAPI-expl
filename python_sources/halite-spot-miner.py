...
AGENTS = (AGENTS 
                    + [a for a in AGENTS if 'c22-' in a] * 2
                      + [a for a in AGENTS if 'c22-basic-raider' in a] * 10
                          + [a for a in AGENTS if 'c30-base' in a] * 10
                              + [a for a in AGENTS if 'c31-' in a] * 3
         ) 
