...
# # Titanic Prediction Kernel - samueljklee
# 
# 
# ### This notebook refers to (and forked from) [Startupsci's Titanic Kernel](https://www.kaggle.com/startupsci/titanic-data-science-solutions). 
# 
# This is my first time participating in Kaggle's competition and applying Machine Learning on their dataset. For this kernel, I will be refering to Startupsci's kernel to learn the process and hands on Machine Learning practices. 
...
print(train_df.groupby(['Embarked'])['Embarked'].count())
...
# calculate the coefficient of features in the decision function
...
# Decision Tree
# predictive model which maps features (tree branches) to conclusions about the target value (tree leaves)
# DT with target variable with continuous values aka regression tree
