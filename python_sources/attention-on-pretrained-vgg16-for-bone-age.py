...
get_ipython().system('ls -l ../input/rsna-bone-age')
...
# !ls -l ../input/rsna-bone-age/boneage-training-dataset/boneage-training-dataset | wc -l
...
age_df['boneage_zscore'].hist(figsize=(10,5))


# In[ ]:


age_df[['boneage', 'boneage_zscore']].hist(alpha=1.0)
...
age_df['boneage_zscore'].hist(stacked=True, bins=20)
...
train_df[['boneage', 'gender']].hist(stacked=True, bins=20)
...
c = np.stack(train_df['boneage_zscore'].values)
