...
train_df.drop(train_df[train_df['Id'] == 1299].index, inplace=True)
train_df.drop(train_df[train_df['Id'] == 524].index, inplace=True)
...
train_df.drop(['LotFrontage'], 1, inplace=True)
...
X_train, X_test, y_train, y_test = train_test_split(train_df_munged, label_df, test_size=0.2,random_state=0)
...
regr = GradientBoostingRegressor(n_estimators=1100,criterion='mse')
