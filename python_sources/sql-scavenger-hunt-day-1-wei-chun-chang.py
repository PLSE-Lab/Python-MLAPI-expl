...
# <font size=3>The follow-up-notes are from [Ms Rachel's tutorial note](https://www.kaggle.com/rtatman/sql-scavenger-hunt-day-1?utm_medium=email&utm_source=mailchimp&utm_campaign=sql+scav+hunt)</font>
# 
...
# _____________________________________________________________________________________________________________________________________________
# 
# **<font size = 3>OK! Now it's my turn to work!</font>**
# 
...
query = """SELECT country
            ...
            WHERE unit != 'ppm'
        """
Special_unit_countries = open_aq.query_to_pandas_safe(query)


# In[ ]:


Special_unit_countries.country.value_counts().head()
...
Zero_pollution.pollutant.value_counts().head()


# This is a practice ! Feel free to give suggestions!
