"""
This is from the julian python library, since the library is just one script, 
I figured it's easier to import utility scripts than to create a new library.
