...
fifa_data.tail()# Your code here


# Use the first 5 rows of the data to answer the question below.

# Show first five rows to to give following answer.
...
# **Solution**:-Country code BRA spent at least 5 consecutive years in the #1 rankeed spot. 
