...
transactions_query = """ WITH time AS 
            (
                SELECT TIMESTAMP_MILLIS(timestamp) AS trans_time,
                    transaction_id
                FROM `bigquery-public-data.bitcoin_blockchain.transactions`
...
bitcoin_blockchain.estimate_query_size(transactions_query)
transactions_in_2017 = bitcoin_blockchain.query_to_pandas_safe(transactions_query, max_gb_scanned=21)
display(transactions_in_2017)
