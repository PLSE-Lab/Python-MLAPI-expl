...
def preprocess(train):
    ...
    train["Orientation_sin"] = train["Orientation"].apply(lambda x : np.sin(2 * np.pi * x/360.0))
    train["Orientation_cos"] = train["Orientation"].apply(lambda x : np.cos(2 * np.pi * x/360.0))
    train["Dir_sin"] = train["Dir"].apply(lambda x : np.sin(2 * np.pi * x/360))
    train["Dir_cos"] = train["Dir"].apply(lambda x : np.cos(2 * np.pi * x/360))
...
#         train["YardLine_ob"] = train["YardLine"].astype("object")
        ...
        df["Orientation_sin"] = df["Orientation"].apply(lambda x : np.sin(2 * np.pi * x/360.0 ))
        df["Orientation_cos"] = df["Orientation"].apply(lambda x : np.cos(2 * np.pi * x/360.0 ))
        add_new_feas.append("Orientation_sin")
        add_new_feas.append("Orientation_cos")
        df["Dir_sin"] = df["Dir"].apply(lambda x : np.sin(2 * np.pi * x/360.0))
        df["Dir_cos"] = df["Dir"].apply(lambda x : np.cos(2 * np.pi * x/360.0))
