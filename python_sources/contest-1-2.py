...
get_ipython().system('ls ../input/padhai-module1-level-1')
get_ipython().system('unzip ../input/padhai-module1-level-1/level_1_test.zip')
get_ipython().system('unzip ../input/padhai-module1-level-1/level_1_train.zip')
