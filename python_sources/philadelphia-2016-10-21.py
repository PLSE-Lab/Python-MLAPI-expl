...
<html>
  ...
  <body> <!--  DataCanary_s fix -->
    ...
    <script>
      ...
      zoom: 15,
      center: {lat: 39.980333, lng: -75.159713 }
...
# Just this year
d=  d[(d.Dispatch_Date_Time	 >= "2016-10-21 00:00:00") & (d.Dispatch_Date_Time	 <= "2016-10-23 00:00:00")  ]
...
#k=d[(d.Text_General_Code == 'Weapon Violations')]
k=d
...
for i in range(0,len(lat)):
    ...
    s+="['%s', %s, %s, %s,'https://storage.googleapis.com/montco-stats/images/crossHairs.png'],\n" % (displayTitle,lat[i],lng[i],i)
