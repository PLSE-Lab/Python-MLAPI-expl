...
1. Create a utility scripy from this code as explained https://www.kaggle.com/product-feedback/91185
2. You need to pip install torchsummary before importing this script!!
"""
import warnings
            ...
            if early_stopping is not None:
                ...
                if early_stopping.early_stop:
                    ...
                    if early_stopping.save_best_weights:
                        ...
                        if isinstance(model, PytkModuleWrapper):
                            mod = model.model
                        mod.load_state_dict(torch.load(early_stopping.checkpoint_file))
                    return history
...
class PytkModule(nn.Module):
    ...
    def summary(self, input_shape):
        ...
        try:
            ...
            warnings.warn('Warning: torchsummary is not available on this VM. summary() will display basic structure of model!')
...
class PytkModuleWrapper():
    ...
    def summary(self, input_shape):
        ...
        if summary_available:
            ...
            if torch.cuda.is_available():
                print(self.model.cuda())
            else:
                print(self.model.cpu())