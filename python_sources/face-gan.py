...
class FaceGenerator:
    ...
    def train(self, datafolder ,epochs,batch_size,save_images_interval):
        ...
        for epoch in range(epochs):
            ...
            if epoch  == 100 or epoch  == 2000 or epoch  == 3500 or epoch  == 5000: 
...
get_ipython().run_line_magic('time', 'facegenerator.train(datafolder="../input/lagdataset_200/LAGdataset_200/",epochs=5050, batch_size=128, save_images_interval=50)')
...
# Any results you write to the current directory are saved as output.
os.listdir("../input/lagdataset_200/LAGdataset_200/")
import cv2
import matplotlib.pyplot as plt

img = cv2.imread("generated_images/generated_5000.png")
