...
train=pd.read_csv('/kaggle/input/train-pro/train_pro2.csv')
test=pd.read_csv('/kaggle/input/test-pro/test_pro2.csv')
sub = pd.read_csv('/kaggle/input/samplesub-pro/SampleSubmission_BNBR.csv')
...
final.to_csv('20fold_rbl_1_5e-5_wd_0_32_128_epoch4_clean_data.csv',index=False)
