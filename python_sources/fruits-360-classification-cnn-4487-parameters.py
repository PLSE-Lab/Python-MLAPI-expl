...
feature_extractor = keras.models.Model(inputs=model.input, outputs=model.get_layer('dense').output)
...
x_encoded_train=feature_extractor.predict(x_train)
...
tsne_results = tsne.fit_transform(x_encoded_val)
