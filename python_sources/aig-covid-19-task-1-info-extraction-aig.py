...
data=pd.read_excel("/kaggle/input/task3covid/task1_results_summary.xlsx",index=False).dropna()
...
dict_val={'Range of incubation periods for the disease in humans (and how this varies across age and health status) and how long individuals are contagious, even after recovery.':[		'What is known about incubation period of the virus',
...
'Disease models, including animal models for infection, disease and transmission':[		'What is known about disease model of the virus'],
		...
		'What is known about environmental survival  of the virus']}
