...
<html>
  ...
  <body> <!--  DataCanary_s fix -->
    ...
    <script>
      ...
      zoom: 13,
      center: {lat: 40.0714874, lng: -75.1347011}
...
# Vehicle Accident - Cheltenham, July 1700


k = d[(d.title == 'Traffic: VEHICLE ACCIDENT -') & (d.twp == 'CHELTENHAM') ]
k['Month'] = k['timeStamp'].apply(lambda x: x.strftime('%m %B'))
k['Hour'] = k['timeStamp'].apply(lambda x: x.strftime('%H'))


c = k[(k.Month == '07 July') & (k.Hour == '17')]



t=c[['title','timeStamp','lat','lng','desc','twp']]
