...
params = {"objective": "binary:logistic",
          "eta": 0.17,# used to be 0.2 or 0.1
          "max_depth": 8, # used to be 5 or 6
          "min_child_weight": 1,
          "silent": 1,
          "colsample_bytree": 0.7,
          "seed": 1}
num_trees=470 #used to be 300, 375 is better
...
submission.to_csv("rf_xgboost_keras_flatness_v5al.csv", index=False)