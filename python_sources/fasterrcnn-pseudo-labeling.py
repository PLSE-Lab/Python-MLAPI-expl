...
# I use a published fasterRCNN model and then continue train it for 3 more epochs with pseudo labeling. 
# By using this technique, I improve the LB from 0.6687 to 0.6937
# 
...
# 
# 
# **I also published 2 notebooks of centernet training and inference
...
# 
# Your upvotes will be my motivation to upgrade those notenote as I make improvements
...
DIR_WEIGHTS = '/kaggle/input/fastercnn'

WEIGHTS_FILE = f'{DIR_WEIGHTS}/epoch_4'
