...
# #### The only constraints we have are number of ppl in a day is >=125 AND <=300
# ##### therefore, firstly lets just calculate the total sum of ppl
...
# ##### ok, since we have 21,003 ppl against 100 days, on average one day has 210 ppl which satisfies the constraints
# ##### but just in case, lets check the distribution of n_people in a family
...
# #### so it was found that number of people in a family varies from 2 to 8.
