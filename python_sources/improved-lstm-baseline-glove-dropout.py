...
predict_for("I love food")[0][0]


# In[ ]:


predict_for("I love italian food")[0][0]


# In[ ]:


predict_for("I love mexican food")[0][0]


# In[ ]:


predict_for("I love african food")[0][0]


# In[ ]:


predict_for("Happy ramadan to all muslims")[0][0]


# In[ ]:


predict_for("i love this black dress")[0][0]


# In[ ]:


predict_for("i love this green dress")[0][0]
