...
# **Ref.:** https://www.kaggle.com/suicaokhoailang/ensembling-with-averaged-probabilities-0-701-lb
...
preds_t = np.load("../input/rxt50-448-674-rxt50-224-591-rxt50-224-5-688/rx50_448_preds.npy")+          np.load("../input/resnext50-sz384-bb-b16-npy/rx50_preds.npy")+          np.load("../input/resnext50-sz384-b16-npy/rx50_preds.npy")
