...
# * [**Day 4:** WITH & AS](https://www.kaggle.com/rtatman/sql-scavenger-hunt-day-3/)
# 
# ____
# 
...
# Your code goes here :)
query1 = """SELECT f.repo_name, count(c.commit) as num_of_commits
...
commit_per_repos = github.query_to_pandas_safe(query1,max_gb_scanned=6)
