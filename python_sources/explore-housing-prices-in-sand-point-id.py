...
#                           'City_Zhvi_SingleFamilyResidence','City_Zhvi_Condominum']
    final_df.columns = ['City_Zhvi_2bedroom','City_Zhvi_3bedroom',
                          'City_Zhvi_4bedroom','City_Zhvi_5BedroomOrMore','City_Zhvi_AllHomes',
                          'City_Zhvi_SingleFamilyResidence','City_Zhvi_Condominum']
...
sandpoint_df = load_zillow_data(state='ID',county='Bonner County',region='Sandpoint',city='Sandpoint')
...
sandpoint_df.plot(title='Median Prices of Homes and Rental Units in Sand Point, ID',figsize=(12,9), grid=True)
...
plot_seven_columns_using_plotly_regular(sandpoint_df,'City_Zhvi_Condominum', 'City_Zhvi_SingleFamilyResidence',
                                        'City_Zhvi_AllHomes','City_Zhvi_2bedroom','City_Zhvi_3bedroom',
                                        'City_Zhvi_4bedroom','City_Zhvi_5BedroomOrMore','Median Home Prices in Sand Point, ID')
...
plot_seven_columns_using_plotly_express(sandpoint_df,'City_Zhvi_Condominum', 'City_Zhvi_SingleFamilyResidence',
                                        'City_Zhvi_2bedroom','City_Zhvi_3bedroom','City_Zhvi_AllHomes',
                                        'City_Zhvi_4bedroom','City_Zhvi_5BedroomOrMore','Median Home Prices in Sand Point, ID')
