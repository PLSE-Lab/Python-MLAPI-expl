...
#     ! python -m pip install spacy pandas nltk matplotlib
#     ! python -m pip install --upgrade textacy
...
os.system("python -m pip install spacy textacy nltk matplotlib")
...
from summariser_cosine_class           import SummariserCosine
from summariser_tfidf_class            import SummariserTFIDF
from summariser_tfidf_variation_class  import SummariserTFIDFVariation
from summariser_pytextrank_class       import SummariserPyTextRank
