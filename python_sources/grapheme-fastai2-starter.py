...
# ### This kernel uses fastai version-2 on a fork of the original notebook ["Grapheme fast.ai starter"](https://www.kaggle.com/iafoss/grapheme-fast-ai-starter-lb-0-964), thanks to @lafoss.
# 
# ### Since the use of internet is not allowed, I created a [fastai2 dataset](https://www.kaggle.com/sheriytm/fastai2) with the required files to run fastai version-2. Add [my dataset](https://www.kaggle.com/sheriytm/fastai2), follow the installation steps in the following cells and you are good to go.
# 
