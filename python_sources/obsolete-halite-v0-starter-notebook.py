...
# # **6.2.20 UPDATE - this notebook explored Halite in its initial form, and has not been updated to reflect the latest changes in Kaggle environments or Halite gameplay rules**
