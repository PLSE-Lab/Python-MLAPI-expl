...
# pred_dfs = {name: cm.predict_first_day(64).sort_values("geo") for name, cm in cov_models.items()}


# blend_df = get_blend(pred_dfs, weights)
# eval_df = blend_df.copy()

# for d in range(65, 77):
...
sub_df[sub_df["geo"] == flat[3]][["day"] +TARGETS].plot(x="day")
plt.axvline(TEST_FIRST, color='r', linestyle='--', lw=2)
