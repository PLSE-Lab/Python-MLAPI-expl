...
# ### 3) plotting the "Counts" based on the "Season"
...
# ### 4 ) plotting the "counts" based on the "holidays"
...
# ### 5) plotting the "Counts" based on "Working day"
...
# ### 6) plotting the "Counts" based on the "Weather"
...
# ### 7) plotting the "Counts" based on the "Temparature"
...
# ### 8) plotting the "Counts" based on "atemp"  (atemp - "feels like" temperature in Celsius)
...
# ### 9) plotting the "Counts" based on "Humidity"
...
# ### 10) plotting the "Counts" based on "Windspeed"
...
# ### 11) plotting the "Counts" based casual "User"
...
# ### 12) observing the data types and information of the columns 
...
# ### 13) Generate descriptive statistics that summarize the central tendency,dispersion and shape of a dataset's distribution
...
# ### 14) loading the test data and looking at the first and last 5 rows of the test data
...
# ### 15) Installing the pandas profiling library. It is used for a deeper understanding than the normal Dataframe.describe() method
...
# ### 16 ) Detailed report using Pandas Profiling
...
# ### 17) printing shape and Checking Nan
...
# ### 18) plotting the count plot based on hour for 2011 and 2012
...
# ### 19)plotting monthly and hourls bike rentals based on year
...
# ### 20) method to plot a graph for count per hour
...
# ### 21 ) converting the column to datetime for train dataset and adding the hour column for train dataset
...
# ### 22 ) converting the column to datetime for test dataset and adding the hour column for test dataset
...
# ### 23) plotting hourly count of rented bikes for working days and Non-working days for a given year
...
# ### 24)method to convert categorical data to numerical data
...
# ### 25) applying the above conversion logic to training data
...
# ### 26) applying the above conversion logic to test data
...
# ### 28) An Hour vs Count Graph depicting average bike demand based on the hour
...
# ### 29) count of different temp values
...
# ### 30) count of different atemp values
...
# ### 32) method to  select the features
...
# ### 33 ) a method to show results of various model and their predictions
...
# ### 34 ) calcuating the cross validation score
