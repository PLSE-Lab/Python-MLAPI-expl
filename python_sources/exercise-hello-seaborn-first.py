...
# Some questions won't require you to write any code.  Instead, you'll interpret visualizations.  These questions don't require a <font color='#33cc33'>Correct</font> result, and you won't be able to check your answer.  
# 
# But you should still check the <font color='#33cc99'>Solution</font> to ensure your interpretation is right.
# 
...
#It's only brazil as it is the only country which has the longest uninterrupted streak.For spain,there are 2 cases
#Where the yearly streak is broken by brazil(2009-2010)
