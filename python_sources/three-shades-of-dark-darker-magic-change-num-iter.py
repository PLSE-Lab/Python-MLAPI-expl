...
# This notebook investigates the LB scores for various *num_iteration* of estimator.predict in https://www.kaggle.com/kyakovlev/m5-three-shades-of-dark-darker-magic.  
# Thank Yakovlev for sharing the great notebook very much.
# 
# |num_iteration|LB score|
# |---|---|
# |not set(original)|0.47506|
# |1400|0.47506|
# |1300|0.47450|
# |1200|0.47505|
# |1100|0.47509|
# 
# ToDo: Set different *num_iterations* for each *store_id*
