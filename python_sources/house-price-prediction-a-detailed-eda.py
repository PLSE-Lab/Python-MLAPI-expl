...
# <h1><center>HOUSE PRICE PREDICTION USING ADVANCED ML TECHNIQUES</center><h1>
...
# # Let us visualize what we are plotting
...
print(f'Root Mean Square Error test =  {str(math.sqrt(sklm.mean_squared_error(y_test, y_pred_test)))}')   
...
print(f'Root Mean Square Error test  {str(math.sqrt(sklm.mean_squared_error(y_test, y_lasso_test)))}')
...
elasticmod = elastic_cv.fit(x_train, y_train.ravel())
ela_pred=elasticmod.predict(x_test)
print(f'Root Mean Square Error test = {str(math.sqrt(sklm.mean_squared_error(y_test, ela_pred)))}')
print(elastic_cv.alpha_)
...
print(f'Root Mean Square Error test = {str(math.sqrt(sklm.mean_squared_error(y_test, xg_pred)))}')
...
print(f'Root Mean Square Error test = {str(math.sqrt(sklm.mean_squared_error(y_test, vote_pred)))}')
...
print(f'Root Mean Square Error test = {str(math.sqrt(sklm.mean_squared_error(y_test, stacking_pred)))}')
...
print(f'Root Mean Square Error test=  {str(math.sqrt(sklm.mean_squared_error(y_test, final_test)))}')
