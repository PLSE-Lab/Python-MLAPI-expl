...
# I just created a copy with small enhancements of https://www.kaggle.com/amiiiney/price-prediction-top-15-regularization-stacking. See also my comment https://www.kaggle.com/amiiiney/price-prediction-top-15-regularization-stacking#805478
...
# * But before going any futher, we start by cleaning the data from missing values. I set the threshold to 90% (red line), all columns with more than 90% missing values will be dropped.
