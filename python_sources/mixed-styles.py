...
vgg16_model=ks.applications.vgg16.VGG16(weights=mw,input_tensor=input_tensor,include_top=False)
...
vgg16_model2=ks.applications.vgg16.VGG16(weights=mw,input_tensor=input_tensor2,include_top=False)
# Create layer dictionaries
...
vgg16_model=ks.applications.vgg16.VGG16(input_tensor=input_tensor,include_top=False)
vgg16_layer_dict={layer.name:layer for layer in vgg16_model.layers}
