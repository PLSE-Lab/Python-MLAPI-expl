...
# 
# Latest Addition: Method of seperate constraints for each score/ratio
...
# ### Filter Combinations to Have Those With Sum of Weights > 0.95 AND Apply Weight Constraints
# 
