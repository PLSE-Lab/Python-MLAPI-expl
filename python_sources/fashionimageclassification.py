...
train_df= pd.read_csv("../input/kaggle-fashion/kaggle_fashion_product_train (2).csv")
val_df = pd.read_csv("../input/kaggle-fashion/kaggle_fashion_product_validation (2).csv")
test_df = pd.read_csv("../input/kaggle-fashion/kaggle_fashion_product_test (2).csv")
...
direc = '../input/fashion-product-images-dataset/fashion-dataset/images/'
...
train_generator = train_datagen.flow_from_dataframe(
        dataframe=train_df,
        directory='../input/fashion-product-images-dataset/fashion-dataset/images/',
        x_col="filepath",
        y_col="subCategory",
        target_size=(224, 224),
        batch_size=64,
...
model.save_weights("Fashion_pretrain_resnet50_weights_shuffled.h5")
