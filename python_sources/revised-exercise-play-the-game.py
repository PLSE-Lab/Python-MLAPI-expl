...
# # The original Exercise will create Error in the submission. In this file, I revised codes to make all submssion work.
...
env.play([agent_q1, None], width=500, height=450)
