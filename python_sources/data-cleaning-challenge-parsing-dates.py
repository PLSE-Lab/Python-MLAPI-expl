...
volcanos['Last_known_year_parsed'].head(10)
...
for x in volcanos['Last Known Eruption']:
    if x!= 'Unknown':
        year, era = x.split()
        if era=='BCE':
            years.append('-'+ year)
...
volcanos['Last_Known_year_parsed']= years

print(volcanos['Last_Known_year_parsed'].head())
...
_=sns.distplot(volcanos['Last_Known_year_parsed'].dropna())
