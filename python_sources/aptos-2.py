...
get_ipython().system('ls /kaggle/images/train/0 | wc -l')
get_ipython().system('ls /kaggle/images/train/1 | wc -l')
get_ipython().system('ls /kaggle/images/train/2 | wc -l')
get_ipython().system('ls /kaggle/images/train/3 | wc -l')
get_ipython().system('ls /kaggle/images/train/4 | wc -l')
...
get_ipython().system('ls /kaggle/images/val/0 | wc -l')
get_ipython().system('ls /kaggle/images/val/1 | wc -l')
get_ipython().system('ls /kaggle/images/val/2 | wc -l')
get_ipython().system('ls /kaggle/images/val/3 | wc -l')
get_ipython().system('ls /kaggle/images/val/4 | wc -l')
...
get_ipython().system('ls ../images/test')
...
get_ipython().system('ls ../imagestrain/3')
