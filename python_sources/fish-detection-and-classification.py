...
def main():
    ...
    train_files, train_data, train_resp =         extract_img_features(training_data_dir)
    ...
    if os.path.exists(testing_data_dir):
        ...
        test_files, test_data, test_resp =             extract_img_features(testing_data_dir, type='test')
