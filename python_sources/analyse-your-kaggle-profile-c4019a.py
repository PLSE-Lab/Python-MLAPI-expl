...
def _analyze_profile(username):
    ...
    metrics = {"mytags" : mytags, 
               "unigrams" : unigrams,
               "unigrams_d" : unigrams_d,
               "bigrams" : bigrams,
               "bigrams_d" : bigrams_d,
...
# This is a fork of this great kernel: https://www.kaggle.com/shivamb/analyse-your-kaggle-profile-framework
# <br>
# MetaKaggle is an amazing dataset, and this past week I wanted to extract some insights about my kaggle activity over past 6 months. I prepared this kernel as a tool / framework to analyze all the discussions made by any kaggler. Using the dataset shared in MetaKaggle dataset, I have prepared this kernel template (which can be improved further) to analyze all discussions of a kaggle profile. 
# 
