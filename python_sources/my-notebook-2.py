...
# **Notebook Objective:**
# 
# Classify first without embeddings and later with embeddings. FInally club the results each stage 30%
# 
...
plt.hist([val_y])
plt.title('Distribution of Original Test(slpit from train) data')
plt.xlim(0,1)
plt.xlabel('Label') # 1->insincere; 0->not insincere
...
plt.hist([round(float(i)) for i in pred_noemb_val_y])
plt.title('Distribution of Predicted Test(slpit from train) data without any Pretrained Embeddings')
plt.xlim(0,1)
plt.xlabel('Label') # 1->insincere; 0->not insincere
plt.ylabel('Number of Questions')
plt.plot()
...
print('Accuracy withour using pretrained Embedings =', metrics.accuracy_score(val_y, [round(float(i)) for i in pred_noemb_val_y]))
...
plt.hist([round(float(i)) for i in pred_glove_val_y])
plt.title('Distribution of Test(slpit from train) data using glove embeddings')
plt.xlim(0,1)
plt.xlabel('Label') # 1->insincere; 0->not insincere
plt.ylabel('Number of Questions')
plt.plot()
...
plt.hist([round(float(i)) for i in pred_noemb_val_y])
plt.title('Distribution of Test(slpit from train) data')
plt.xlim(0,1)
plt.xlabel('Label') # 1->insincere; 0->not insincere
plt.ylabel('Number of Questions')
plt.plot()
...
plt.hist([round(float(i)) for i in pred_paragram_val_y])
plt.title('Distribution of Test(slpit from train) data')
plt.xlim(0,1)
plt.xlabel('Label') # 1->insincere; 0->not insincere
plt.ylabel('Number of Questions')
...
plt.hist([round(float(i)) for i in pred_val_y])
plt.title('Distribution of Test(slpit from train) data')
plt.xlim(0,1)
plt.xlabel('Label') # 1->insincere; 0->not insincere
plt.ylabel('Number of Questions')
...
plt.hist([round(float(i)) for i in pred_test_y])
plt.title('Distribution of Original Test data')
plt.xlim(0,1)
plt.xlabel('Label') # 1->insincere; 0->not insincere
plt.ylabel('Number of Questions')
plt.plot()
