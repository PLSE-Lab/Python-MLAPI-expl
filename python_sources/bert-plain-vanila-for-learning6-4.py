...
# 20%train
# num_to_load=1000000->3600000                         #Train size to match time limit
# valid_size= 100000->50000 
...
SEED = 1234
EPOCHS = 1  #maybe EPOCHS = 0.7
Data_dir="../input/jigsaw-unintended-bias-in-toxicity-classification"
Input_dir = "../input"
WORK_DIR = "../working/"
num_to_load=360000                         #Train size to match time limit
