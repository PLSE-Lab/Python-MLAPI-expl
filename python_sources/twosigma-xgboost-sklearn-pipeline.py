...
#### MODEL HERE
    ...
    model = XGBRegressor(max_depth=5, learning_rate=0.1, n_estimators=100, silent=False, objective='reg:linear', nthread=-1, gamma=0.0006, min_child_weight=2000,
    max_delta_step=0, subsample=1.0, colsample_bytree=0.7, colsample_bylevel=1, reg_alpha=0.0, reg_lambda=3.0, scale_pos_weight=1, base_score=0.0, seed=42,
    missing=None)
