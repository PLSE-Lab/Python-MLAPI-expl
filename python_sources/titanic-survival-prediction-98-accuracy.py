...
# > **Looking out for missing and incomplete data**
...
# 
# So from here Age and Embarked play a important role in suvival rate. So we need to fill up the missing values.
...
# > **We also need to visualize based on certain columns**
...
# *High fare class are likely to survive*
# 
# *Survival also depends on the port of Embarkment*
# 
# *So we finally decided upon the features that are to be used*
...
# > **Dropping the other features namely Cabin, Passenger ID, Ticket**
...
# > **So, Random Forest Classifier is the best classifier with an accuracy of 97.08%**
