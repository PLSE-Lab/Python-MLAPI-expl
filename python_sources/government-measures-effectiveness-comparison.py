...
mobility=DataFrame(pd.read_csv(r'../input/covid-measure/covid_measures5.csv',encoding='latin-1'))
mobility.head()
...
tags=DataFrame(pd.read_csv(r'../input/covid-measure/tags5.csv',encoding='latin-1'))
tags
