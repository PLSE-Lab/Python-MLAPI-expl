...
get_ipython().run_cell_magic('time', '', 'preprocess()')
...
get_ipython().run_cell_magic('time', '', '# Train LGBM and generate predictions\nlgb_preds, lgb_model = run_lgb(X_train, y_train, X_val, y_val, X_test)')
...
get_ipython().run_cell_magic('time', '', 'xgb_preds, xgb_model = run_xgb(X_train, y_train, X_val, y_val, X_test)')
...
get_ipython().run_cell_magic('time', '', '# Train Catboost and generate predictions\ncat_preds, cat_model = run_catboost(X_train, y_train, X_val, y_val,  X_test)')
