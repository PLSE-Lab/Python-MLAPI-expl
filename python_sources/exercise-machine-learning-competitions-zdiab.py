...
features = ['LotArea', 'YearBuilt', '1stFlrSF', '2ndFlrSF', 'GarageCars','Heating','FullBath', 'BedroomAbvGr', 'TotRmsAbvGrd', 'Neighborhood']
...
test_preds = mean_absolute_error(rf_val_predictions, val_y)
...
# this is was a good course ,i hope i can get to the compition.
