...
def get_train_transforms():
    return A.Compose(
        [A.ShiftScaleRotate(scale_limit=(-0.5, 0.5), rotate_limit=0, shift_limit=0.1, p=0.5, border_mode=0),
...
image, target, image_id = train_dataset[23]
...
#path='../input/checkpoint-effdet-1024/last-checkpoint_29.bin'
run_training()
