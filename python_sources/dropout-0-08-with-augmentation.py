...
# train the network
history = model.fit_generator(aug.flow(x_train, y_train_cat, batch_size=32), workers=4, steps_per_epoch=len(x_train) // 32,
...
pickling_on = open('augmentation.08.pkl','wb')
