...
for n_fold, (trn_idx, val_idx) in enumerate(folds.split(train)):
    ...
    cb_model = CatBoostRegressor(iterations=1000, learning_rate=0.1, depth=8, l2_leaf_reg=20, bootstrap_type='Bernoulli',  eval_metric='RMSE', metric_period=50, od_type='Iter', od_wait=45, random_seed=17, allow_writing_files=False)
...
b1['target'] = (b1['dp1'] * 0.6) + (b1['dp2'] * 0.6)
