...
# # Improvement over Edward Turner's Kernel
# Hello Guys, In this kernel, I just imp the score over Edward Turner's Kernel named as Logistics and Basic Stats(LB Public - ~0.046).All the work done here is completely Edward's credit.
# https://www.kaggle.com/eaturner/logistics-and-basic-stats-lb-public-0-046
# I checked the kernel with various model, and XGBoost performed quite well, in this beautifully preprocessed data, giving a Public score of (0.007331)
# 
# 
...
df_sample_sub = pd.read_csv('../input/SampleSubmissionStage2_SampleTourney2018.csv')
