...
from keras.layers import Input,Dense,merge,Dropout,BatchNormalization,    Activation,Conv2D,MaxPooling1D,MaxPooling2D,AveragePooling2D,Reshape,Flatten,UpSampling2D,Conv2DTranspose;
...
d_optim=keras.optimizers.Adam(learning_rate=0.001)
# d_optim=adam(lr=0.001);
g_optim=keras.optimizers.Adam(learning_rate=0.001)
