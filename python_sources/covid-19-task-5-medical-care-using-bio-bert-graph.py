...
# ## Some sample queries,answers and more details
...
Task='Task 06'
data=pd.read_excel("/kaggle/input/task3covid/task5_results_summary.xlsx")
qadata=pd.read_excel("/kaggle/input/covid-task-qa-answer/task5_results_summary_QA.xlsx")
