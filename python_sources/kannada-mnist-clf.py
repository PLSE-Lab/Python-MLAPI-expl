...
plt.subplot(431)
plt.imshow(zero,cmap='binary');
plt.title('zero')
#plt.colorbar()
plt.subplot(432)
plt.imshow(one,cmap='binary');
plt.title('one')
#plt.colorbar()
plt.subplot(433)
plt.imshow(two,cmap='binary');
plt.title('two')
#plt.colorbar()
plt.subplot(434)
plt.imshow(three,cmap='binary');
plt.title('three')
#plt.colorbar()
plt.subplot(435)
plt.imshow(four,cmap='binary');
plt.title('four')
#plt.colorbar()
plt.subplot(436)
plt.imshow(five,cmap='binary');
plt.title('five')
#plt.colorbar()
plt.subplot(437)
