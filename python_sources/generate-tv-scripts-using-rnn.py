...
copyfile(src = "/kaggle/input/tvscriptdata/scripts/helper.py", dst = "../working/helper.py")
copyfile(src = "/kaggle/input//tvscriptdata/scripts/problem_unittests.py", dst = "../working/problem_unittests.py")

# load in data
import helper
data_dir = '/kaggle/input/tvscriptdata/tvdata/Seinfeld_Scripts.txt'
...
def batch_data(words, sequence_length, batch_size):
    ...
    no_of_batches = len(words)//batch_size
    # only full batches
    words = words[:no_of_batches*batch_size]
...
class RNN(nn.Module):
    ...
    def forward(self, nn_input, hidden):
        ...
        Final_out = out[:, -1] # get last batch of labels       
