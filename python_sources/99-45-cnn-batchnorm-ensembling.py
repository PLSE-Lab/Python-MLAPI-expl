...
# **99.45% CNN,Batchnorm,Ensembling:**
# 
# This is my very first kernel using CNN,Batchnorm and model Ensembling.
# 
# References:
# 
...
# **LOAD DATASETS:**
# 
# **Using pandas to read the CSV file which has MNIST Train and Test sets.
# Input directory = "../input/" directory.
# Split 1000 examples from  train data for validation.**
...
# 
# Lets check how the mean of all the input images look like.
# There are 28x28 = 784 pixels in each image
...
# 
# 
# The below architecture can be described as:
# [conv-relu-batchnorm-pool]x2 -> [affine-relu-batchnorm]->[affine] -> [softmax]
...
# **Ensembling:**
# 
# Training accuracy will improve significantly if average weights are used.
# Below is the tensorflow implementation of Exponential moving average model ensembling.
# More details available at: https://www.tensorflow.org/versions/r0.12/api_docs/python/train/moving_averages
...
# 
# This model achieves accuracy of more than 99%
# 
# **INCRESE** the number of epochs and fine tune the batchsize for high accuracy.
# 
