...
# ###  3.1.1 Subplot grid for plotting conditional relationships
...
# ###  3.1.2 Draw a categorical plot onto a Facetgrid
...
# ###  3.1.3 Plot data and regression model fits across a FacetGrid
...
# ###  3.1.4 Subplot grid for plotting relationships 
...
# ###  3.1.5 Plot pairwiase bivariate
...
# ###  3.1.6 Grid for bivariate plot vs univariate plots
...
# ###  3.1.7 Plot bivariate distibution
...
# ### 3.2.1 Scatterplot
# 
# a) Scatterplot with one categorical variable
...
# b) Categorical scatterplot with non-overlapping points
...
# Plot data and a  linesr model fit
