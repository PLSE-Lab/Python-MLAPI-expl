...
def objective(params):
    ...
    for i, (train_index, valid_index) in enumerate(kfold.split(X_train, y_train)):
        ...
        model.fit(Xk_train, Yk_train, batch_size=params['batch_size'], epochs=params['epochs'],                            validation_data=(Xk_val, Yk_val), callbacks=callbacks, class_weight=class_weights)
