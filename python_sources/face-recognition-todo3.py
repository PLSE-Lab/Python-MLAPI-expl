...
def video_file_recog_haar(src_filename, output_filename='/kaggle/working/output_haar.mp4', framerate=None, scaleFactor=1.3, minNeighbors=5, minSize=60, maxSize=70):
...
def infer(x_test, ground_truth, titles, save_results=False, display=True, model_file='/kaggle/input/srganA-epoch300'):
...
infer(x_test, ground_truth, titles, save_results=False, display=True, model_file='/kaggle/input/srganA-epoch300')
