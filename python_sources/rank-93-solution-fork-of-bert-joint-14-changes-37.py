...
# This kernel is heavily inspired by https://www.kaggle.com/mmmarchetti/bert-joint . 
# 
...
# 
# Thanks to all my team mates - Ashish, Mukharbek and Rahul - for making this possible.
...
config = {'attention_probs_dropout_prob':0.5, #change
