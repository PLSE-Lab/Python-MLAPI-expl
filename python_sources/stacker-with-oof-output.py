...
y_out = stack.fit_predict(train, target_train, test)
y_valid = y_out[1]
y_pred = y_out[0]
...
oof = pd.DataFrame()
oof['id'] = id_train
oof['target0'] = y_valid[:,0]
oof['target1'] = y_valid[:,1]
oof['target2'] = y_valid[:,2]
oof.to_csv('stacker_oof_1.csv', index=False)