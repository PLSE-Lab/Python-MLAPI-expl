...
selector = selector.fit(x_train,label4)
...
np.save('benchmark_label5_GA.npy',x_train_label1)


# In[ ]:


np.save('benchmark_label5_features_GA.npy',selector.support_ )
