...
# Hector Bonilla Simplified the code for the ca_utils implementation
...
# Hector Bonilla this is the library load and the program calls in subsequent tasks are prefixed with the correspondent code calls like ca_load.load_data
...
ca_vis_automata = imp.load_source('vis_automata_task', ca_file)
...
task = ca_load.load_data('08ed6ac7.json', phase='training')
ca_plot.plot_task(task)
...
ca_display.display_vid(VideoFileClip('../input/ca-videos/IaANIHh6.mp4'), loop=True, autoplay=True)
...
task = ca_load.load_data('db3e9e38.json', phase='training')
...
ca_vis_automata.vis_automata_task(task, compute_db3e9e38_part_automata_step, 16, 0)
...
ca_vis_automata.vis_automata_task(task, compute_db3e9e38_automata_step, 16, 0)
...
task = ca_load.load_data('b27ca6d3.json', phase='training')
...
ca_vis_automata.vis_automata_task(task, compute_b27ca6d3_part3_automata_step, 5, 0)
...
ca_vis_automata.vis_automata_task(task, compute_b27ca6d3_automata_step, 5, 0)
...
ca_vis_automata.vis_automata_task(task, compute_00d62c1b_part_automata_step, 128, 0)
...
ca_vis_automata.vis_automata_task(task, compute_00d62c1b_automata_step, 50, 1)
