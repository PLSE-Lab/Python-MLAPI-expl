...
# <h1>My Own Kaggle Profile</h1>
# 
# This Kernel is forked from [Shivam Bansal](https://www.kaggle.com/shivamb)'s Kernel: <a href="https://www.kaggle.com/shivamb/analyse-your-kaggle-profile-framework">Analyse Your Kaggle Profile - Framework !!</a>
...
# <h2>Generate report for Gabriel Preda</h2>

# In[ ]:


_generate_report("gpreda")


# <h2>Thank you very much Shivam Bansal for this Kernel!</h2>
