...
def GPIndividual1(data):
    predictions = (np.sinh(((((np.sinh(data["team1Seed"]) - data["team2Seed"]) + ((np.tanh(data["team2Wmax"]) + ((data["team1Lstd"] + np.minimum( (data["team1losses"]),  (data["year"])))/2.0))/2.0)) + ((data["team2Seed"] == (1.0/(1.0 + np.exp(- data["team2wins"])))).astype(float)))/2.0)) +
                    ...
                    ((np.floor(np.minimum( (((1.732051 == data["team1Lmax"]).astype(float))),  (np.cos(data["team1WAverage"])))) == ((np.round(((((-(data["team2LAverage"])) <= data["team2losses"]).astype(float)) - 2.211120)) <= (data["team2Wmin"] * data["team2losses"])).astype(float))).astype(float)) +
                    np.minimum( ((np.abs(data["team1Wmedian"]) - ((data["team1Seed"] >= np.abs(data["team1Lmedian"])).astype(float)))),  (np.round(np.sinh(np.minimum( ((((data["team2WAverage"] != data["team1Seed"]).astype(float)) + data["team2WAverage"])),  ((-(((data["team1Wmin"] >= 2.717282).astype(float)))))))))) +
                    ...
                    np.minimum( (((data["team2WAverage"] >= np.floor(data["team2Wmin"])).astype(float))),  (np.abs(((data["team1Seed"] >= np.sinh(((0.692147 > np.minimum( (data["team2Wmedian"]),  (((data["team1Seed"] <= ((data["team1Wmedian"] <= np.cos(0.693147)).astype(float))).astype(float))))).astype(float)))).astype(float))))) +
                    ...
                    np.maximum( (np.minimum( (data["team1Wmin"]),  (np.ceil(np.minimum( (np.minimum( (0.137462),  (((data["team1Seed"] >= data["team2Lmedian"]).astype(float))))),  (data["team2losses"])))))),  ((((-(np.maximum( (data["team2"]),  (data["team2Seed"])))) > ((data["team1losses"] < 1.414214).astype(float))).astype(float)))) +
                    np.minimum( (np.maximum( (data["team1Lmin"]),  ((-(((data["team1wins"] >= np.cos(0.699430)).astype(float))))))),  (np.minimum( (np.ceil((data["team1Wmedian"] / 2.0))),  ((-(((data["team1Wmin"] >= (1.196370 + ((data["team1Wstd"] < 0.093340).astype(float)))).astype(float)))))))) +
                    ((((-(np.abs(np.abs(((data["team1"] + (-(0.138462)))/2.0))))) * ((0.355879 >= data["team2wins"]).astype(float))) > ((data["team1Wmedian"] + np.maximum( (data["team1"]),  (((0.366879 != data["team1"]).astype(float)))))/2.0)).astype(float)) +
                    ...
                    ((-(((data["team2Wmin"] >= ((-((data["team2Wstd"] + 0.307310))) * (1.0/(1.0 + np.exp(- (-((1.0/(1.0 + np.exp(- 0.317310)))))))))).astype(float)))) * (((1.0/(1.0 + np.exp(- data["year"]))) * data["team1Lmin"]) * data["team2Lstd"])) +
                    ...
                    np.ceil(((2.674680 <= np.abs(np.maximum( ((data["team2"] + np.maximum( (np.abs(data["team1Seed"])),  (data["team2LAverage"])))),  ((0.317310 + (np.minimum( (data["team1Wmedian"]),  (((data["team2"] != data["team2LAverage"]).astype(float)))) - data["team2Lmin"])))))).astype(float))) +
                    ...
                    ((((data["team2"] <= ((((data["team1Lmin"] + 5.416570)/2.0) + (np.cos(np.maximum( (data["team1Lmin"]),  (np.maximum( ((1.0/(1.0 + np.exp(- data["team1Wmin"])))),  (data["team2LAverage"]))))) / 2.0))/2.0)).astype(float)) <= ((((data["team2"] + 5.428570)/2.0) <= data["team1Wmedian"]).astype(float))).astype(float)) +
                    ...
                    (((0.591941 <= (data["team2Wmin"] - ((((np.cos(data["team1Wmedian"]) * 2.0) * 2.0) >= 1.650796).astype(float)))).astype(float)) * np.sin(np.sinh(np.sinh(data["team2Wstd"])))) +
                    ...
                    np.minimum( (np.cos(data["team1"])),  (((((((((((data["team1"] / 2.0) / 2.0) * 9.808604) <= 0.058823).astype(float)) <= data["team1Wstd"]).astype(float)) == np.ceil(((data["team1"] / 2.0) * 9.869604))).astype(float)) - 0.094340))) +
                    np.maximum( (np.round(((2.201120 <= (data["team1Wmax"] - ((data["team2Lmin"] + data["team2Lmedian"])/2.0))).astype(float)))),  (((3.0 < (data["team2losses"] + np.maximum( ((-(((data["team2Lmin"] + data["team2LAverage"])/2.0)))),  (data["team1"])))).astype(float)))) +
                    ((data["team2wins"] - np.sin(data["team2Wmin"])) * ((np.maximum( (data["team2wins"]),  (0.850000)) <= np.minimum( (data["team1Lmax"]),  ((np.maximum( (data["team2Wmax"]),  ((data["team2wins"] * np.floor(data["team2Wmax"])))) - 0.0588230)))).astype(float))) +
                    ((math.tanh((-(1.609430))) > np.sin(np.maximum( (data["team2Wmin"]),  (np.minimum( (np.minimum( (data["team2Seed"]),  (((data["team1LAverage"] + data["team1Wstd"])/2.0)))),  ((((data["team2Seed"] <= data["team2Wmin"]).astype(float)) - data["team2Lstd"]))))))).astype(float)) +
                    ...
                    ((data["team2Wmin"] > ((0.300310 + (((1.0/(1.0 + np.exp(- (((data["team2Seed"] * np.maximum( (data["team2"]),  (data["team1Lmax"]))) <= ((data["team2losses"] < data["team1Lmax"]).astype(float))).astype(float))))) < data["team2Wmin"]).astype(float))) * 2.0)).astype(float)) +
                    np.sinh(np.floor((0.357879 - (((((np.minimum( (data["team1LAverage"]),  (np.floor(data["team2WAverage"]))) == ((2.405090 < -3.0))).astype(float)) + (data["team2wins"] * np.sin(np.minimum( (data["team1Lmax"]),  (data["team2WAverage"])))))/2.0) / 2.0)))) +
...
if __name__ == "__main__":
    ...
    print(log_loss(trainlabels, np.clip(predictions.values*1.0080036, 1e-6, 1-1e-6)))
    test[test.columns] = np.round(ss.transform(test), 4)
    predictions = GPIndividual1(test)
    predictions.fillna(1, inplace=True)
    submission = pd.DataFrame({'Id': testids,
                               'Pred': np.clip(predictions.values*1.008950, 1e-6, 1-1e-6)})
