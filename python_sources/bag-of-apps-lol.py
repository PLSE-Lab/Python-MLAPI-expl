...
events.head(10)
print("# App labels done")
events.category = events.category.apply(lambda x : x.lower())
events.category[events.category.str.contains('.*game.*')] = 'game'
events.category[events.category.str.contains('.*finance.*')] = 'finance'
events.category[events.category.str.contains('.*financial.*')] = 'finance'
events.category[events.category.str.contains('.*car.*')] = 'car'
events.category[events.category.str.contains('.*hotel.*')] = 'hotel'
events.category[events.category.str.contains('.*free.*')] = 'free'
events.category[events.category.str.contains('.*property industry.*')] = 'property industry'
events.category[events.category.str.contains('.*sports.*')] = 'sports'
events.category[events.category.str.contains('.*travel.*')] = 'travel'
events.category[events.category.str.contains('.*airlines.*')] = 'travel'
events.category[events.category.str.contains('.*personal effectiveness.*')] = 'personal effectiveness'
events.category[events.category.str.contains('.*bank.*')] = 'finance'
events.category[events.category.str.contains('.*loan.*')] = 'finance'
events.category[events.category.str.contains('.*futures.*')] = 'finance'
events.category[events.category.str.contains('.*lottery.*')] = 'lottery'
