...
# Then we will use Keras to let the model learn.
# 
# ## Import libraries
...
# check list of files in the input folder
...
# Change the dataset to work with Keras
...
# Let's check accuracy between training and validation.
