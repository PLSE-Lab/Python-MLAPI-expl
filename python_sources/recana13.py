...
def replace_data(X):
    #features
    #print ('***',X['features'].iloc[:4])

 #   X['features'] = X['features'].str.replace("doorman","ffffff")
...
print ('Replacing...')
replace_data(X_train)
replace_data(X_test)

feature_transform = CountVectorizer(stop_words='english', max_features=170)
...
print("Normalizing high cordinality data...")
