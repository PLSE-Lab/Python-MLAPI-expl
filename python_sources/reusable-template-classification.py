...
trainSet = pd.read_csv("../input/digit-recognizer/train.csv", sep=",")
labels = ['label']
...
testSet = pd.read_csv("../input/digit-recognizer/test.csv", sep=",")
...
print(testIds.head())
#testIds.to_csv('../output/myPrediction.csv', index=False)
