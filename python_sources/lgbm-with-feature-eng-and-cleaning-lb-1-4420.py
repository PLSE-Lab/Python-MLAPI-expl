...
train_missing.reset_index()[['index', 'missing_ratio']]    .merge(test_missing.reset_index()[['index', 'missing_ratio']], on='index', how='left')    .rename(columns={'index':'columns', 'missing_ratio_x':'train_missing_ratio', 'missing_ratio_y':'test_missing_ratio'})    .sort_values(['train_missing_ratio', 'test_missing_ratio'], ascending=False)    .query('train_missing_ratio>0')
