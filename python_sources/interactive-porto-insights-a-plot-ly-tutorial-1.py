...
# This is the first time that I have rewritten the kernel of [Interactive Porto Insights - A Plot.ly Tutorial](https://www.kaggle.com/arthurtok/interactive-porto-insights-a-plot-ly-tutorial) made by [Anisotropic](https://www.kaggle.com/arthurtok).
...
# 
# This notebook will aim to provide some interactive charts and analysis of the competition data by way of the Python visualisation library Plot.ly and hopefully bring some insights and beautiful plots that others can take and replicate. Plot.ly is one of the main products offered by the software comapny - Plotly which specialized in providing online graphical and statistical visualisations (charts and dashboards) as well as providing an API to a whole rich suite of programming languages and tools such as Python, R, Matlab, Node.js, etc.
# 
# Listed below for easy convenience are links to the various Ploly plots in this notebook. 
# 
...
# Here we observe that there are 4 features: ps_ind_10_bin, ps_ind_11_bin, ps_ind_12_bin, ps_ind_13_bin which are completely dominated by zero. This begs the question of whether these features are useful at all as they do not contain much information about the other calss vis-a-vis the target. 

# ### Categorical and Ordinal feature inspection
# 
# Let us first take a look at the features that are termed categorical as per their suffix '_cat_'.
...
trace2 = go.Bar(
    ...
    name='Random Forest Freature Importance',
    orientation='h'
)
layout = dict(
...
trace2 = go.Bar(
    ...
    name='Gradient Boosting Classifier Freature Importance',
    orientation='h'
)
layout = dict(
    title='Barplot of Feature Importances',
