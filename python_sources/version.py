...
X_tr=X_train[['display_address','building_id', 'listing_id','hcc_building_id_pred_1',
'hcc_building_id_pred_2',
'hcc_manager_id_pred_1',
'hcc_manager_id_pred_2','street_address']]

X_te=X_test[['display_address','building_id', 'listing_id','hcc_building_id_pred_1',
'hcc_building_id_pred_2',
'hcc_manager_id_pred_1',
'hcc_manager_id_pred_2','street_address']]
