...
data_variants = pd.read_csv('/kaggle/input/msk-redefining-cancer-treatment/training_variants.zip')
...
data_variants_profile = ProfileReport(data_variants, title='Data Variants Report', html={'style':{'full_width':True}})
data_variants_profile
...
data_text_profile = ProfileReport(data_text, title='Data Text Report', html={'style':{'full_width':True}})
data_text_profile
...
# Don't foreget the missing values we found in the report 
...
train_class_distribution = train_df['Class']
test_class_distribution = test_df['Class']
cv_class_distribution = cv_df['Class']
...
my_colors = 'rgbkymc'
train_class_distribution.value_counts().plot(kind='bar')
plt.xlabel('Class')
...
my_colors = 'rgbkymc'
test_class_distribution.value_counts().plot(kind='bar')
plt.xlabel('Class')
plt.ylabel('Number of Data points per Class')
...
my_colors = 'rgbkymc'
cv_class_distribution.value_counts().plot(kind='bar')
plt.xlabel('Class')
...
submission_stacking = pd.DataFrame(sclf.predict_proba(test_x_onehotCoding))
