...
#Opening The Image
prediction_image_path = '../input/dataset_2/dataset/predict/74.jpg'
img_array = np.array(Image.open(prediction_image_path))
plt.imshow(img_array)

#Predicting the Image
test_img=image.load_img(prediction_image_path,target_size=(256,256))
