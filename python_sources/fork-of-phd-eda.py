...
plt.bar(x=top_ten_quantity_by_SalesPersonID.index,height=top_ten_quantity_by_SalesPersonID['Quantity'])
...
((top_ten_quantity_by_SalesPersonID['Quantity']/summation_of_total_Sales)*100)
((last_ten_quantity_by_SalesPersonID['Quantity']/summation_of_total_Sales)*100)
...
data1 = [
    go.Bar(
        x=top_ten_quantity_by_SalesPersonID.index, # assign x as the dataframe column 'x'
        y=((top_ten_quantity_by_SalesPersonID['Quantity']/summation_of_total_Sales)*100),
        text=((top_ten_quantity_by_SalesPersonID['Quantity']/summation_of_total_Sales)*100),
        textposition='auto'
    )
]
...
data1 = [
    go.Bar(
        ...
        y=((last_ten_quantity_by_SalesPersonID['Quantity']/summation_of_total_Sales)*100),
        text=((last_ten_quantity_by_SalesPersonID['Quantity']/summation_of_total_Sales)*100),
        textposition='auto'
    )
]
...
((top_ten_quantity_by_SalesPersonID['Quantity']/summation_of_total_Sales)*100).sum()
...
((last_ten_quantity_by_SalesPersonID['Quantity']/summation_of_total_Sales)*100).sum()
...
data1 = [
    go.Bar(
        ...
        y=top_ten_TotalSales_by_SalesPersonID['TotalSalesValue'],
        text=top_ten_TotalSales_by_SalesPersonID['TotalSalesValue'],
        textposition='auto'
    )
]
...
((top_ten_TotalSales_by_SalesPersonID['TotalSalesValue']/summation_of_total_Sales)*100)
((last_ten_TotalSales_by_SalesPersonID['TotalSalesValue']/summation_of_total_Sales)*100)
...
# #### First we have divided the two columns TotalSalesValue by  Quantity this will give us the PricePerUnit of that particular ProductID for that SalesPersonID for that particular ReportID
