...
def make_submission(y_prob, ids, encoder, name='../output/lasagneSeed21.csv'):
...
#Load Data
X, y, encoder, scaler, rbm1, rbm2, rbm3 = load_train_data("../input/train.csv")
X_test, ids = load_test_data('../input/test.csv', scaler, rbm1, rbm2, rbm3)
