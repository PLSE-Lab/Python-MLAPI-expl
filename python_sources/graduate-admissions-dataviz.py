...
#To know about dataset size and  know if there is null values
df.info()
...
sns.heatmap(df.corr(), ax=ax, annot=True, linewidths=0.5, fmt= '.2f',cmap="magma")
plt.show()
...
#or another way to get Y series or X Matrix 
#x=df.iloc[:,:-1]
#y=df.iloc[:,-1]
