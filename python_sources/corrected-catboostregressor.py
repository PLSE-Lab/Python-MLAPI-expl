...
# This was forked from another kernel which was based on the kernels listed below. I replaced the LGBM with CatBoost, tuned the parameters and adjusted the coefficients to get the distribution of the predictions on the test set to match the distribution of the training target.
# 
# Links to orginal kernels:
#  * https://www.kaggle.com/tunguz/annoying-ab-shreck-and-bluetooth
#  * https://www.kaggle.com/domcastro/let-s-annoy-abhishek
#  * https://www.kaggle.com/abhishek/maybe-something-interesting-here
# 
# EAS - I am replacing the LGB Booster with a CatBoost Regressor
# 
# ** Change Log **
# 
#  * v1 - replacing lgb with catboost and tuning params
#  * v2 - writing script to automatically tune coefficients by distribution of test predictions
#  * v4 - v3 seems to be in a loop
#  * v10 - more parameter tuning
#  * v11 - trying with hand tuned coefs instead of auto tuned
...
# Using the calculated coefficients on the test dataset results a distribution which is very different from that of the training target. I manually adjust the coefficients to get the distributions as similar as I could, which resulted in improved results on the LB.
