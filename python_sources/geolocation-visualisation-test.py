...
# Remove the events at/near (lat,lon) = (0,0)

# In[ ]:


df_at0 = df_events[(df_events['longitude'] == 0) & (df_events["latitude"] == 0)]
df_near0 = df_events[(df_events["longitude"]>-2) &                     (df_events["longitude"]<2) &                     (df_events["latitude"]>-2) &                     (df_events["latitude"]<2)]
