...
xtrain, xtest, ytrain, ytest = cross_validation.train_test_split(train, y, stratify=y, random_state=42)
clf = LogisticRegression()
clf.fit(xtrain,ytrain)
print (metrics.roc_auc_score(ytest, clf.predict_proba(xtest)[:,1]))
