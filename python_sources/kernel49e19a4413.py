...
train_df = gpd.read_file("/kaggle/input/covid-19-enriched-dataset-week-2/enriched_covid_19_week_2.csv")
...
week3_df = gpd.read_file("/kaggle/input/covid19-global-forecasting-week-4/train.csv")
