...
for f in train_all_real.columns[0:200]:
    train_all_real[f+'duplicate_count'] = train_all_real.groupby([f])[f].transform('count')
...
for f in train_all_real.columns[0:200]:
    ...
    train_all_real[f + '_duplicate_value_3'] = train_all_real[f]* (train_all_real[f + 'duplicate_count']>3).astype(int)
...
train_all_real = train_all_real.drop(train_all_real.columns[400:600],axis = 1)
...
for f in train_features_real.columns[0:200]:
    ...
    #real_data[f+'plus_of_mean'] = real_data[f+'plus_of_mean']*real_data[f+'duplicate']


# In[ ]:


train_features_real.shape,real_data.shape,train_target.shape
...
predictions[fake_data.index] = 0.5
