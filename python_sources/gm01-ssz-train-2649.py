...
def GPIndividual1(data):
    predictions = (np.sinh(((((np.sinh(data["team1Seed"]) - data["team2Seed"]) + ((np.tanh(data["team2Wmax"]) + ((data["team1Lstd"] + np.minimum( (data["team1losses"]),  (data["year"])))/2.0))/2.0)) + ((data["team2Seed"] == (1.0/(1.0 + np.exp(- data["team2wins"])))).astype(float)))/2.0)) +
                    ...
                    ((((-(np.abs(np.abs(((data["team1"] + (-(0.138462)))/2.0))))) * ((0.357879 >= data["team2wins"]).astype(float))) > ((data["team1Wmedian"] + np.maximum( (data["team1"]),  (((0.367879 != data["team1"]).astype(float)))))/2.0)).astype(float)) +
                    ...
                    np.minimum( (np.ceil(((data["team2Wmin"] + ((0.095340 >= data["team2"]).astype(float)))/2.0))),  ((np.minimum( ((data["team1Lmax"] * data["team1Wmedian"])),  (((data["team1Wmedian"] < (data["team1Wmax"] - data["team2Lmedian"])).astype(float)))) * np.maximum( (data["team2Seed"]),  (data["team1Wmax"]))))) +
                    ...
                    (((0.602941 <= (data["team2Wmin"] - ((((np.cos(data["team1Wmedian"]) * 2.0) * 2.0) >= 1.650796).astype(float)))).astype(float)) * np.sin(np.sinh(np.sinh(data["team2Wstd"])))) +
