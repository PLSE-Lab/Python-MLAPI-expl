...
# ### Let's check 1st file: ../input/mitbih_test.csv
...
df1 = pd.read_csv('../input/mitbih_test.csv', delimiter=',', nrows = nRowsRead)
...
# ### Let's check 2nd file: ../input/mitbih_train.csv
...
df2 = pd.read_csv('../input/mitbih_train.csv', delimiter=',', nrows = nRowsRead)
...
# ### Let's check 3rd file: ../input/ptbdb_abnormal.csv
...
df3 = pd.read_csv('../input/ptbdb_abnormal.csv', delimiter=',', nrows = nRowsRead)
