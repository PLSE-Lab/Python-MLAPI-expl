...
def plot_bivariate(
        df, x, y, hue=None, show_season=True, annotate=True,
        dont_annotate_hue_na=True, fit_reg=False, xyline=False, ax=None,
        figsize=(10, 8), suptitle=None, text_size='medium',
        suptitle_size=14, axes_labels_size=14, x_jitter=None, y_jitter=None
):
    """"""
    ...
    p1 = sns.regplot(
        data=df, x=x, y=y, ax=ax, fit_reg=fit_reg, ci=False,
        color=plot_color, x_jitter=x_jitter, y_jitter=y_jitter,
