...
# There are three models with magic numbers
# algorithm summary
# 1) Model1
#    read data (without macro)
#    clean data
#    add feature engineering
#    rescale prices per quartal
# xgboost

# 2) Model2
#    read data (without macro)
#    label encoding of categories
#    rescale prices per train period
# xgboost

# 3) Model3
#    read data (with macro)
#    feature engineering for time interval features (like build date -> build n-th years ago )
...
# All xgboosts parameters was cross validated but you can uncomment xgb.cv

# Results dont repeatable on home PC.
# I think this is due to the number of threads
...
# set N_THREAD for reproducibility of results
N_THREAD = 4
...
#clean data I also try to clean data n
...
result["price_doc"] =result["price_doc"] *0.995        
