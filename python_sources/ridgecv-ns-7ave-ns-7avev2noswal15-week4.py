...
Modification of https://www.kaggle.com/aerdem4/covid19-w2-final-v2, credit to team @titericz @cpmpml @aerdem4

My changes to the ensemble(week3):
- RidgeCV with Kfold over 5 folds
- 2 NN models each with 7 connected NN models with a last average layer.
...
get_ipython().system('[](https://www.googleapis.com/download/storage/v1/b/kaggle-user-content/o/inbox%2F3924325%2F6c9c574e47720fe1caf35aac613bded0%2Fmodel.png?generation=1586428155487874&alt=media)')
...
def get_ridgeCV_sub(save_oof=False, save_public_test=False):
...
def get_nn_sub():
    ...
    def train_models(df):
        ...
        for i in range(NUM_MODELS):
            ...
            checkpoint = tf.keras.callbacks.ModelCheckpoint("model{}.h5".format(i), monitor='val_loss', verbose=0, save_best_only=True,save_weights_only=True, mode='min')
