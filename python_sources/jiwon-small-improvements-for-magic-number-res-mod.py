...
# Parameters
prediction_stderr = 0.007  #  assumed standard error of predictions
...
probthresh = 95  # minimum probability*frequency to use new price instead of just rounding
...
rate_2015_q2 = 1
rate_2015_q1 = rate_2015_q2 / 0.9903
...
mult = 0.9681
y_train = df_train['price_doc'].values * mult + 10.08
id_test = df_test['id']
