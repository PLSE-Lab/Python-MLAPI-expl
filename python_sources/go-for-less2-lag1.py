...
def processData(in_file_name, cust_dict):
	...
	for row in csv.DictReader(in_file_name):
	    ...
	    if row['fecha_dato'] in ['2015-01-28','2015-02-28','2015-03-28', '2015-04-28','2016-01-28','2016-02-28','2016-03-28','2016-04-28']:
	        prev_target = getTarget(row)
	        prev_dict[cust_id] = prev_target[:]
		...
		if row['fecha_dato'] == '2016-06-28':
			...
			prev_targ_list = prev_dict.get(cust_id, [0]*22)
			x_vars_list.append(x_vars + prev_target_list + prev_targ_list)
