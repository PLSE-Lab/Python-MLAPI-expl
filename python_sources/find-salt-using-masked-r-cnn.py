...
# This notebook explains how to use Masked RCNN to identify the salt from given images and its masks. It uses the matterport's [implemetation](https://github.com/matterport/Mask_RCNN) which is well known in the Kaggle community. 
