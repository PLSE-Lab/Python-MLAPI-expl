...
query_unit = """SELECT country,unit
            ...
            WHERE unit != 'ppm'
        """
units = open_aq.query_to_pandas_safe(query_unit)


# In[ ]:


countries = list(set(units['country']))
countries
...
query_pollutant = """SELECT pollutant
            ...
            WHERE value = 0.00
        """
pollut = open_aq.query_to_pandas_safe(query_pollutant)


# In[ ]:


pollutants=list(set(pollut['pollutant']))
pollutants
