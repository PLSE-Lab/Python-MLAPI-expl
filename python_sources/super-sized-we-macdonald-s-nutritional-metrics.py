...
# # Introduction
# 
# MacDonald. The word synonymous with Fast food culture. The Big Mac, Cheeseburger, Egg McMuffin, Chicken McNuggets have been etched in annals of history.  However there lies a more pejorative connotation associated with these iconic foods - one of excessive unhealthiness and processed devilry. This was exacerbated by the release of the American documentary ***Super Size Me*** ( of which this notebook's title draws its inspiration from) to critical reception and a lasting impact of the film's emphasis on MacDonald's supersize portions. 
# 
# However, this notebook will aim to take an empirical approach in evaluating the nutritional content of the various offerings provided in this MacDonald's dataset and will ultimately let the data craft its story. I will start off with some standard data exploration and analytics after which I will proceed to plot interactive Plotly scatter plots of the various nutritional food metrics. Finally as a 
...
# # 3. "Super Size Me" Diet 
# 
# Finally in our last section, let us analyse the impact of taking on the Super Size Me diet
# 
