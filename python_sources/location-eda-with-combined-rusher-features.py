...
# Model is from https://www.kaggle.com/bestpredict/location-eda-8eb410
# Rusher features idea is from the discussion: 
# https://www.kaggle.com/c/nfl-big-data-bowl-2020/discussion/113698#latest-675738
...
def create_features(df, deploy=False):
    ...
    def rusher_features(df):
        ...
        for feat1 in ['RusherS','RusherA','RusherX', 'RusherY']:
            for feat2 in ['RusherS','RusherA','RusherX', 'RusherY']:
                if feat1 == feat2:
                    continue
                new_feature = feat1 + '_' + feat2
                new_feature_reversed = feat2 + '_' + feat1
                if new_feature in rusher.columns or new_feature_reversed in rusher.columns:
                    continue
                rusher[new_feature] = rusher[feat1].div(rusher[feat2] + 10)
        
        rusher['v_horizontal_vertical'] = rusher['v_horizontal'].div(rusher['v_vertical'] + 10)
    ...
    def static_features(df):
        ...
        static_features = df[df['NflId'] == df['NflIdRusher']][add_new_feas+['GameId','PlayId','X','Y','S','A','Dis','Orientation','Dir',
                                                            'YardLine','Quarter']].drop_duplicates()
