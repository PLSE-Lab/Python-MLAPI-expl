...
# # Confision Matrix Implementation on Cancer Dataset
...
# 1. [Confision Matrix Visualization](#6)
...
# <a id = "5"></a>
# # 5. Confision Matrix with Sklearn
...
# Then I implemented Random Forest Algorithm to predict my test data:
...
# I am going to use Confision Matrix for describing the performance of Random Forest Classification.(It can be any other ML classification method)
...
# <a id = "6"></a>
# # 6. Confision Matrix Visualization
...
# Let's expain the heatmap graph:
# 
...
# * There are 3 data that is actually malignant but the algorithm thinks that it is benign.
