...
X_train_valid, X_local_test, y_train_valid, y_local_test = train_test_split(
    X_learning, y_learning, test_size=0.128, random_state=4
)
...
clf = xgb.XGBClassifier(missing=np.nan, max_depth=5,
                        ...
                        subsample=0.43, colsample_bytree=0.92, seed=4274)

# fitting
clf.fit(X_fit, y_fit, early_stopping_rounds=100, eval_metric="auc", eval_set=[(X_eval, y_eval)])
