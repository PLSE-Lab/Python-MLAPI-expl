...
# This method may potentially improve your score by 20~30 after you've done all the other methods such as 2-opts.
# 
...
get_ipython().run_cell_magic('time', '', 'num_iters = 250\nrun_opt(baseline,40,200)')
