...
MIMIC_PATH = "../input/"
data = pd.read_csv(os.path.join(MIMIC_PATH,'mimic3d.csv'))
...
# 10.1 Training data
Xtr = {"num" : dtrain[num].values,          # Note the name 'num'
...
ohe_ls=LSTM(32)(emb_re)
ohe_ls1=LSTM(32)(emb_eth)
ohe_ls.shape
ohe_ls1.shape
...
model = Model([num, ohe, re, eth, ad,ap], [rnn_ad, rnn_ap, emb_re, emb_eth, num, ohe_ls,ohe_ls1,ohe])
model.summary()
