...
with strategy.scope():
    ...
    enb5.trainable = True # Full Training
...
with strategy.scope():
    ...
    enb4.trainable = True # Full Training
...
checkpoint = ModelCheckpoint(filepath='best_model.h5', monitor='loss',mode='min', save_best_only=True, verbose=1)
...
probabilities = (model1.predict(test_images_ds)+model2.predict(test_images_ds)+model3.predict(test_images_ds))/3 # using average model probability
