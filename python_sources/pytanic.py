...
# Now let's study the new features:
...
# Before we start exploring the different models we are adjusting the categorical string column types to integer. This is necessary since not all classifiers can handle string input.
