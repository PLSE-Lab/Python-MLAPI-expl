...
# This is the third time I have rewritten the kernel of [EDA To Prediction (DieTanic)](https://www.kaggle.com/ash316/eda-to-prediction-dietanic) made by [Ashwini Swain](https://www.kaggle.com/ash316), which is awesome as belows:
...
# 
# Let's dive in a littel bit more and check for other interesting observations. Let's check survival rate with Sex and Pclass Together. 
...
# There are some misspelled initials like Mile or Mme that stand for Miss, I will replace them with Miss and same thing for other values. 
...
# The Women and Child First Policy thus hold true irrespective of class. 
# 
...
# There looks to be a large distribution in the fares of Passengers in Pclass 1 and this distribution goes on decreasing as the standars reduces. As this is also continous, we can convert into discrete values by using binning. 
...
# ## Part2: Feature Engineering and Data Clearing
# 
# **Age_band**
# 
...
# Family_Size=0 means that the passenger is alone. Cleary, if you are alone or family_size=0, then chances for survival is very low. For family_size>4, the changes decreases, too. This also looks to be an important feature for the model. Let's examine this further. 
...
# It is visible that being alone is harmful irrespective of Sex of Pclas except for Pclass 3 where the chances of females who are alone is high than those with family. 
# 
# **Fare_Range**
# 
...
# 
# Now, we cannot pass the Fare_range values as it is. We should convert it into singleton values smae as we did in Age_band.
...
# Clearly, as the Fare_cat increases, the survival chances increses. This feature may become an important feature during modeling along with the Sex. 
# 
