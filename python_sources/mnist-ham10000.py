...
from keras.layers import Dense, Dropout, Flatten, Conv2D, MaxPool2D,AveragePooling2D,GlobalMaxPooling2D
...
skin_df = pd.read_csv('../input/dataaugment/HAM10000_metadata_plus.csv')
