...
# 
# The model is a bidirectional LSTM and I am not training the Embedding layer as the GPU time is just 2 hours in this competition. 
...
# 1. **Without Pretrained Embeddings to save time:**
# 
...
pred_val_y = 0.39*pred_glove_val_y + 0.41*pred_fasttext_val_y + 0.39*pred_paragram_val_y 
for thresh in np.arange(0.1, 0.501, 0.01):
    thresh = np.round(thresh, 2)
...
pred_test_y = 0.35*pred_glove_test_y + 0.42*pred_fasttext_test_y + 0.35*pred_paragram_test_y
