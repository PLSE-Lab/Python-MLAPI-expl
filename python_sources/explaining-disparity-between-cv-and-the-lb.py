...
trn_user_target['target'].values[:20]


# In[ ]:


bestscore = 1.4275 #Olivier's LB Score
bestdiff = 1000
bestthreshold = 10
thresholds = []
diffs = []
...
_ = plt.plot(thresholds,diffs)


# **Although a hypothesis**, if the LB np.log1p(revenues) are less than 18.28999999999982 then the LB matches CV. This means using the LB as a measure of goodness of models could be very very dangerous - trust your CV! ;) 
