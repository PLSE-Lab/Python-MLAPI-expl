...
def main():
  ...
  parser.add_argument('--weights', type=str, default='/kaggle/input/efficenet-b4-30-epochs/model-0070.h5')
  ...
  model = tf.keras.models.load_model('/kaggle/input/efficientnetb4-parameter-tweaks/Enet-final.h5')
  print(model.summary())
  row_id, target = [], []
