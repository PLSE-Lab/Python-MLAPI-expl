...
# **Map of Police Stations in Chicago**
...
# end secret_token
train = pd.read_csv('../input/chicago-police-stations/police-stations.csv', nrows = 30_000)
train.head()
...
print("Total Number of Police Stations: {}".format(train.shape[0]))


# In[ ]:


target = train['DISTRICT NAME']
data = [go.Histogram(x=target)]
layout = go.Layout(title = "Police Stations per Neighborhood")
...
layout = go.Layout(autosize=False,
                   mapbox= dict(accesstoken=private_mapbox_access_token,
                    ...
                    width=1800,
                    height=1200, title = "Police Stations in Chicago")
