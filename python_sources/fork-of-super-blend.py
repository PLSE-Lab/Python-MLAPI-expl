# Inspired by Shujian Liu's post on LinkedIn:
# https://www.linkedin.com/feed/update/urn:li:activity:6379302503325982721/

# Credits:
# Bojan Tunguz, Anthony Marakis, Håkon Hapnes Strand, Prashant Kikani, the1owl and rednivrug
...
submission.to_csv('tr8.csv', index=False)