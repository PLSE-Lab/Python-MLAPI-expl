...
# 
k=d[d.parent_incident_type.str.match(r'Breaking & Entering*')]
t=k[['title','timeStamp','lat','lng','desc','twp']]
t=t[(t['timeStamp'] >= '2017-10-01 00:00:00')]
...
for i in range(0,len(lat)):
    ...
    s+="['%s ', %s, %s, %s,'https://storage.googleapis.com/montco-stats/images/homeIbb.png'],\n" % (displayTitle,lat[i],lng[i],i)
