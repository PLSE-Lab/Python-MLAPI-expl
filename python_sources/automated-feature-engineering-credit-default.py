...
# # Automated Feature Engineering | Credit Default  
# **David Rivas, Ph.D.**  
#   
#   
# # Abstract
...
# All entities in the entityset can be related to each other. In theory this allows us to calculate features for any of the entities, but in practice, we will only calculate features for the `app` dataframe since that will be used for training/testing. 
...
# If you are interested in running this call on the entire dataset and making the features, the main reference wrote a script [for that here](https://www.kaggle.com/willkoehrsen/feature-engineering-using-feature-tools). Unfortunately, this will not run in a Kaggle kernel due to the computational expense of the operation. Using a computer with 64GB of ram, this function call took around 24 hours. The main reference made the entire dataset available [here](https://www.kaggle.com/willkoehrsen/home-credit-default-risk-feature-tools/data) in the file called `feature_matrix.csv`. 
# 
...
# # References used  
# [Automated Feature Engineering Basics](http://kaggle.com/willkoehrsen/automated-feature-engineering-basics) by Will Koehrsen  
# [Automated Feature Engineering in Python](https://towardsdatascience.com/automated-feature-engineering-in-python-99baf11cc219) by Will Koehrsen
# 
