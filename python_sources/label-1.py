...
selector = selector.fit(x_train,label0)
...
np.save('benchmark_label1_GA.npy',x_train_label1)


# In[ ]:


np.save('benchmark_label1_features_GA.npy',selector.support_ )
