# forked from script code by gilles .. https://www.kaggle.com/sv/145140
import pandas as pd 
import numpy as np 
...
df1 = pd.DataFrame({'x': train_preds})
df2 = pd.DataFrame({'x': test_preds})
df1.to_csv('train_preds.csv', index=False)
df2.to_csv('test_preds.csv', index=False)
...
preds_out.to_csv('xgb_offset_submission_02.csv')