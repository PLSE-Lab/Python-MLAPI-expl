...
#From the graph we can see that the number of faudulent transactions are very low compared to the legal transactions
...
print('number of legal transactions--')
print(len(legal))
...
# Thus we can see that the SVM, KNN and the Naive Bayes algorithms produce the most accurate results.
