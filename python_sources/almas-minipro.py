...
#analysis about the data we have
data
...
#using transfer learning model resnet18
...
img = open_image('/kaggle/input/chest-xray-pneumonia/chest_xray/test/PNEUMONIA/person87_bacteria_434.jpeg')
