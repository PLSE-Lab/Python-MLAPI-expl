...
get_ipython().run_cell_magic('time', '', "train = pd.read_csv('../input/train.csv', dtype=dtypestrain).drop(['var_184','var_199'], axis=1)\ntest = pd.read_csv('../input/test.csv', dtype=dtypestest).drop(['var_184','var_199'], axis=1)")
...
get_ipython().run_cell_magic('time', '', "LGBDART_FIT = LGBDART.fit(X_train, y_train, \n                  eval_set=[(X_val,y_val)], \n                  eval_metric= ['auc','binary_logloss'], \n                  #early_stopping_rounds=100, \n                  verbose=50)")
...
get_ipython().run_cell_magic('time', '', "LGBREGQNT_FIT = LGBREGQNT.fit(X_train, y_train, \n                  eval_set=[(X_val,y_val)], \n                  eval_metric= ['auc','quantile'], \n                  early_stopping_rounds=100, \n                  verbose=50)")
...
get_ipython().run_cell_magic('time', '', "LGBGOSS_FIT = LGBGOSS.fit(X_train, y_train, \n                  eval_set=[(X_val,y_val)], \n                  eval_metric= ['auc','binary_logloss'], \n                  early_stopping_rounds=100, \n                  verbose=50)")
