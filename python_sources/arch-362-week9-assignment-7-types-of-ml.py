...
# **Fork this notebook**. **Rename your copy**. **Do not Edit this copy**
...
advertising = pd.read_csv('../input/tvmarketing.csv')#Telling the computer what to read and from where
advertising.head(5)
...
sns.pairplot(advertising, x_vars=['TV'], y_vars= 'Sales', height=7, aspect=0.9, kind='scatter')
