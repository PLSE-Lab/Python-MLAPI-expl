...
# ![BubbleMap_mch29.png](attachment:BubbleMap_mch29.png)
...
# ## Forecast Estimated of Confirmed Cases and Deaths (April 12, 2020)
# 
# ![sigmoid_model_estimates.png](attachment:sigmoid_model_estimates.png)
...
cleaned_data = pd.read_csv('../input/covid19dailydata2/complete_data_new_format.csv', parse_dates=['Date'])
cleaned_data.head()
#print(cleaned_data)
...
plot_titles = ['US','Spain','Italy','France','Germany','Iran','Belgium','Switzerland','Netherlands','South Korea']
