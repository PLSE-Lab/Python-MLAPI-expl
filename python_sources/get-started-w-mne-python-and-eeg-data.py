...
Updated 02/13/2019 to work with new "part 2" single subject datasets 
@author: brian roach
...
#so, column labels needs to be pulled from our other dataset:
#
...
for i,subject in enumerate(subjects):
    ...
    fnames = glob("../input/buttontonesz2/%d.csv/%d.csv" % (subject, subject)) #glob("../input/%d.csv" % (subject))
