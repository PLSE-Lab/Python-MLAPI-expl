...
#read data from xlsx
excel_dataframe = pd.read_excel('../input/unstructured-data/Unstructured Data English.xlsx')

#read only required columns
excel_dataframe = excel_dataframe[['ID', 'Katakana text Translated']]

#extract Katakana text Translated column and convert it to string format
tweets = excel_dataframe['Katakana text Translated'].to_string(index=False)
...
tweets = list(excel_dataframe['Katakana text Translated'])
