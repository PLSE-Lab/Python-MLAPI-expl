...
# Comprehensive analysis of GPU models over time, by price, max resolution, and various performance metrics. Please upvote if you like it, this notebook took time to compose.
...
# ### 1.3 Preprocessing<a class="anchor" id="preprocessing"></a>
...
plt.title('Price/performance ra')
