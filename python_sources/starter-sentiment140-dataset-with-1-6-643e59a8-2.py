...
# ### Let's check 1st file: ../input/training.1600000.processed.noemoticon.csv
...
df1 = pd.read_csv('../input/training.1600000.processed.noemoticon.csv', delimiter=',', nrows = nRowsRead)
