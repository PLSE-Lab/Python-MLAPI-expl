...
get_ipython().system('git clone https://github.com/udacity/CarND-Advanced-Lane-Lines.git')
...
get_ipython().system('wget "https://www.kaggleusercontent.com/kf/22717527/eyJhbGciOiJkaXIiLCJlbmMiOiJBMTI4Q0JDLUhTMjU2In0..hFNng1yFKymqHz8EFJvVvw.AZoIDMKbHjspKBbQ0wy-_gz2A0ZOtsLWEdJdXWiajqn1oLZ6udBuJYRE2vhtTYZUVpsm816sL2ZkmXe-j9vXJqDbFE89QI1BahE1UTompmYJOh5Bcjr1f14sXfm9SwlfN1nYsj7ndAZTariF0FTm8h8mOdh4_K4dCHCErF6SKcc.eoMHjBFozmzgz18va-__1g/calibration_pickle.p"')
...
get_ipython().run_line_magic('time', 'video1_clip.write_videofile(video1_output, audio=False)')
...
get_ipython().run_line_magic('time', 'video2_clip.write_videofile(video2_output, audio=False)')
...
get_ipython().run_line_magic('time', 'video3_clip.write_videofile(video3_output, audio=False)')
