...
data1['Product_Category_2'].min()
data1['Product_Category_2'].max()


# In[ ]:


def fillNaN_with_random(data1):
    a = data1.values
    m = np.isnan(a) 
...
print(data1['Product_Category_2'])


# In[ ]:


fillNaN_with_random(data1['Product_Category_2'])
...
print(data2['Product_Category_2'])


# In[ ]:


fillNaN_with_random(data2['Product_Category_2'])
...
X=data1[['Gender','Purchase','Age']].values
