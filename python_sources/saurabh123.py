...
data1 = pd.DataFrame({"Id": test['Id'].values, "Response": data[1]})
data2=pd.DataFrame({"Id": test['Id'].values, "Response": np.clip(data[1], 1, 8)})
