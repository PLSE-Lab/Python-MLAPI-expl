...
query = """ SELECT f.repo_name AS repo, COUNT(c.commit) AS num_of_commits
...
num_commit_in_python = github.query_to_pandas_safe(query, max_gb_scanned = 10)
num_commit_in_python
