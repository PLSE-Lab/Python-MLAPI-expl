...
def xgboost_pred(train,labels,test):
	...
	#Using 3000 rows for early stopping. 
	offset = 3000
...
preds1OUT = pd.DataFrame({"Id": test_ind, "Hazard": preds1})
preds1OUT = preds1OUT.set_index('Id')   
preds1OUT.to_csv('xgboost_preds_1OUT.csv')
