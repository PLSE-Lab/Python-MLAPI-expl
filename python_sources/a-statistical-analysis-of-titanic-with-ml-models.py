...
train.select_dtypes(include = ['O']).iloc[:,1].value_counts(dropna = False)
...
train.loc[:,'Survived'][train.Sex == 'female'].mean()
...
knn = KNeighborsClassifier(weights="distance", n_neighbors=23,  metric='minkowski', p =2 )
...
# 
# If you would like to discuss any fun project ideas or other topics about data science, just give me a nudge in [my website](http://masumrumi.strikingly.com/) or [LinkedIn](https://www.linkedin.com/in/masumrumi/ )
# 
