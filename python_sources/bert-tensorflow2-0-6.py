...
gkf = GroupKFold(n_splits=15).split(X=df_train.question_body, groups=df_train.question_body) # originaln_splits=5
...
# 
# Loops over the folds in gkf and trains each fold for 5 epochs --- with a learning rate of 3e-5 and batch_size of 8. A simple binary crossentropy is used as the objective-/loss-function. 
