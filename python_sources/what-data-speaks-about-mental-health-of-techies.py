...
# 
# <p align="center">
#   <img src="https://www.fionaoloughlin.ie/wp-content/uploads/2018/04/mental-health.jpg"/>
# </p>
# 
...
# # [Download the dataset](https://www.kaggle.com/gbletsch/mental-health-in-tech-2014?select=survey_2014.csv)
...
space = [0.1,0.2,0.4]
data['Gender'].value_counts().plot(kind='pie', wedgeprops=dict(width=0.5), explode=space, fontsize=12,autopct='%1.1f%%')
