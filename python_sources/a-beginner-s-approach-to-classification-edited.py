...
# This a preface to the original author's introduction. I'm using this tutorial kernel to learn the ropes at Kaggle. The interface seems a tad quirky while I get accustomed to it. Somehow I accidentally delated the changes before making the other publish.
# 
# I wonder if it's possible to edit locally in a ipython notebook, and then push to both kaggle and github.
...
# This is a helpful notebook. I'm editing it to see how to to use kaggle. The markdown/python switch had a strange behavior just now. It's switching on its own.
...
# Using this tutorial kernel to learn the ropes.
