...
get_ipython().system('unzip -q ../input/recursion-2019-load-resize-and-save-images/train.zip -d ../tmp')
get_ipython().system('unzip -q ../input/recursion-2019-load-resize-and-save-images/test.zip -d ../tmp ')
