...
countries = set(no_ppm_countries.country) # Countries which do not use ppm as a unit of measurement
len(countries) # 64 countries
...
pollutants = set(pollutant_0.pollutant) # Pollutants which have a value of 0
len(pollutants) # 7 pollutants
pollutants
