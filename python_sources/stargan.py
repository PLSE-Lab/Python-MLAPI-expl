...
# Directories.
parser.add_argument('--celeba_image_dir', type=str, default='../input/celeba-dataset/img_align_celeba/img_align_celeba')
parser.add_argument('--attr_path', type=str, default='../input/celebaattr/list_attr_celeba.txt')
