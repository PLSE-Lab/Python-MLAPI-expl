...
#training
get_ipython().run_line_magic('time', 'grid_log.fit(X_train[BestFeat_log], y_train)')
...
#training
get_ipython().run_line_magic('time', 'grid_SVC.fit(X_train, y_train)')
...
#training
get_ipython().run_line_magic('time', 'grid_ada.fit(X_train[BestFeat_ada], y_train)')
...
#training
get_ipython().run_line_magic('time', 'grid_forest.fit(X_train[BestFeat_for], y_train)')
...
#training
get_ipython().run_line_magic('time', 'grid_XGB.fit(X_train[BestFeat_XGB], y_train)')
