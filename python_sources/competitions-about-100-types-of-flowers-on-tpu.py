...
with strategy.scope():
    ...
    #pretrained_model = tf.keras.applications.Xception(weights='imagenet', include_top=False ,input_shape=[*IMAGE_SIZE, 3])
    #pretrained_model = tf.keras.applications.NASNetLarge(weights='imagenet', include_top=False ,input_shape=[*IMAGE_SIZE, 3])
    ...
    input_shape=(331, 331, 3), include_top=False, weights='imagenet', input_tensor=None,
