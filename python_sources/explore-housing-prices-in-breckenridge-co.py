...
def plot_five_columns_using_plotly_regular(dataframe,column_one,column_two,column_three,column_four,column_five,title):    
    '''
...
def plot_five_columns_using_plotly_express(dataframe,column_one,column_two,column_three,column_four,column_five,title):
    '''
    This function plots four numerical columns against a date column.
    It using the plotly express library instead of the normal plotly library.
    '''
    df_melt = dataframe.melt(id_vars='Date', value_vars=[column_one,column_two,column_three,column_four,column_five])
...
breckenridge_df = load_zillow_data(state='CO',county='Summit County',
                              region='Dillon',city='Breckenridge')
...
breckenridge_df.plot(title='Median Prices of Homes and Rental Units in Breckenridge, CO',figsize=(12,9), grid=True)
...
plot_five_columns_using_plotly_regular(breckenridge_df,'City_Zhvi_1bedroom',
                                        'City_Zhvi_2bedroom','City_Zhvi_3bedroom',
                                        'City_Zhvi_4bedroom','City_Zhvi_5BedroomOrMore',
                                        'Median Home Prices in Breckenridge, CO')
...
plot_five_columns_using_plotly_express(breckenridge_df, 'City_Zhvi_1bedroom',
                                        'City_Zhvi_2bedroom','City_Zhvi_3bedroom',
                                        'City_Zhvi_4bedroom','City_Zhvi_5BedroomOrMore',
                                        'Median Home Prices in Breckenridge, CO')
