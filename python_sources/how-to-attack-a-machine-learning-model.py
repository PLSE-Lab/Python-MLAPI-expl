...
# We found out that each digit has its natural fooling target. For example 9 was likely predicted as 5 or 7 which makes sense as all three have "two bubbles" on top of each other as a sketch shape.
...
# $\epsilon = 128$: is minumum value thatwe can chose for this image, with a lower epsilon value our model couldn't turn the 9(Ankle Boot) image into 0(T-shirt/top) and 3(Dress). 
# 
# Change the epsilon value and see the results yourself :-) 
