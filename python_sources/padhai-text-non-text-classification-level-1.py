...
sn_mse.fit(X_scaled_train, Y_train, epochs=500, learning_rate=0.011, loss_fn="mse", display_loss=True)
...
sn_ce = SigmoidNeuron()
sn_ce.fit(X_scaled_train, Y_train, epochs=300, learning_rate=0.01, loss_fn="ce", display_loss=True)
