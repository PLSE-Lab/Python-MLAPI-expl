...
features_one = train[['Neutered',"AgeInYears","AnimalType"]].values
...
#Categorical to Numerical conversion of AGe
test['AgeCategory'][test['AgeCategory']=='young']=0
test['AgeCategory'][test['AgeCategory']=='young adult']=1
test['AgeCategory'][test['AgeCategory']=='adult']=2
test['AgeCategory'][test['AgeCategory']=='old']=3

test['Neutered'] = test.SexuponOutcome.apply(get_neutered)
#Categorical to Numerical conversion of Sex
test['Neutered'][test['Neutered']=='neutered']=0
test['Neutered'][test['Neutered']=='intact']=1
test['Neutered'][test['Neutered']=='unknown']=2


# Extract the features from the test set: Pclass, Sex, Age, and Fare.
test_features = test[['Neutered',"AgeInYears","AnimalType"]].values
