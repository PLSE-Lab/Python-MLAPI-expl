...
# In this interactive graph the customer can select the desired engine size and weight of cars which will in turn shows the miles per gallon on the second graph and vice-versa, as the customer select the engine size and mileage it shows the weight of that particular car. This is really helpful for the customer who wants to prioritise their car features according to their own wish.
...
# The graph gives us information on the number of vehicles available in each manufacturer with respect to different types company. Easy for customer to sort out different companies in the decision making process of prioritising manufacturers.
...
# The graph put forth the information regarding the horsepower of different cars manufactured by different companies. The mean line will help the customer to categorise vehicles above a certain horsepower and below it making it easier to sort cars according to their desire.
