...
# * Depth  = 3
# * 1 - Root Node (/users/rt/courses/)
# * 2 - cs252/
# * 3 - projects/
# 
# h. What is the height of the tree?
# * Height = 4
# * From Root Node (/user/rt/courses/):
#     * 1 - cs252/
#     * 2 - projects/
#     * 3 - papers/
#     * 4 - buylow
...
# 2. For the following tree, demonstrate (by hand) the output of:
# 
# ![image.png](attachment:image.png)
# 
# 
# a. Inorder traversal:
# * 4, 2, 5, 1, 8, 6, 3, 9, 10, 7 
# * 10 is left of 7 therefore is visited before 7
# 
...
# 3. Using LinkedBinaryTree (ch08/linked_binary_tree.py), recreate the tree above, and use the various traversals to check that your outputs for question 2 were correct.

# > # Tree Class TextbookSampleCode (Code Hidden)
...
# # Binary Tree from TextbookSampleCode [](http://)(Code Hidden)
...
# # LinkedBinaryTree from TextbookSampleCode (Code Hidden)
...
# Using the same traversals (inorder, preorder and postorder) give the same results as question 2.

# In[39]:


inorder_tree = tree.inorder()
...
postorder_tree = tree.postorder()
for i in postorder_tree:
    print(i.element())
