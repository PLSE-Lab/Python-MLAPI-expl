...
# This notebook is a reproduction of the model that i trained using Google colab which provides free and reliable GPU runtime in the cloud. To be able to submit the notebook in Kaggle i have converted the Google colab related cells to markdown cells
# 
# To view the Google colab ntebook please use the link below 
# [View in Colaboratory](https://colab.research.google.com/github/kbalu99/kaggle-minst-cnn/blob/master/kaggle_minst_cnn.ipynb)
# 
# The keras model is saved and converted to tensorflowjs model for use in an Angular Webapp to demo inference
# 
# Demo of the model is here - https://kbalu99.github.io/minst-cnn
# 
# 
