...
# **HEATMAP OF CHANGE IN UNEMPLOYMENT RATE**
# 
...
ax = sns.heatmap(country_pivot, cmap='cubehelix_r')
plt.title('Movement in Unemployment rate [Darker: Higher rate || Lighter: Lower rate]')


# **BARPLOT OF CHANGE IN UNEMPLOYMENT RATE**
# 
# And here we plot a Seaborn barplot just to visualise the data in a different manner
