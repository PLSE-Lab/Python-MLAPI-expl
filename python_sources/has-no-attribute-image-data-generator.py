...
my_new_model = Sequential() # what does this mean: include_top=False
...
my_new_model.fit_generator(
        train_generator,
        steps_per_epoch=2 * 22, 
    # how to choose this number? 
    #https://stackoverflow.com/questions/47928347/value-of-steps-per-epoch-passed-to-keras-fit-generator-function
