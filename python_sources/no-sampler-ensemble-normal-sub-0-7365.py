...
get_ipython().system('python ../input/tweet-inference-scripts-lvl-2/inference_cnn_2_2.py')


# In[ ]:


get_ipython().system('python ../input/tweet-inference-scripts-lvl-2/inference_wavenet_4_3.py')


# In[ ]:


get_ipython().system('python ../input/tweet-inference-scripts-lvl-2/inference_rnn_5_3.py')


# In[ ]:


get_ipython().system('python ../input/tweet-inference-scripts-lvl-2/inference_wavenet_0_3.py')
