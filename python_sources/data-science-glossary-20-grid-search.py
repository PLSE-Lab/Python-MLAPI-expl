...
# - We are going to use the <a href='https://www.kaggle.com/c/titanic'>Titanic</a> dataset.
...
# Passanger who didn't  survived has edge over survived passanger.  
...
#  lets keep all the features as there is no strong evidence of data redundancy.
...
# P values for features Sex, Embarked and Pclass are very low. So we can reject our Null Hypothesis which states that " features are independent and have no relationship with target variable"
...
# * Let's check  features containing missing values
...
# - Here's the official document of <a href='https://scikit-learn.org/stable/modules/generated/sklearn.model_selection.GridSearchCV.html'>Grid Search</a>.
