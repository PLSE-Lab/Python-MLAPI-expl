...
# # Cumulative Graph of the maintenance time of machine breakdown

# ## Problem Statement

# Lets assume that the allowable maintenance time of machines in a specific manufacturing plant is 180 minutes. Based on previous data, we want to analyze whether allowing 180 minutes for maintenance is reasonable.
