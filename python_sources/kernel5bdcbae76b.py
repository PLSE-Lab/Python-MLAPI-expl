...
#Checking for the null values is exist or not?
...
#Creating a dataset to analyze the cases for all country wise

latest_data = country_grouped_covid['ObservationDate'] == '03/10/2020'
...
# Analysis of Spread and Death Due to COVID-19

# In[ ]:


#Plotting a bar graph for confirmed cases vs deaths in the World.
...
latest_data = covid_data['Date'] == '28-03-2020'
...
# Role of Temp and Climate change in COVID-19 Cases
...
# Building the timeseries model using selecting the column for manipulation
