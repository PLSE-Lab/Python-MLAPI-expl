...
# This notebook is becoming a modified version of the notebook [Machine Learning Tutorial for Beginners](https://www.kaggle.com/kanncaa1/machine-learning-tutorial-for-beginners) for the purpose of my own personal use (work in progress).  
# 
# 
