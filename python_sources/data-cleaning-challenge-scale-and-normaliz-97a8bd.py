...
# **Answer**  *Normalize the data*. As stated earlier, you use normalization for data that is not normaly distributed and also if you are using linear regression model. I this case time is not normalize since some student do not study at all.
# 
# * You're still working on your grades study, but you want to include information on how students perform on several fitness tests as well. You have information on how many jumping jacks and push-ups each student can complete in a minute. However, you notice that students perform far more jumping jacks than push-ups: the average for the former is 40, and for the latter only 10. Should you scale or normalize these variables?
# **Answer** *Scaling data* would work in this case. There is a large gap between the former and the latter.
...
# min_max scale data between 0 and 1
...
# Both colums *usd_pledged_real* and the *pledged* seem to have the same info.
