...
sn_mse.fit(X_scaled_train, Y_train, epochs=500, learning_rate=0.0023, loss_fn="mse", display_loss=True)
...
sn_ce = SigmoidNeuron()
sn_ce.fit(X_scaled_train, Y_train, epochs=200, learning_rate=0.0022, loss_fn="ce", display_loss=True)
