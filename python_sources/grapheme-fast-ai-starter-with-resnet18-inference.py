...
# 
# The original kernel is [here](https://www.kaggle.com/iafoss/grapheme-fast-ai-starter). Check it for more training details. The image preprocessing pipline is provided [here](https://www.kaggle.com/iafoss/image-preprocessing-128x128).
