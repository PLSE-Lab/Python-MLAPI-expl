...
def _convert_coordinates_to_raster(coords, img_size, xymax):
    ...
    print("executing _convert_coordinates_to_raster")
    Xmax, Ymax = xymax
    H, W = img_size
    W1 = 1.0 * W * W / (W + 1)
    H1 = 1.0 * H * H / (H + 1)
...
def _get_xmax_ymin(grid_sizes_panda, imageId):
    # __author__ = visoft
    # https://www.kaggle.com/visoft/dstl-satellite-imagery-feature-detection/export-pixel-wise-mask
    print("executing _get_xmax_ymin")
...
def _get_polygon_list(wkt_list_pandas, imageId, cType):
    # __author__ = visoft
    # https://www.kaggle.com/visoft/dstl-satellite-imagery-feature-detection/export-pixel-wise-mask
    print("executing _get_polygon_list")
...
def _get_and_convert_contours(polygonList, raster_img_size, xymax):
    # __author__ = visoft
    # https://www.kaggle.com/visoft/dstl-satellite-imagery-feature-detection/export-pixel-wise-mask
    print("executing _get_and_convert_contours")
    perim_list = []
    interior_list = []
...
def _plot_mask_from_contours(raster_img_size, contours, class_value=1):
    # __author__ = visoft
    # https://www.kaggle.com/visoft/dstl-satellite-imagery-feature-detection/export-pixel-wise-mask
    print("executing _plot_mask_from_contours")
...
def generate_mask_for_image_and_class(raster_size, imageId, class_type, grid_sizes_panda=GS, wkt_list_pandas=DF):
    # __author__ = visoft
    # https://www.kaggle.com/visoft/dstl-satellite-imagery-feature-detection/export-pixel-wise-mask
    print("executing generate_mask_for_image_and_class")
...
def jaccard_coef_int(y_true, y_pred):
    # __author__ = Vladimir Iglovikov
    print("executing jaccard_coef_int")
...
def stick_all_train():
    print("executing stick_all_train")
...
def get_unet():
    ...
    print("executing conv5 Convolution2D")
    ...
    print("executing conv10 Convolution2D")
...
def mask_for_polygons(polygons, im_size):
    ...
    print("executing mask_for_polygons")
...
def mask_to_polygons(mask, epsilon=5, min_area=1.):
    ...
    print("executing mask_to_polygons")
...
def batch_generator(X, y, batch_size, shuffle):
    ...
    print("executing batch_generator")
...
def batch_generatorp(X, batch_size, shuffle):
    print("executing batch_generatorp")
...
if __name__ == '__main__':
    ...
    x, y = stick_all_train()
    print("executing main make val")
    x_val, y_val = make_val(x, y)
    print("executing main train_net")
    model = train_net(x, y, x_val, y_val)
    print("executing main calc_jacc")
    score, trs = calc_jacc(model, x_val, y_val)
    print("executing main make_submit")
