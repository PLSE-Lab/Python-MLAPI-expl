...
# Here we calculate the rotated bounding boxes for all `29070` images and save then into a dictionary. 
...
# Export these bounding boxes for everyone to use in a Pandas dataframe.
