...
# Parameters
prediction_stderr = 0.007301  #  assumed standard error of predictions
...
train['rel_floor'] = 0.005+train['floor'] / train['max_floor'].astype(float)
train['rel_kitch_sq'] = 0.005+train['kitch_sq'] / train['full_sq'].astype(float)

test['rel_floor'] = 0.005+test['floor'] / test['max_floor'].astype(float)
test['rel_kitch_sq'] = 0.005+test['kitch_sq'] / test['full_sq'].astype(float)
