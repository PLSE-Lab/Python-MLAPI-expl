...
def featurize(df, df_meta, aggs, fcp, n_jobs=4):
    ...
    agg_df_mjd_pas['0_1_diff_det_mjd_pas']=agg_df_mjd_pas['0_diff_det_mjd_pas'] - agg_df_mjd_pas['1_diff_det_mjd_pas']
    agg_df_mjd_pas['0_2_diff_det_mjd_pas']=agg_df_mjd_pas['0_diff_det_mjd_pas'] - agg_df_mjd_pas['2_diff_det_mjd_pas']
    agg_df_mjd_pas['0_3_diff_det_mjd_pas']=agg_df_mjd_pas['0_diff_det_mjd_pas'] - agg_df_mjd_pas['3_diff_det_mjd_pas']
    agg_df_mjd_pas['0_4_diff_det_mjd_pas']=agg_df_mjd_pas['0_diff_det_mjd_pas'] - agg_df_mjd_pas['4_diff_det_mjd_pas']
    agg_df_mjd_pas['0_5_diff_det_mjd_pas']=agg_df_mjd_pas['0_diff_det_mjd_pas'] - agg_df_mjd_pas['5_diff_det_mjd_pas']
    
    agg_df_mjd_pas['1_2_diff_det_mjd_pas']=agg_df_mjd_pas['1_diff_det_mjd_pas'] - agg_df_mjd_pas['2_diff_det_mjd_pas']
    agg_df_mjd_pas['1_3_diff_det_mjd_pas']=agg_df_mjd_pas['1_diff_det_mjd_pas'] - agg_df_mjd_pas['3_diff_det_mjd_pas']
    agg_df_mjd_pas['1_4_diff_det_mjd_pas']=agg_df_mjd_pas['1_diff_det_mjd_pas'] - agg_df_mjd_pas['4_diff_det_mjd_pas']
    agg_df_mjd_pas['1_5_diff_det_mjd_pas']=agg_df_mjd_pas['1_diff_det_mjd_pas'] - agg_df_mjd_pas['5_diff_det_mjd_pas']
    
    agg_df_mjd_pas['2_3_diff_det_mjd_pas']=agg_df_mjd_pas['2_diff_det_mjd_pas'] - agg_df_mjd_pas['3_diff_det_mjd_pas']
    agg_df_mjd_pas['2_4_diff_det_mjd_pas']=agg_df_mjd_pas['2_diff_det_mjd_pas'] - agg_df_mjd_pas['4_diff_det_mjd_pas']
    agg_df_mjd_pas['2_5_diff_det_mjd_pas']=agg_df_mjd_pas['2_diff_det_mjd_pas'] - agg_df_mjd_pas['5_diff_det_mjd_pas']
    
    agg_df_mjd_pas['3_4_diff_det_mjd_pas']=agg_df_mjd_pas['3_diff_det_mjd_pas'] - agg_df_mjd_pas['4_diff_det_mjd_pas']
    agg_df_mjd_pas['3_5_diff_det_mjd_pas']=agg_df_mjd_pas['3_diff_det_mjd_pas'] - agg_df_mjd_pas['5_diff_det_mjd_pas']
    
    agg_df_mjd_pas['4_5_diff_det_mjd_pas']=agg_df_mjd_pas['4_diff_det_mjd_pas'] - agg_df_mjd_pas['5_diff_det_mjd_pas']
    ...
    result['hspxmjd_det']=result['hostgal_specz']*result['mjd_diff_det']
...
def predict_chunk_0(df_, clfs_, meta_, features, featurize_configs, train_mean):
    
    preds_df_ = pd.DataFrame()
    preds_df_['object_id'] = df_['object_id'].unique()
    preds_df_['class_6'] = 0
    preds_df_['class_15'] = 0
    preds_df_['class_16'] = 0
    preds_df_['class_42'] = 0
    preds_df_['class_52'] = 0
    preds_df_['class_53'] = 0
    preds_df_['class_62'] = 0
    preds_df_['class_64'] = 0
    preds_df_['class_65'] = 0
    preds_df_['class_67'] = 0
    preds_df_['class_88'] = 0
    preds_df_['class_90'] = 0
    preds_df_['class_92'] = 0
    preds_df_['class_95'] = 0
    preds_df_['class_99'] = 0
    return preds_df_
...
def process_test(clfs, 
    ...
    meta_train_new=pd.read_csv('../input/normalizesomethingdifferentfeatures/testdfNormal.csv')
    meta_train_new=meta_train_new.loc[:,['object_id','outlierScore', 'hipd', 'lipd', 'highEnergy_transitory_1.0_TF',
          'highEnergy_transitory_1.5_TF', 'lowEnergy_transitory_1.0_TF', 
          'lowEnergy_transitory_1.5_TF']]
    meta_train_new['highEnergy_transitory_1.0_TF']=meta_train_new['highEnergy_transitory_1.0_TF'].astype('int')
    meta_train_new['highEnergy_transitory_1.5_TF']=meta_train_new['highEnergy_transitory_1.5_TF'].astype('int')
    meta_train_new['lowEnergy_transitory_1.0_TF']=meta_train_new['lowEnergy_transitory_1.0_TF'].astype('int')
    meta_train_new['lowEnergy_transitory_1.5_TF']=meta_train_new['lowEnergy_transitory_1.5_TF'].astype('int')

    meta_test=meta_test.merge(meta_train_new,on='object_id',how ="left")
    ...
    for i_c, df in enumerate(pd.read_csv('../input/PLAsTiCC-2018/test_set.csv', chunksize=chunks, iterator=True)):
        ...
        #elif (i_c<60):
        #    preds_df = predict_chunk_0(df_=df,
        #                         clfs_=clfs,
        #                         meta_=meta_test,
        #                         features=features,
        #                         featurize_configs=featurize_configs,
...
def main(argc, argv):
    ...
    meta_train_new=pd.read_csv('../input/normalizesomethingdifferentfeatures/traindfNormal.csv')
    meta_train_new=meta_train_new.loc[:,['object_id','outlierScore', 'hipd', 'lipd', 'highEnergy_transitory_1.0_TF',
          'highEnergy_transitory_1.5_TF', 'lowEnergy_transitory_1.0_TF', 
          'lowEnergy_transitory_1.5_TF']]
    meta_train_new['highEnergy_transitory_1.0_TF']=meta_train_new['highEnergy_transitory_1.0_TF'].astype('int')
    ...
    meta_train=meta_train.merge(meta_train_new,on='object_id',how ="left")
    ...
    if 'object_id' in full_train:
        ...
        del full_train['0__skewness']
        del full_train['flux_by_flux_ratio_sq_sum']
        del full_train['3_4_diff_det_mjd_pas']
        del full_train['3__fft_coefficient__coeff_0__attr_"abs"']
