...
# # Based on Dog Breed Identification dataset - Horizontal Line Detector
# 
...
# 1. **Fork this notebook** -----done
# 2. **Run this full notebook and scroll down to see the output**  You will see the original image, as well as an example of the image we get from applying our horizontal line detector to the image. -----done
# 3. **Fill in the code cell for `vertical_line_conv`.**  You will have to think about what numbers in the list will create a vertical line detector.  Run this cell. -----done
# 4. **Add `vertical_line_conv` to `conv_list`.  Run that cell.**  You will see the output of your vertical line filter underneath the horizontal line filter.  You will also see a printed hint indicating if you got this right. -----done
# 
