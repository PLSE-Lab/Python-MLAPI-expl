...
for i in range(50000):
    if(dataset[i][1]==0):
        cl_0.append(np.int32(0))
    if(dataset[i][1]==1):
        cl_1.append(np.int32(1))
    if(dataset[i][1]==2):
        cl_2.append(np.int32(2))
    if(dataset[i][1]==3):
        cl_3.append(np.int32(3))
    if(dataset[i][1]==4):
        cl_4.append(np.int32(4))
    if(dataset[i][1]==5):
        cl_5.append(np.int32(5))
    if(dataset[i][1]==6):
        cl_6.append(np.int32(6))
    if(dataset[i][1]==7):
        cl_7.append(np.int32(7))
    if(dataset[i][1]==8):
        cl_8.append(np.int32(8))
    if(dataset[i][1]==9):
        cl_9.append(np.int32(9))
print("Class {}: Total Images {}".format(classes[0],len(cl_0)) )
print("Class {}: Total Images {}".format(classes[1],len(cl_1)) )
print("Class {}: Total Images {}".format(classes[2],len(cl_2)) )
print("Class {}: Total Images {}".format(classes[3],len(cl_3)) )
print("Class {}: Total Images {}".format(classes[4],len(cl_4)) )
print("Class {}: Total Images {}".format(classes[5],len(cl_5)) )
print("Class {}: Total Images {}".format(classes[6],len(cl_6)) )
print("Class {}: Total Images {}".format(classes[7],len(cl_7)) )
print("Class {}: Total Images {}".format(classes[8],len(cl_8)) )
print("Class {}: Total Images {}".format(classes[9],len(cl_9)) )
...
history += fit(30, 0.005, model, train_loader, val_loader)


# In[ ]:


history += fit(15, 0.025, model, train_loader, val_loader)


# In[ ]:


history += fit(15, 0.02, model, train_loader, val_loader)
...
test_results['val_acc'], test_results['val_loss']
