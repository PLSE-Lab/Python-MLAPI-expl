...
df_all = df_all.drop(['search_term','product_title','product_description','brand','product_info','attr'], axis=1)
...
model = ExtraTreesRegressor(n_estimators=1000,max_features= 10,min_samples_split= 4,
