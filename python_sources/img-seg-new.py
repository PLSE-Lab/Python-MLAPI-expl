...
balanced_train_df = unique_img_ids.groupby('grouped_ship_count').apply(lambda x: x.sample(SAMPLES_PER_GROUP) if len(x) > SAMPLES_PER_GROUP else x)
#print(balanced_train_df.sample(5))
