...
# ![Movies](https://i.pinimg.com/originals/23/d1/b8/23d1b8d4e491ae43f2b7bc9645c29aba.gif)
...
# **Contents**
# 
# 1. [Importing Libaries](#1)
# 1. [Reading and Exploring the data](#2)
# 1. [Data Analysis](#3)
# 1. [Cleaning of data](#4)
...
# ## 1. Importing Libaries <a class="anchor" id="1"></a>
# 
...
# ## 2. Reading and Exploring Data <a class="anchor" id="2"></a>
# 
...
data= pd.read_csv('../input/movielens-dataset/movies.csv')
data.shape
...
data.head(10) #displays first 10 entries 
...
ratings_data=pd.read_csv('../input/movielens-dataset/ratings.csv',sep=',')
ratings_data.shape
...
# ## 3. Cleaning Data <a class="anchor" id="3"></a>
# 
...
plt.title("Popularity of Genres",bbox={'facecolor':'k', 'pad':5},color='R',fontsize = 30)
plt.show()
