...
df = pd.read_csv('/kaggle/input/ihs-markit-sample-competition/train_sample.csv', index_col='vehicle_id')
...
df_oos = pd.read_csv('/kaggle/input/ihs-markit-sample-competition/oos_sample.csv', index_col='vehicle_id')
