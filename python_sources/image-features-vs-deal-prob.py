...
# This kernel is almost fully derivated from the excellent work of https://www.kaggle.com/shivamb/ideas-for-image-features-and-image-quality .
# 
# I tried to point out some correlation between these great features and real `deal_probability`.
# 
# I was not abble to find a relationship between `image` and `deal_probability`.
# 
