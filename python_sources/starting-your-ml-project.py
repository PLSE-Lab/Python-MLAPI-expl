...
# 
# You are about to build a simple model and then continually improve it. It is easiest to keep one browser tab for the tutorials you are reading, and a separate browser window with the code you are writing. You will write all your code in the same place, even as you progress through the sequence of explanations and instructions spread over multiple pages.
# 
# ** You will open a workspace to write your code using** <a href="https://www.kaggle.com/kernels/fork/400771" target="_blank"><b>THIS LINK</b></a>.  **Open that link in a new tab.  You will read examples predicting home prices using data from Melbourne, Australia. You will then write code to build a model predicting prices in the US state of Iowa. The Iowa data is pre-loaded in your coding notebook.****
# 
...
# --- 
# # Your Turn
# 1. **If you didn't open a window for writing your own code using the link at the top of the page, open [this link](https://www.kaggle.com/kernels/fork/400771)  in a new tab to access your coding workspace. **
# 
# 1. **Read the Iowa data and print the summary information.  The file path for your data is already shown in your coding notebook. Look at the mean, minimum and maximum values for the first few fields. Are any of the values so crazy that it makes you think you've misinterpreted the data?**
# 
...
# 
# # Continue
# Move on to the next [page](https://www.kaggle.com/dansbecker/Selecting-And-Filtering-In-Pandas/) where you will be focusing on the most relevant columns.
