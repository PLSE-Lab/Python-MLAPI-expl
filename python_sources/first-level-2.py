...
sn_mse.fit(X_scaled_train, Y_train, epochs=1000, learning_rate=0.0155, loss_fn="mse", display_loss=True)
...
sn_ce = SigmoidNeuron()
sn_ce.fit(X_scaled_train, Y_train, epochs=1000, learning_rate=0.0155, loss_fn="ce", display_loss=True)
