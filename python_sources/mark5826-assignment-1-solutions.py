...
# <h2> Welcome to MARK5826 Assignment 1 SOLUTIONS!</h2>
# 
...
sorts = sort(data['stars'], how = 'descending')  ### OR sort(data = data, by = 'stars', how = 'descending')
tail(sorts, 12)
...
stars = query(data, 'stars', '>3')
result = tabulate(stars['country'], stars['style'])
plot(data = result, x = 'country', y = 'count', colour = 'style')
