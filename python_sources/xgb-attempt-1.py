# Based on https://www.kaggle.com/realtwo/prudential-life-insurance-assessment/xgb-test/run/152209
# The form & function has remained the same as above, but the parameters have been altered
...
# train model
# Ok so I lied above... removed the learning_rates option, so the form changed maybe¿
...
preds_out.to_csv('xgb_attempt_1.csv')