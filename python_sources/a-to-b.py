...
train_B = pd.DataFrame(data=train_total[37323:].get_values(), columns=['device_id', 'group'])
...
#Drop out 0.2
#Validation 2.3017
result.to_csv('sub_bagofapps_softmax_B.csv', index=True, index_label='device_id')
