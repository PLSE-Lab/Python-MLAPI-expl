...
import os  # input data paths
import cv2
import numpy as np # linear algebra
import pandas as pd # data processing, CSV file I/O (e.g. pd.read_csv)
from skimage.io import imread
import matplotlib.pyplot as plt
from skimage.segmentation import mark_boundaries  # can opencv be used ?
...
print('There are ' +str(len(images_with_ship)) + ' image files with ships')
masks.head()


# There are 131030 findings of which 104070 are from different images.
...
# Added a new column  "ships".  If an image has ship or not is marked as 0 or 1 respectively.
...
img_without_ship = cv2.imread('../input/train/00003e153.jpg')
