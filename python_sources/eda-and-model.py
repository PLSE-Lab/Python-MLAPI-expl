...
# **FVC** It is the maximum amount of air that can be that can be forcibly exhaled from the lungs.
...
# **References**
# https://www.kaggle.com/manojprabhaakr/basic-eda-dicom-images-and-lightgbm#Proportion-of-Male-and-Female-in-the-study
