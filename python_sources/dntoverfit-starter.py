...
# ### Code for beginners to easily start participating in this competition

# In[ ]:


get_ipython().system('ls ../input/300-probed-aucs-from-dont-overfit-ii')
...
# Let's visualize difference between train and test data
