...
for country in countries:
    ...
    for state in states:
        ...
        xmodel1 = XGBRegressor(n_estimators=1000,learning_rate =0.1, max_depth=5, min_child_weight=1,gamma=0, subsample=0.8,seed=27, scale_pos_weight=1,colsample_bytree=0.8)
        xmodel1.fit(X_xTrain_CS, y1_xTrain_CS)
        y1_xpred = xmodel1.predict(X_xTest_CS)
        
        xmodel2 = XGBRegressor(n_estimators=1000,learning_rate =0.1, max_depth=5, min_child_weight=1,gamma=0, subsample=0.8,seed=27, scale_pos_weight=1,colsample_bytree=0.8)
