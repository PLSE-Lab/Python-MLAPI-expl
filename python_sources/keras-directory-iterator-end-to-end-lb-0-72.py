...
# In this kernel I present an end-to-end solution using the custom Keras Directory Iterator and a small training/validation subset that I 've compiled. You can find my training data as well as the whole test dataset here https://www.kaggle.com/voglinio/speechtest. Once loaded, this dataset will give you access to the following folders
# * train_path='../input/part1/part1/train/'
# * val_path ='../input/part1/part1/val/'
# * test_path ='../input/test/test/'
# 
# This kernel ends with a submission file, that scores 0.72 on the LB. I have used limited number of epochs because of the 1 hour running time limit imposed by the kernel.
...
# I use the `keras.util.Sequence` class to iterate through test images. It is a thread safe way to predict on a series of test files.
...
# Here we define the `WavSequence` using the list of test file names and the same batch size.
...
# Let us create a submission file (and hope that the files are evaluated in order).
...
ipd.Audio(test_path_audio+'/'+'clip_5d6b88af5.wav')


# In[ ]:


ipd.Audio(test_path_audio+'/'+'clip_6eb57dec2.wav')


# In[ ]:


ipd.Audio(test_path_audio+'/'+'clip_2570d8e83.wav')
