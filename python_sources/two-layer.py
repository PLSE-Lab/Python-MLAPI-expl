...
# Two layer network. Code credits to Jannes, we made use of much of the code in the notebooks.
...
model = train(model,X,y,learning_rate=learning_rate,epochs=32000,print_loss=True)
