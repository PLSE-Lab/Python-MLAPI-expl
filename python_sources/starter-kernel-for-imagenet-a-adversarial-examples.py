...
# **Starter Kernel for ImageNet-A Adversarial Examples**
# * Adapted from https://github.com/hendrycks/natural-adv-examples
...
import os
print(os.listdir("../input/imagenet-a/imagenet-a")[:10])
...
# This code cell was adapted from https://github.com/hendrycks/natural-adv-examples/blob/master/calibration_tools.py
...
# This code cell was adapted from https://github.com/hendrycks/natural-adv-examples/blob/master/eval.py
...
naes = dset.ImageFolder(root="../input/imagenet-a/imagenet-a", transform=test_transform)
...
print('Densenet121 Accuracy on ImageNet-A Dataset (%):', round(100*acc, 4))
