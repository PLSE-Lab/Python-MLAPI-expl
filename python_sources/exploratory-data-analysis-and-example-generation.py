...
# 
# 
#   [1]: https://storage.googleapis.com/kaggle-datasets-jbf/tsa_datasets/body_zones.png
...
# Your output should look something like this (without the yellow dots):
# ![4x4 Scan View][1]
#   [1]: https://storage.googleapis.com/kaggle-datasets-jbf/tsa_datasets/4x4_scan_viewx.png
...
# Your output should look something like this (sans the meany face and the privacy barrel!):
# ![Raw Image and Histogram][1]
# 
# 
#   [1]: https://storage.googleapis.com/kaggle-datasets-jbf/tsa_datasets/raw_img_scan_hist.png
...
# ![Grayscale Scan and Histogram][1]
# 
# 
#   [1]: https://storage.googleapis.com/kaggle-datasets-jbf/tsa_datasets/grayscale_img_scan_hist.png
...
# ![High Contrast Scan and Histogram][1]
# 
# 
#   [1]: https://storage.googleapis.com/kaggle-datasets-jbf/tsa_datasets/spreadspect_img_scan_hist.png
...
# ![4x4 Feature Matrix][1]
# 
# 
#   [1]: https://storage.googleapis.com/kaggle-datasets-jbf/tsa_datasets/4x4_feature_matrix.png
...
# 
# 
#   [1]: https://storage.googleapis.com/kaggle-datasets-jbf/tsa_datasets/4x4_crop_matrix.png
