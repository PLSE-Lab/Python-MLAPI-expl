...
# * **Step 1 - Discard Images**: Use the MobileNet classifier trained in [this kernel](https://www.kaggle.com/xhlulu/severstal-steel-eda-and-detect-missing-masks) to predict all of the test images that will have all 4 masks missing. We will automatically set the RLEs of those images to null.
...
# 
# Sorry if this kernel feels a bit hacky. I will clean up the code in the upcoming days.
...
remove_model = load_model('../input/severstal-steel-eda-and-detect-missing-masks/model.h5')
