...
get_ipython().system('wget https://storage.googleapis.com/xlnet/released_models/cased_L-24_H-1024_A-16.zip')


# In[ ]:


get_ipython().system('unzip cased_L-24_H-1024_A-16.zip')
...
get_ipython().system('mkdir gs_root')
...
get_ipython().system('ls ./xlnet_cased_L-24_H-1024_A-16')
