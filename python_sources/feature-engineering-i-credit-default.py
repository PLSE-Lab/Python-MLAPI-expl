...
# # *Feature Engineering I | Credit Default*  
# **David Rivas, Ph.D.**  
# 
#   
# # Abstract  
# 
# This analysis is an extension to our [first analysis of this data base](https://www.kaggle.com/davidrivasphd/eda-classification-credit-default).
#   
...
# We can test this function using the `EXT_SOURCE_3` variable which we [found to be one of the most important variables ](https://www.kaggle.com/davidrivasphd/eda-classification-credit-default) according to a Random Forest and Gradient Boosting Machine. 
...
# Recall that the (main) train table has the unique client ID as its (unique) primary key, whereas the bureau table has various entries for each unique client. Therefore, in order to join the bureau table to the train table we first have to group by unique client ID and calculate the statistics for each group in the bureau table, then rename the statistics labels, and finally join both tables by unique client ID.  
...
# # Using the functions above to join train, bureau, and bureau_balance by unique client
# 
...
# # References Used  
# [EDA Classification | Credit Default](https://www.kaggle.com/davidrivasphd/eda-classification-credit-default#EDA-Classification-|-Credit-Default) by David Rivas, Ph.D.  
# [Introduction to Manual Feature Engineering](https://www.kaggle.com/willkoehrsen/introduction-to-manual-feature-engineering#Modeling) by Will Koehsen
# 
