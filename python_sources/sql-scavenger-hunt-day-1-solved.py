...
# #### Option 1 (better): Remove duplicates using the SELECT DISTINCT statement
...
# #### Option 2: Remove duplicates afterwards using the drop_duplicates function from Pandas
