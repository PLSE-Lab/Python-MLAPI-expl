...
get_ipython().run_line_magic('time', 'for i in range(10000): func()')
print('Calculation time for another method:')
get_ipython().run_line_magic('time', 'for i in range(10000): func2()')
...
for model in models:
    print(str(model) + ": ")
    get_ipython().run_line_magic('time', "cross_validate(model, X, y, scoring='accuracy', cv=3)")
    print(str(score) + "\n")
