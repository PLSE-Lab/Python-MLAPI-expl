# this is my first cording of Python.
# because I haven't learn machine laerning, I can't use its powerfull method.
# but there must be tendency who was survive.
# for example, female/child tended to be alive. social class is also strong facter.
...
# in this prediction, I will try to make a prediction without train data but using these famous tendency.
# it will also be checking how important train data set are.
#
# V4 : Female survive
# V5 : prediction from Pclass, Sex, Age
...
test['Is_UpperClass'] = (test['Pclass'] >= 3)
test['Is_Female'] = (test['Sex'] == 'female')
test['Is_Child'] = (test['Age'] < 18)
test['Prediction'] = (test['Is_UpperClass'] | test['Is_Female'] | test['Is_Child']).astype(int)
test.columns
test
# test['Pclass']

Submission = pd.DataFrame({ 'PassengerId': PassengerId,
                            'Survived': test['Prediction'] })
