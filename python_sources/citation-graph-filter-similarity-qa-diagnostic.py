...
# 
# ## Some sample queries and answers. The entire list of queries and their answers are shown at the bottom of this notebook
# ![task-07-1.jpg](attachment:task-07-1.jpg)
# ![task-07-2.jpg](attachment:task-07-2.jpg)
# 
...
# # Read papers Selected for "diagnostics and surveillance?" 
# Order of tasks have been changed based on popularity. Earlier this was task-9 and task-7 for some time. Using old nomenclature for some files.

# In[ ]:


Task='Task 09'
data=pd.read_excel("/kaggle/input/task3covid/task7_results_summary.xlsx")

qadata=pd.read_excel("/kaggle/input/covid-task-qa-answer/task7_results_summary_QA.xlsx")
...
def prepare_dataset(df,query,query_id=0,val=0.99):
    #print("Query is ")
