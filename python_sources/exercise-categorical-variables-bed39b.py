...
cond2_train_cat_var = set(X_train['Condition2'].unique())
cond2_train_cat_var
...
cond2_valid_cat_var = set(X_valid['Condition2'].unique())
cond2_valid_cat_var
...
cond2_train_cat_var.difference(cond2_valid_cat_var)


# In[ ]:


cond2_valid_cat_var.difference(cond2_train_cat_var)
...
# hint: added entries - dropped entries 
...
# print(score_dataset(OH_X_train_imputed, OH_X_valid_imputed, y_train, y_valid))
...
# oh_encoder_test = OneHotEncoder(sparse=False, handle_unknown='ignore')
