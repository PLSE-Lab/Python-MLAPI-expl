...
#model = model_mAlexNet(input_shape)
from keras.models import load_model
model = load_model('../input/cnrparkmodel/mAlexNet_keras.h5')
...
model.save_weights('mAlexNet_weights.h5')
model.save('mAlexNet_keras.h5')
...
#from keras.models import load_model
#model = load_model('../input/malexnetmodel/mAlexNet_keras.h5')
