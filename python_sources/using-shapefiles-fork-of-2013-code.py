'''
This is a fork of https://www.kaggle.com/pjbutcher/d/census/2013-american-community-survey/making-a-map/code
...
for key in state_codes.keys():
    m.readshapefile('../input/shapefiles/shapefiles/tl_2014_{0}_puma10'.format(key),
