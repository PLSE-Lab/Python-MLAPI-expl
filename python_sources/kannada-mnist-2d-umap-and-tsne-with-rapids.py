...
# 
# The purpose of this kernel is to showcase the speedup that one gets with t-SNE and UMAP algorithm between the CPU versions and the Rapids version. The t-SNE Sklearn version can be found [here](https://www.kaggle.com/tunguz/kannada-mnist-2d-t-sne/), and the UMAP version can be found [here](https://www.kaggle.com/tunguz/kannada-mnist-2d-umap/)
