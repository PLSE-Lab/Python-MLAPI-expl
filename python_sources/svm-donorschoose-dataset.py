...
# # 4. SAMPLING
# ## -> 4.1: Taking Sample from the complete dataset
# ## NOTE: A sample of 20000 Datapoints is taken due to lack computational resource.
...
# ## ->->-> 6.3.2.0: TF-IDF (Unigram): Essays (Train, CV, Test)
...
# ## ->->-> 6.3.2.1: TF-IDF (BiGrams): Essays (Train, CV, Test)
...
x_train_onehot_tfidf = hstack((x_train_onehot,x_train_titles_tfidf, x_train_essays_tfidf_unigram)).tocsr()
...
# ## -> 7.6: SET 6:  Merging All ONE HOT with TF-IDF (Unigram) (Only Essay) features

# In[ ]:


x_train_onehot_tfidf_forSVD = hstack((x_train_onehot, x_train_essays_tfidf_unigram)).tocsr()
# x_cv_onehot_tfidf    = hstack((x_cv_onehot,x_cv_titles_tfidf, x_cv_essays_tfidf)).tocsr()
...
# print("Shape -> One Hot TFIDF -> cv             : ",x_cv_onehot_tfidf.shape)
print("Shape -> One Hot TFIDF - Only Essays (ForSVD) -> x_test         : ",x_test_onehot_tfidf_forSVD.shape)### SET 1:  Merging ONE HOT with BOW (Title and Essay) features
...
# # -> 8.1:<font color='red'> SET 1</font>  Applying SVM on BOW (Set 1).

# 
# ## ->-> 8.1.1: <font color='red'> SET 1</font> Hyper parameter tuning to find best 'Alpha' and Best 'Regularizer L1 or L2' using GRIDSEARCHCV
...
# # -> 8.2:<font color='red'> SET 2</font>  Applying SVM on TFIDF.

# 
# ## ->-> 8.2.1: <font color='red'> SET 2</font> Hyper parameter tuning to find best 'Alpha' and Best 'Regularizer L1 or L2' using GRIDSEARCHCV
...
# # -> 8.3:<font color='red'> SET 3</font>  Applying SVM on AvgW2V.

# 
# ## ->-> 8.3.1: <font color='red'> SET 3</font> Hyper parameter tuning to find best 'Alpha' and Best 'Regularizer L1 or L2' using GRIDSEARCHCV using GRIDSEARCHCV
...
# # -> 8.4:<font color='red'> SET 4</font>  Applying SVM on TFIDF_W2V.

# 
# ## ->-> 8.4.1: <font color='red'> SET 4</font> Hyper parameter tuning to find best 'Alpha' and Best 'Regularizer L1 or L2' using GRIDSEARCHCV using GRIDSEARCHCV
...
# # -> 8.5:<font color='red'> SET 5</font>  Applying SVM on ALL EXCEPT TEXT.
...
# # Applying Truncated SVD on Essay

# In[ ]:


x_train_essays_tfidf_unigram.shape
...
# ## Printing the Explained Variance of the Truncated SVM
# 
...
# 
# ## ->-> 8.5.1: <font color='red'> SET 5</font> Hyper parameter tuning to find best 'Alpha' and Best 'Regularizer L1 or L2' using GRIDSEARCHCV using GRIDSEARCHCV
