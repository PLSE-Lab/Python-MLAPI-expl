...
train['CategoricalAge'] = pd.cut(train['Age'], 7)
...
for dataset in full_data:
    ...
    dataset.loc[(dataset['Age'] > 32) & (dataset['Age'] <= 43), 'Age'] = 3
    dataset.loc[(dataset['Age'] > 43) & (dataset['Age'] <= 55), 'Age'] = 4
    dataset.loc[(dataset['Age'] > 55) & (dataset['Age'] <= 70), 'Age'] = 5
