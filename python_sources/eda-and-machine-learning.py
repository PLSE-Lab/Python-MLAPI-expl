...
data.plot(kind="hist",y="pelvic_incidence",bins=50,range=(0,100),density=True,ax=axes[0])
data.plot(kind="hist",y="pelvic_incidence",bins=50,range=(0,100),density=True,ax=axes[1],cumulative=True)
plt.show()
...
data.plot(kind="hist",y="sacral_slope",bins=50,range=(0,100),density=True,ax=axes[0])
data.plot(kind="hist",y="sacral_slope",bins=50,range=(0,100),density=True,ax=axes[1],cumulative=True)
plt.show()
...
data.pelvic_incidence.plot(kind="line",color="g",label="Pelvic Incidence",linewidth=1,alpha=0.5,grid=True,linestyle=":")
data.sacral_slope.plot(color="r",label="Sacral Slope",linewidth=1,alpha=0.5,grid=True,linestyle="-.")
...
data.plot(kind="scatter",x="pelvic_incidence",y="sacral_slope",alpha=0.5,color="r")
plt.xlabel("Pelvic Incidence")
plt.ylabel("Sacral Slope")
plt.title("Pelvic Incidence-Sacral Slope Scatter Plot")
plt.show()
...
sns.jointplot(x=data.pelvic_incidence, y=data.sacral_slope, data=data, kind="kde");


# In[ ]:


sns.swarmplot(x = 'pelvic_incidence', y = 'sacral_slope', data = data)
plt.show()
...
ax = data.pelvic_incidence.plot.kde()
ax = data.sacral_slope.plot.kde()
ax = data.lumbar_lordosis_angle.plot.kde()
ax.legend()
plt.show()
...
g = sns.jointplot("pelvic_incidence", "sacral_slope", data=data, kind="reg",
...
sns.pointplot(x='pelvic_incidence',y='sacral_slope',data=data,color='lime',alpha=0.8)
sns.pointplot(x='pelvic_incidence',y='lumbar_lordosis_angle',data=data,color='red',alpha=0.8)
sns.pointplot(x='pelvic_incidence',y='pelvic_tilt numeric',data=data,color='blue',alpha=0.8)
plt.text(200,0.4,'pelvic_incidence-sacral_slope',color='lime',fontsize = 15,style = 'italic')
plt.text(100,0.5,'pelvic_incidence-lumbar_lordosis_angle',color='red',fontsize = 16,style = 'italic')
plt.text(0,0.6,'pelvic_incidence-pelvic_tilt numeric',color='blue',fontsize = 17,style = 'italic')
plt.xlabel('pelvic_incidence',fontsize = 15,color='blue')
plt.ylabel('values',fontsize = 15,color='blue')
plt.title('sacral_slope  -  lumbar_lordosis_angle - pelvic_tilt numeric',fontsize = 20,color='blue')
plt.grid()
