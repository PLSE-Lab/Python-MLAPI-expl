...
my_new_model.compile(optimizer='sgd', loss='categorical_crossentropy', metrics=['accuracy']) #'sgd' for the optimizer stands for stochastic gradient descent


# # 2) Fit the Model Using Data Augmentation
# 
# Run this cell and you should get a model that achieves about 90% accuracy.  By using data augmentation, you cut the error rate in half.
