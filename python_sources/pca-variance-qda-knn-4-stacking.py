...
oof_knn_var, preds_knn_var = instant_model(newtrain1, test1,                                    clf = KNeighborsClassifier(n_neighbors = 7, p = 2, weights = 'distance'),                                   selection = 'variance')
...
# oof_nusvm, preds_nusvm = instant_model(newtrain1, test1, clf = NuSVC(probability = True, kernel = 'poly'))
oof_knn_pca, preds_knn_pca = instant_model(newtrain1, test1,                                            clf = KNeighborsClassifier(n_neighbors = 7, p = 2, weights = 'distance'))
...
newX_train_stack = pd.DataFrame({"QDA_var": oof_qda_var, "QDA_pca": oof_qda_pca,                                  "KNN_var": oof_knn_var, "KNN_pca": oof_knn_pca})
newX_test_stack = pd.DataFrame({"QDA_var": preds_qda_var, "QDA_pca": preds_qda_pca,                                 "KNN_var": preds_knn_var, "KNN_pca": preds_knn_pca})
