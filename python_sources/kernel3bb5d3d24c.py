!pip install deepctr #--proxy="my_proxy_name:port"
import pandas as pd
import numpy as np
import deepctr
...
if True:
	...
	model.compile(Adam(0.005), "binary_crossentropy", metrics=['binary_crossentropy'],)
	...
	np.savetxt("result_adam0_005_PNN_ep6.txt",pred_ans,fmt = "%.20f")
	print("Ready!")
