...
# An implementation for the jigsaw competitions using a BERT pretrained model with tensorflow. Results are unimpressive.
# 
...
# source: https://raw.githubusercontent.com/google-research/bert/master/tokenization.py 
...
get_ipython().run_cell_magic('time', '', 'predictions = model.predict([test_input_ids, test_input_masks, test_segment_ids], batch_size=512).flatten()\n# predictions = model.predict([test_input_ids[:512], test_input_masks[:512], test_segment_ids[:512]], batch_size=512).flatten()')
