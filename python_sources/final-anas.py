...
X = full[~full.Survived.isnull()].drop(['Survived'], axis=1).drop(['Cabin'],axis=1).drop(['Name'],axis=1).drop(['Ticket'],axis=1).drop(['PassengerId'],axis=1).drop(['NorFare'],axis=1)
...
toPredict = full[full.Survived.isnull()].drop(['Survived'], axis=1).drop(['Cabin'],axis=1).drop(['Name'],axis=1).drop(['Ticket'],axis=1).drop(['PassengerId'],axis=1).drop(['NorFare'],axis=1)
