...
X_train, X_test, y_train, y_test = train_test_split(train_df[['qid','question_text']], train_df['target'],test_size=0.33, random_state=42)


# In[ ]:


label_encoder = LabelEncoder().fit(pd.concat([y_train, y_test]))
