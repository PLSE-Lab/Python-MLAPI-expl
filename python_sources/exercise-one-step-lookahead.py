...
# - Commit this notebook by clicking on the blue **"Commit"** button in the top right corner.
# - This will generate a pop-up window with **"Running"** in the top left corner.  Once this changes to **"Complete"**, click on **"Open Version"**.  This will open a new window.
# - Click on the **"Data"** tab on the left side of this window, and look in the list of **Output Files** to find the **submission.py** file.
# - Click on **"Submit to Competition"**.  This brings you to the Leaderboard on the competition page.
