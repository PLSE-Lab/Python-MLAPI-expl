...
# **In this project we are going to try to make the predictions without even considering the images. The results we get are not going to be the most accurate(obviously). We will try to predict the "gleason_score" using regression methods and using this new feature along with the "data_provider", we will try to predict the 'isup_grade'. This is a fairly simple project compared to the other ones that you might see but I thought this was worth exploring. Cheers!**
...
# **#Now we can test the accuracy to see how this model has performed--
# **
