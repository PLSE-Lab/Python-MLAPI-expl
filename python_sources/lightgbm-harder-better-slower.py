"""
This kernel provides a further development to the LightGBM a previously had a go with.
It is a bit longer and hence more unwieldy with around a 2h run time, but acheives a 
better score.
"""
import os
import gc
...
def feature_engineering(app_data, bureau_df, bureau_balance_df, credit_card_df,
    ...
    app_data['CHILDREN_RATIO'] = (1 + app_data['CNT_CHILDREN']) / app_data['CNT_FAM_MEMBERS']
    ...
    app_data['EXT_SOURCES_MEAN'] = app_data[['EXT_SOURCE_1', 'EXT_SOURCE_2', 'EXT_SOURCE_3']].mean(axis=1)
...
# Some parameters taken from https://www.kaggle.com/ogrellier/fork-lightgbm-with-simple-features/code                       
lgbm_params = {
    'boosting': 'dart',
    'application': 'binary',
    'learning_rate': 0.02,
