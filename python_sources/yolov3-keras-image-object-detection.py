...
# ## YOLOv3 NET
# Don't get freaked out by the following lines of code, I definitely didn't write them myself. They are used to create the YOLOv3 Neural Network in Keras.
# 
...
# This is the end of this Kernel. I hope the aforementioned implementation can help you guys getting started with creating new models! Looking forward to this challenge's results.
