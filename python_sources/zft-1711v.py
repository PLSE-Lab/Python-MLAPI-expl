...
def get_hashes(arr):
    ...
    if 1:
        ...
        sub.append((3, antiguedad))
        #sub.append((5, ind_nuevo))
        sub.append((4, ind_actividad_cliente))
        #sub.append((7, canal_entrada))
        sub.append((5, ind_nuevo,canal_entrada))
        sub.append((6, ind_empleado))
        sub.append((7,pais_residencia, sexo, renta1, age, segmento))
        sub.append((8,sexo, age, segmento))
        sub.append((9,pais_residencia, sexo, antiguedad, segmento, ind_empleado))
    else:
        # Random set
