...
get_ipython().run_cell_magic('time', '', "test = pd.read_csv('../input/clean-datasets-drift-noise-removed/test_clean_removed_drift_noise.csv')")


# In[ ]:


get_ipython().run_cell_magic('time', '', "train = pd.read_csv('../input/clean-datasets-drift-noise-removed/train_clean_removed_drift_noise.csv')")
...
get_ipython().run_cell_magic('time', '', "nestedcv_clf1s, f1_macro_score, graph = train_model_by_batch(train, 1, 2, '1s', cv_enumerator=get_nestedcv_enumerator)\nnestedcv_f1_macro_scores.append(f1_macro_score)\ngraph")


# In[ ]:


get_ipython().run_cell_magic('time', '', "kfold_clf1s, f1_macro_score, graph = train_model_by_batch(train, 1, 2, '1s', cv_enumerator=get_kfold_enumerator)\nkfold_f1_macro_scores.append(f1_macro_score)\ngraph")
...
get_ipython().run_cell_magic('time', '', "nestedcv_clf1f, f1_macro_score, graph = train_model_by_batch(train, 3, 7, '1f', cv_enumerator=get_nestedcv_enumerator)\nnestedcv_f1_macro_scores.append(f1_macro_score)\ngraph")


# In[ ]:


get_ipython().run_cell_magic('time', '', "kfold_clf1f, f1_macro_score, graph = train_model_by_batch(train, 3, 7, '1f', cv_enumerator=get_kfold_enumerator)\nkfold_f1_macro_scores.append(f1_macro_score)\ngraph")
...
get_ipython().run_cell_magic('time', '', 'nestedcv_sub, nestedcv_average_f1_macro_score = create_prediction(test, nestedcv_sub, nestedcv_params)')
...
get_ipython().run_cell_magic('time', '', 'kfold_sub, kfold_average_f1_macro_score = create_prediction(test, kfold_sub, kfold_params)')
