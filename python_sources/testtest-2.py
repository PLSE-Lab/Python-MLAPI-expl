...
# global variables
columns_to_drop = ['Id', 'Response', "Family_Hist_3","Family_Hist_5","Medical_History_10", "Medical_History_15", "Medical_History_24", "Medical_History_32"]
xgb_num_rounds = 700
num_classes = 8
eta_list = [0.05] * 200 
...
preds_out.to_csv('xgb_offset_submission_blackbull_deleted_features.csv')