...
def GrabData():
    tourneyresults = pd.read_csv('../input/stage2wdatafiles/WNCAATourneyCompactResults.csv')
    tourneyseeds = pd.read_csv('../input/stage2wdatafiles/WNCAATourneySeeds.csv')
    regularseasoncompactresults =         pd.read_csv('../input/stage2wdatafiles/WRegularSeasonCompactResults.csv')
    sample = pd.read_csv('../input/WSampleSubmissionStage2.csv')
