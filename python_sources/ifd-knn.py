...
u = [[7.6,3.4,5,2.4],       
           [5.7,3.9,2,0.3]]     #assigning the characteristics of 2 iris flowers of unknown species to unknown
predicted = knn1.predict(u)  #predicting the species of the unknown iris flowers
print("Predicted species: ", predicted)   #print the predicted species
