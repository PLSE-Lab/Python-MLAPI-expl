...
#### preprocessing
train_test["cont1"] = np.power(preprocessing.minmax_scale(train_test["cont1"]), .59)
train_test["cont2"] = np.power(preprocessing.minmax_scale(train_test["cont2"]), 1.07)
train_test["cont3"] = np.power(preprocessing.minmax_scale(train_test["cont3"]), .87)
train_test["cont4"] = np.power(preprocessing.minmax_scale(train_test["cont4"]), .26)
train_test["cont5"] = np.power(preprocessing.minmax_scale(train_test["cont5"]), 2)
train_test["cont6"] = np.power(preprocessing.minmax_scale(train_test["cont6"]), .38)
train_test["cont7"] = np.power(preprocessing.minmax_scale(train_test["cont7"]), .02)
train_test["cont8"] = np.power(preprocessing.minmax_scale(train_test["cont8"]), 5)
train_test["cont9"] = np.power(preprocessing.minmax_scale(train_test["cont9"]), .38)
train_test["cont10"] = np.power(preprocessing.minmax_scale(train_test["cont10"]), .54)
train_test["cont11"] = np.power(preprocessing.minmax_scale(train_test["cont11"]), .42)
train_test["cont12"] = np.power(preprocessing.minmax_scale(train_test["cont12"]), .42)
train_test["cont13"] = np.power(preprocessing.minmax_scale(train_test["cont13"]), .38)
