...
# ### Improving the Model using the above Statistics

# From the above result and the paiplot drawn above we may infer that, there are strong multicollinearity among 'Avg. Area Number of Bedrooms' and other independent variables, also lets find VIF values for this.
...
pd.Series(data=vifs,index=X_train.columns)
