...
# Techniques that are used in this notebook: 
# 1. residual block
# 2. lovasz loss
# 3. unet
# 4. iou
...
# 
# <font color='green'>* Private Score : 0.85323</font>
...
ZipFile('../input/test.zip').extractall('test')


# In[ ]:


basic_name = f'Unet_resnet' # python3 f string formatting
...
# src : https://www.kaggle.com/shaojiaxin/u-net-with-simple-resnet-blocks-v2-new-loss/notebook
###########
# Metrics
#########
...
# * index_col="id", usecols=[0] ==> I'm taking the first column, considering it as index
...
# * The **_loss function_** is that parameter one passes to Keras model.compile which is actually optimized while training the model . This loss function is generally minimized by the model.
# 
# * Unlike the loss function , the **_metric_** is another list of parameters passed to Keras model.compile which is actually used for judging the performance of the model.
