...
# This is the 1st out of 3 notebooks where I have plotted the **meter_reading over the year 2016 (duration of training data) for different types of meters for all the buildings across sites 0 to 5**. The goal is to quickly refer to the meter_reading for all the sites to identify outliers and gaps.
# 
# - [Plot for Site 6 to 10](https://www.kaggle.com/arnabbiswas1/eda-meter-reading-for-site-0-5/edit/run/23044140)
...
# # meter_reading site 0

# In[ ]:


plot_meter_reading_for_site(train_df, 0)


# # meter_reading site 1

# In[ ]:


plot_meter_reading_for_site(train_df, 1)


# # meter_reading site 2

# In[ ]:


plot_meter_reading_for_site(train_df, 2)


# # meter_reading site 3

# In[ ]:


plot_meter_reading_for_site(train_df, 3)


# # meter_reading site 4

# In[ ]:


plot_meter_reading_for_site(train_df, 4)


# # meter_reading site 5

# In[ ]:


plot_meter_reading_for_site(train_df, 5)
