...
# I tried to translate real selfies to anime but couldn't get good results, so this is generating anime faces based on noise using a Deep Convolutional GAN

# In[ ]:


os.listdir('../input/selfie2anime')


# Downsizing each image from (256,256,3) to (128,128,3)
...
dcgan = DCGAN()
#dcgan.train(epochs=15000, batch_size=40, save_interval=100)
