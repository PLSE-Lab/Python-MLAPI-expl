...
get_ipython().run_cell_magic('time', '', "train = pd.read_csv('../input/tmdb-box-office-prediction/train.csv')\ntest = pd.read_csv('../input/tmdb-box-office-prediction/test.csv')\ntrain.index = train['id']\ntest.index = test['id']")
...
(sns.FacetGrid(train[(train['release_year']                        .isin(train['release_year']                              .value_counts()[:5].index.values))],
