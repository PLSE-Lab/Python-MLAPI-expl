...
param_grid = {'rfr__n_estimators' : list(range(30,40,1)), 'rfr__max_depth': list(range(5,8,1))}
model = grid_search.GridSearchCV(estimator = clf, param_grid = param_grid, n_jobs = -1, cv = 12, verbose = 150, scoring=RSME)
