...
#merge evals dataset with competitions dataset
...
#find all records in competitions for which CompetitionId is in scriptprojects.CompetitionId
...
#just a list of all records for which competitions.IsMax is null
#any will iterate through the IsMax column and if null it will classify as True
...
#convert the type of Score variable to float
...
#do with submissions the same as with competitions: merging if a variable is present
