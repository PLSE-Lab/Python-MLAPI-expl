...
data_df = train_df.append(test_df,sort=True) 


# **Inputting the age as per Title**
...
# **Adding Family_Survival** for clubbing together the same tickets and researches the info
...
# **Making FARE BINS** making the continous fare data discontinous
...
# **Making AGE BINS** making the continous age data discontinous
...
# **Label Encoding SEX and dropping garbage data**
...
#applying KNN for the above model
