...
def get_params():
    ...
    params["eta"] = 0.05
    params["min_child_weight"] = 80 #240
...
train.to_csv('fea_train.csv')
test.to_csv('fea_test.csv')
...
preds_out.to_csv('xgb_offset_submission_2_check.csv')
