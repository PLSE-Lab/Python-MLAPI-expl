...
# ## HSSCC Compressive Strength Prediction using Decison Tree Regressor
...
# ## HSSCC Compressive Strength Prediction using Neural Networks

# In[ ]:


# TRAIN THE MODEL
mlp = MLPRegressor(hidden_layer_sizes=(4,3),max_iter=1000, early_stopping=True, random_state=51, solver='lbfgs')
