...
# ### Let's check 1st file: /kaggle/input/fashion-mnist_test.csv
...
df1 = pd.read_csv('/kaggle/input/fashion-mnist_test.csv', delimiter=',', nrows = nRowsRead)
...
# ### Let's check 2nd file: /kaggle/input/fashion-mnist_train.csv
...
df2 = pd.read_csv('/kaggle/input/fashion-mnist_train.csv', delimiter=',', nrows = nRowsRead)
