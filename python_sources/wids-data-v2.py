...
# **1. Frequency plot of Hospital Deaths**
...
# **2. Ethnicity vs Hospital Deaths**
...
# **3. Hospital Admit Source vs Hospital Deaths**
...
# **4. ICU Admit Source vs Hospital Deaths**
...
# **5. Hospital ID vs Hospital Deaths**
...
# **6. Freq plot of Age for hospital_death 0 and 1**
...
# ## Checking the number of unique values for remaining columns
...
# ## Extracting column with unique values <= 15
...
# ## Checking the data types of these columns for conversion to Categorical
