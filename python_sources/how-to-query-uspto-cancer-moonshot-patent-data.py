...
# # How to Query USPTO Cancer Moonshot Patent Data (BigQuery)
...
# ## Example SQL Query
# What are the names of some cancer related patents?
...
# Interpretting this number, this means my query scanned about ~0.016 GB (or 16 MB) of data in order to return a table of 20 unique patent titles from the dataset.
