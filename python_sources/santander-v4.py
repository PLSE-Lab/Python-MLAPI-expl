...
hashes_important_indexes = list(range(2, 26))
...
def get_hashes(arr):
    ...
    if 1:
        ...
        sub.append((10, pais_residencia, sexo, age, segmento))
...
def run_solution():
    ...
    sub_file = os.path.join('submission_mod' + str(map7) + '_' + str(datetime.datetime.now().strftime("%Y-%m-%d-%H-%M")) + '.csv')
    out = open(sub_file, "w")
