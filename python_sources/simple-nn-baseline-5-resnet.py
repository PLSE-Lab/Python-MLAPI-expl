...
"""
try resnet, densenet, dropout 
"""
mlp = MLP()
mlp.set_tensor(0, {'Shape': [1, 1, x_train.shape[1]], "InputType": 'pointwise', 'ImportanceMul':0.00001})
mlp.set_tensor(1, {'Shape': [1, 1, hidden_size]})
mlp.set_tensor(2, {'Shape': [1, 1, hidden_size]})
mlp.set_tensor(3, {'Shape': [1, 1, hidden_size]})
mlp.set_tensor(4, {'Shape': [1, 1, hidden_size]})
mlp.set_tensor(5, {'Shape': [1, 1, hidden_size]})
mlp.set_tensor(6, {'Shape': [1, 1, hidden_size]})
mlp.set_tensor(7, {'Shape': [1, 1, hidden_size]})
mlp.set_tensor(8, {'Shape': [1, 1, hidden_size]})
mlp.set_tensor(9, {'Shape': [1, 1, hidden_size]})
mlp.set_tensor(10, {'Shape': [1, 1, hidden_size]})
mlp.set_tensor(11, {'Shape': [1, 1, 1], 'LossType':"hardmse", "Regularization":1, 'OutputShrink':0.1, 'OutputRange':[-1,1]})

filters = [
    {'Tin': 0, 'Tout': 1, 'Op': 'fc', 'BiasRate':0.005, 'Activation':activation, 'Leaky':leaky},
    {'Tin': 1, 'Tout': 2, 'Op': 'fc', 'Activation':activation, 'Leaky':leaky},
    {'Tin': 2, 'Tout': 3, 'Op': 'fc', 'Activation':activation, 'Leaky':leaky},
    {'Tin': 3, 'Tout': 4, 'Op': 'fc', 'Activation':activation, 'Leaky':leaky},
    {'Tin': 4, 'Tout': 5, 'Op': 'fc', 'Activation':activation, 'Leaky':leaky},
    {'Tin': 5, 'Tout': 6, 'Op': 'fc', 'Activation':activation, 'Leaky':leaky},
    {'Tin': 6, 'Tout': 7, 'Op': 'fc', 'Activation':activation, 'Leaky':leaky},
    {'Tin': 4, 'Tout': 7, 'Op': 'add', 'Activation':activation, 'Leaky':leaky}, # add
    {'Tin': 7, 'Tout': 8, 'Op': 'fc', 'Activation':activation, 'Leaky':leaky},
    {'Tin': 8, 'Tout': 9, 'Op': 'fc', 'Activation':activation, 'Leaky':leaky},
    {'Tin': 9, 'Tout': 10, 'Op': 'fc', 'Activation':activation, 'Leaky':leaky},
    {'Tin': 7, 'Tout': 10, 'Op': 'add', 'Activation':activation, 'Leaky':leaky}, # add
    {'Tin': 10, 'Tout': 11, 'Op': 'fc', 'Activation':activation, 'Leaky':leaky},
]
