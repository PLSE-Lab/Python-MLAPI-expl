...
# 2. Decrease number of features. As you see from images all signs are in the middle of the frames. Therefore, around signs are same for all signs.
...
# Wow - so we've gone from 4096 dimensions to just 292!
# 
...
# And as you can see we've taken this simple model from ~47% accuracy on the test set to over 71%
