...
df_test.to_pickle("/kaggle/input/test.pkl")
...
df_train_ = pd.read_pickle("/kaggle/input/train.pkl")
df_test_ = pd.read_pickle("/kaggle/input/test.pkl")
...
for col in categorical_cols:
    ...
    X_test[col] = X_test[col].cat.add_categories('not_known')#.fillna("None")
