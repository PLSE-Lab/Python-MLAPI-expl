...
# This notebook is a practice exercise of the Level 2 couse  in the [Learn Machine Learning](https://www.kaggle.com/learn/machine-learning) curriculum. 
# In this notebook, I show my solutions to handle missing values
# 
# # Introduction
...
# # Conclusion
# In this case, we saw that the  version with missing information does not improve a lot. The score goes 
# - Mean Absolute Error from dropping columns with Missing Values: **347,856**
# - Mean Absolute Error from Imputation:                                                ** 203,480**
# - Mean Absolute Error from Imputation while Track What Was Imputed: **204,367**
# 
# We see that the best result is with imputation with mean
# 
# 
# 
