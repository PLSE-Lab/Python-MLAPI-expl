...
class Model(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.conv2 = torch.nn.Conv2d(88,32,kernel_size=5)

        self.incep_1 = InceptionM(in_channels=16)
        self.incep_2 = InceptionM(in_channels=32)
...
optimus = torch.optim.SGD(model.parameters(), lr = 0.05, momentum=0.05)
