...
# https://www.kaggle.com/carlolepelaars/ensembling-with-stacknet

# Ensemble only atm, stacking is on the way

# ### Import libraries and data, reduce memory usage
...
ensemble.isFraud=lgb_submission*0.4+xgb_submission*0.4+stack_submission*0.2
