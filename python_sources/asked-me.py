...
res = minimize(minimize_train_log_loss, [0.00,  0.00], method='Nelder-Mead', tol=1e-9, options={'maxiter': 2000})
W = res.x
...
test[ ['test_id','is_duplicate'] ].to_csv("count_words.csv", header=True, index=False)