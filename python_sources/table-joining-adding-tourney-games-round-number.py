...
# **Added the round number for each game**

# In[ ]:


def round_number (row):
    if row['Season'] >= 1998 and  row['Season'] <= 2002:
        if ( row['DayNum'] == 137 or row['DayNum'] == 138):
            return '1'
        if ( row['DayNum'] == 139 or row['DayNum'] == 140):
            return '2'
        if ( row['DayNum'] == 145):
            return '3'
        if ( row['DayNum'] == 147):
        ...
        if ( row['DayNum'] == 153):
            return 'Final'
    if row['Season'] >= 2003 and  row['Season'] <= 2014:
        if ( row['DayNum'] == 138 or row['DayNum'] == 139):
            return '1'
        if ( row['DayNum'] == 140 or row['DayNum'] == 141):
            return '2'
        if ( row['DayNum'] == 145 or row['DayNum'] == 146):
            return '3'
        if ( row['DayNum'] == 147 or row['DayNum'] == 148):
            return '4'
        if ( row['DayNum'] == 153):
            return 'SemiFinal'
        if ( row['DayNum'] == 155):
            return 'Final'  
    if row['Season'] == 2015 or  row['Season'] == 2016:
        if ( row['DayNum'] == 137 or row['DayNum'] == 138):
            return '1'
        if ( row['DayNum'] == 139 or row['DayNum'] == 140):
            return '2'
        if ( row['DayNum'] == 144 or row['DayNum'] == 145):
            return '3'
        if ( row['DayNum'] == 146 or row['DayNum'] == 147):
            return '4'
        if ( row['DayNum'] == 153):
            return 'SemiFinal'
        if ( row['DayNum'] == 155):
    ...
    if row['Season'] == 2017 :
        ...
        if ( row['DayNum'] == 153):
            return 'Final'
    return '0'    
tourneycompactresults['round_num'] = tourneycompactresults.apply (lambda row: round_number (row),axis=1)
