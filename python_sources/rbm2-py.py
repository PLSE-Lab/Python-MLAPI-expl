...
movies = pd.read_csv('../input/ml1mm/movies.dat', sep = '::', header = None, engine = 'python',encoding = 'latin-1')
users = pd.read_csv('../input/ml1mm/users.dat', sep = '::', header = None, engine = 'python',encoding = 'latin-1')
ratings = pd.read_csv('../input/ml1mm/ratings.dat', sep = '::', header = None, engine = 'python',encoding = 'latin-1')
...
#movies title
movie_title = pd.read_csv('ml-1mm/movies.dat', sep = '::', header = None, engine = 'python',encoding = 'latin-1')
