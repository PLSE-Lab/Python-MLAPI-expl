...
train_X,test_X, train_y ,test_y = train_test_split(iris[['SepalLengthCm','SepalWidthCm','PetalLengthCm','PetalWidthCm']],iris.Species, test_size = 0.3)# in this our main data is split into train and test
