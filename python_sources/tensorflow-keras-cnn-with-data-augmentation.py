...
# 
# One more bit of analysis before wrapping up: Print out the confusion matrix to look at what the model is mispredicting.  
...
# Well, that's enough to get familiar with the Kaggle environment.  No need to beat this digit example to death.  Thanks for reading. 
