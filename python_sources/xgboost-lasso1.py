...
label_df["SalePrice"].to_csv('label1.csv', header=True, index_label='Id')
label_df.to_csv('label.csv', header=True, index_label='Id')
train_df_munged.to_csv('trainmunged.csv', header=True, index_label='Id')
test_df_munged.to_csv('testmunged.csv', header=True, index_label='Id')
