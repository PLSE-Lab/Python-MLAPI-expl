# Fork from Alexander Larko using sklearn ensemble (RF+logRegr)
# https://www.kaggle.com/alexxanderlarko/santander-product-recommendation/ens2710/code
...
for c in df_train.columns:
    if c != 'ncodpers':
        ...
        clf = ensemble.RandomForestClassifier(n_estimators=30, n_jobs=-1,max_depth=10, min_samples_split=10, verbose=1)
        ...
        p_train = p_train1*0.45+p_train2*0.1+p_train3*0.45 
...
sample.to_csv('ens2710-mod.csv', index=False)
