...
# As repos "facebook/react" and "Microsoft/vscode" have a very small number, they do not show a proper visualization in above pie plot. Lets try using a barplot.
