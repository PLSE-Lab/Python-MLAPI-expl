...
df1 = pd.read_csv('../input/genome_scores.csv', delimiter=',', nrows = nRowsRead)
...
# ### Let's check 2nd file: ../input/genome_tags.csv
...
df2 = pd.read_csv('../input/genome_tags.csv', delimiter=',', nrows = nRowsRead)
...
# ### Let's check 3rd file: ../input/link.csv
...
df3 = pd.read_csv('../input/link.csv', delimiter=',', nrows = nRowsRead)
