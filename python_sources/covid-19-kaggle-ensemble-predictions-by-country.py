...
#     print(wk1.columns)
    ...
    gb = ['Country_Region', 'SubmissionId', 'Date']
...
#     print(wk1)
    states = wk1.groupby('Country_Region').FatalitiesActual.max().sort_values(ascending=False).index
...
#                                             visible=(region_name==default_state)
    ...
    fig_fatalities.update_layout(showlegend=False, 
...
#     default_state = "California"
    ...
    for region_name in states:
        ...
        fig_cases.add_trace(go.Box(x=region["Date"], y=region["ConfirmedCases"], 
#                                    visible=(region_name==default_state)
                                  ))
        fig_cases.add_trace(go.Scatter(x=region_actual["Date"], y=region_actual["ConfirmedCasesActual"],
                                       line={}, 
#                                        visible=(region_name==default_state)
                                      ))
