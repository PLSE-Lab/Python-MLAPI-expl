...
plt.subplot(1,2,1);
plt.plot(df[df.symbol == 'XYL'].open.values, color='red', label='open')
plt.plot(df[df.symbol == 'XYL'].close.values, color='green', label='close')
plt.plot(df[df.symbol == 'XYL'].low.values, color='blue', label='low')
plt.plot(df[df.symbol == 'XYL'].high.values, color='black', label='high')
...
plt.subplot(1,2,2);
plt.plot(df[df.symbol == 'XYL'].volume.values, color='black', label='volume')
...
# choose one stock
df_stock = df[df.symbol == 'XYL'].copy()
