...
# 
# <br>
# This kernel is meant for learning purposes, In this kernel, I have explained 3D convolutions and their implementation on 3D MNIST dataset. In one of my previous [kernel](https://www.kaggle.com/shivamb/a-very-comprehensive-tutorial-nn-cnn), I have shared the working of convolutional neural networks for images. 
# 
...
# The model may not be very accurate at this point of time, But with hyperparamter tuning one can achieve a good accuracy with 3D convolutional networks. The model can be improved further with architectural changes and hyperparameter tuning. 
# 
# Thanks for viewing, **Do Upvote** the kernel if you liked it. 
