# -*- coding: utf-8 -*-
"""
Created on Thu Apr 14 15:17:01 2016
...
print ('Training...')
forest = RandomForestClassifier(n_estimators=50,min_samples_split=5, min_samples_leaf=5)
...
predictions_file = open("RFmin5.csv", "wt")
