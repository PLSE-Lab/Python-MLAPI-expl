...
class ConvLayer(object):
	...
	def __init__(self, input, filter_shape, image_shape, padding=(0, 0), 
		...
		b_vals = rng.uniform(size=filter_shape[0])
...
def rmsprop(l_rate, d_rate=0.9, epsilon=1e-6, parameters=None, grads=None):
	...
	:type d_rate: theano.tensor.scalar
	:param: Decay rate
	...
	----------
	list
	    returns a list of updates for the required parameters
	"""
...
# 	location = '...\\Kaggle\\MNIST\\augmented_train.npy'
# 	location_test = '...\\Kaggle\\MNIST\\test_padded.npy'
# 	loc_submission = '...\\Kaggle\\MNIST\\Results\\submission.csv'
...
# 	label = label[:28001].astype(np.int8)
