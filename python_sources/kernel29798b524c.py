...
test_missing_pred =  model.predict_generator(test_gen,steps=len(test_gen),verbose=1)
...
checkpoint = ModelCheckpoint('model.h5',  monitor='val_loss',  verbose=0,  save_best_only=True,  save_weights_only=False,
            mode='auto')
