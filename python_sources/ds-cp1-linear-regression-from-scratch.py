...
possible_ms = [-10 + 0.1 * i for i in range(201)] #your list comprehension here
print(possible_ms)
...
possible_bs =  [-20 + 0.1 * i for i in range(401)] #your list comprehension here
print(possible_bs)
