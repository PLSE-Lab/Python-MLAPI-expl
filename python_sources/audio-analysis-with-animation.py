...
get_ipython().system('ln -s ../input/LANL-Earthquake-Prediction/sample_submission.csv ../input/sample_submission.csv')
get_ipython().system('ln -s ../input/LANL-Earthquake-Prediction/test ../input/test')
get_ipython().system('ln -s ../input/LANL-Earthquake-Prediction/train.csv ../input/train.csv')
...
get_ipython().system("awk 'NR == 1 || NR % 200 == 0'  ../input/train.csv > ./train_every_Nth.csv")
...
get_ipython().system('sox {AUDIO}.wav {AUDIO}_noise.wav trim 7.383 0.451')
# creating noise profile before removing
get_ipython().system('sox {AUDIO}_noise.wav -n noiseprof {AUDIO}_noise.prof')
# here we're remoiving the noise
get_ipython().system('sox {AUDIO}.wav {AUDIO}_clean.wav noisered {AUDIO}_noise.prof 0.15')
...
get_ipython().system('mkdir -p $HOME/.imageio/ffmpeg/')
get_ipython().system('cp ../input/skrillex-codecs/ffmpeg-linux64-v3.3.1   $HOME/.imageio/ffmpeg/ffmpeg-linux64-v3.3.1')
get_ipython().system('cp ../input/skrillex-codecs/moviepy-0.2.3.5.tar.gz_ ./moviepy-0.2.3.5.tar.gz')
get_ipython().system('pip install ./moviepy-0.2.3.5.tar.gz')
get_ipython().system('rm ./moviepy-0.2.3.5.tar.gz')
