...
# 
# Let's look at some examples. We'll start with the scatter plot. Suppose that we are interested in seeing which type of offensive players tends to get paid the most: the striker, the right-winger, or the left-winger.

# In[ ]:


footballers.loc[footballers["Position"].isin(["ST", "RW", "LW"])]
