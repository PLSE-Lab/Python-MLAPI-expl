...
inc_path = '../input/inceptionv3/inception_v3_weights_tf_dim_ordering_tf_kernels_notop.h5'

# Creating CNN
cnn_model = InceptionV3(weights=inc_path, include_top=False, input_tensor=input_tensor)
...
#checkpointer = ModelCheckpoint(filepath="./finetuned_cnn_rnn_weights_2.hdf5", verbose=1, save_best_only=True,
                              # monitor='val_acc')
#history=model.fit_generator(train_generator, samples_per_epoch=540, nb_epoch=nb_epochs, verbose=1, validation_data=val_generator,nb_val_samples=nb_val_samples)
