...
for i in range(NRUNS):
    ...
    filename = '../positivedata/sample' + str(i) + '.pkl.gz'
...
##### THE TEST DATA #####
    ...
    df = pd.read_csv("../talkingdata-adtracking-fraud-detection/test.csv", dtype=dtypes, usecols=test_cols)
...
print("writing....")
sub.to_csv('gpu_test2.csv', index=False, float_format='%.9f')
print("Done")
