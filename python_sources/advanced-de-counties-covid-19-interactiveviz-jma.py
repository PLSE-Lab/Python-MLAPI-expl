...
df = pd.read_csv('../input/covid19-tracking-germany/covid_de.csv')
df.head()
...
dfd[['cases','deaths']].iplot(title = 'DE Counties Situation Over Time')
...
df_st_ct = pd.value_counts(df['county'])
