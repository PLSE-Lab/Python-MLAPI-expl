...
# # How to Query Intellectual Property Investigations by the USITC (BigQuery)
...
# ## Example SQL Query
# What are the possible current statuses of all the investigations?
...
# Interpretting this number, this means my query scanned almost 0GB of data in order to return a table of unique current statuses from the dataset.
