...
captions = np.load("../input/automated-image-captioning-flickr8/captions.npy")
next_words = np.load("../input/automated-image-captioning-flickr8/next_words.npy")
...
with open('../input/automated-image-captioning-flickr8/train_encoded_images.p', 'rb') as f:
...
images = np.load("../input/automated-image-captioning-flickr8/images.npy")
...
image_names = np.load("../input/automated-image-captioning-flickr8/image_names.npy")
print(len(image_names))
...
imag = np.load("../input/automated-image-captioning-flickr8/image_names.npy")
...
model.load_weights("../input/automated-image-captioning-flickr8/model_weights.h5")
...
# x= get_encoding(model,"../input/flickr8k/flickr_data/Flickr_Data/Images/1453366750_6e8cf601bf.jpg")
...
img = "../input/fashion-product-images-small/myntradataset/images/13921.jpg"
test_img = get_encoding(resnet, img)
