...
# This function takes a piece of data and converts it using transform_ts() and it does to each of the 3 phases
...
# The X shape here is very important. It is also important to undertand a little bti as to how a LSTM works
