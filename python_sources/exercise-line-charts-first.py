...
sns.lineplot(data=museum_data) #From the data,we can clearly understand that events are important as 
#the viwership of the firehouse museum soared during that time(2014) 
...
plt.title("Monthly Visitors for Avila Adobe")
# Check your answer
step_4.a.check()
...
#The no of Visitors spikes during the months of March and August which can be observed from our graph.
