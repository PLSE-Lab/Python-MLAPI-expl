...
#print('\nCategorical columns that will be dropped from the dataset:', high_cardinality_cols_test)
...
# (Optional) Your code here y_train, y_valid
...
print(final_X_valid.index)


# In[ ]:


print(OH_X_valid.index)
