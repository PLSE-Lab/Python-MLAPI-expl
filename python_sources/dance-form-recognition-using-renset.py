...
train = pd.read_csv('../input/dance-form-classification-1/train.csv')
test = pd.read_csv('../input/dance-form-classification-1/test.csv')
...
for img in list(test['Image']):
  test_imgdir.append('../input/dance-form-classification-1/test.csv' + str(img))
print(test_imgdir)
...
for img in list(train['Image']):
  train_imgdir.append('../input/dance-form-classification-1/train.csv' + str(img))
print(train_imgdir)
...
for img,label in zip(train_imgdir , train_label):
  ...
  #io.imsave('./dataset/train/'+ name + 'ipdown_img.jpg' , updown_img)
  ...
  #extend_train_imgdir.append('./dataset/train/'+ name + 'ipdown_img.jpg' )
...
loss_epoch_arr = []
max_epochs =2
opt = optim.Adam(model.parameters(),lr=0.0000135)
min_loss = 1000
...
df_final.to_csv('submission_dance.csv', index=False)
...
files.download('submission_dance.csv')
