...
# Make symlinks
get_ipython().system('cp -as "$(pwd)/../input/10-monkey-species/" "$(pwd)/COPY"')


# In[ ]:


# Make sure we made symlinks
get_ipython().system('ls COPY/training/training/n0')
...
train_dir = Path('COPY/training/training/')
test_dir = Path('COPY/validation/validation/')
