...
def support_vector_machine(train_data,train_label,test_data):
    ...
    svm_dr = svm.SVC(kernel='linear', C=10,  class_weight='balanced') 
    svm_dr.fit(train_x, ravel(train_label)) 
    
    # print train accuracy
    print("training accuracy: ", svm_dr.score(train_x,ravel(train_label)))
    # print("training accuracy: ", svm_dr.score(train_x,train_label))
