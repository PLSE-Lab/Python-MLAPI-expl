...
get_ipython().run_cell_magic('time', '', "datadir = Path('/kaggle/input/covid19-global-forecasting-week-3')\n\n# Read in the data CSV files\ntrain = pd.read_csv(datadir/'train.csv')\ntest = pd.read_csv(datadir/'test.csv')\nsubmission = pd.read_csv(datadir/'submission.csv')")
...
# 
# Confirmed cases reached 593K people, and **27K people already died at March 27**.<br/>
# Confirmed cases reached 932K people, and **75K people already died at April 1**. It's matter of time until confirmed cases reaches **1M**.
...
# We see that mortality rate is kept almost 3%, however it is slightly **increasing recently to go over 5%** at the beginning of April.
# 
...
#  - Current US new confirmed cases are the worst speed, recording worst speed at 25k people/day. Despite the lock down policy, its spread speed is not slowing down so far...
