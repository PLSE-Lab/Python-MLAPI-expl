...
#np.savetxt('maximums.txt', mask.astype(int),delimt)# This Python 3 environment comes with many helpful analytics libraries installed
# It is defined by the kaggle/python docker image: https://github.com/kaggle/docker-python
# For example, here's several helpful packages to load in 
...
xmax, ymin, W, H=get_size("6170_4_1")
img_mask = np.zeros((W,H),np.uint8)
for i in range(1,10):
    mask = generate_mask_for_image_and_class((W,H),"6170_4_1",i,gs,df)
cv2.imwrite("6170_4_1mask.png",mask)
