...
get_ipython().system('unzip -q ../input/tgs-salt-identification-challenge/train.zip -d train/')
get_ipython().system('unzip -q ../input/tgs-salt-identification-challenge/test.zip -d test/')
