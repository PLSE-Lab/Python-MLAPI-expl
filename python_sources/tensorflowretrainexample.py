...
RETRAIN_FILES_PATH = "/new_disk/myfolder/data/statefarm/retrain/"
TRAIN_PATH = "/new_disk/myfolder/data/statefarm/train"
TEST_PATH = "/new_disk/myfolder/data/statefarm/test"
...
tf.app.flags.DEFINE_string('image_dir', TRAIN_PATH,
                           """Path to folders of labeled images.""")
tf.app.flags.DEFINE_string('output_graph', RETRAIN_FILES_PATH+'output_graph.pb',
                           """Where to save the trained graph.""")
tf.app.flags.DEFINE_string('output_labels', RETRAIN_FILES_PATH+'output_labels.txt',
                           """Where to save the trained graph's labels.""")
tf.app.flags.DEFINE_string('summaries_dir', RETRAIN_FILES_PATH+'retrain_logs',
...
tf.app.flags.DEFINE_string('model_dir', RETRAIN_FILES_PATH+'imagenet',
                           """Path to classify_image_graph_def.pb, """
                           """imagenet_synset_to_human_label_map.txt, and """
                           """imagenet_2012_challenge_label_map_proto.pbtxt.""")
tf.app.flags.DEFINE_string(
    'bottleneck_dir', RETRAIN_FILES_PATH+'/bottleneck',
