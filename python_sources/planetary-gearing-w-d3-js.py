...
# # Introduction
# 
# Based on Mike Bostock's brilliant D3.js examples. Testing it on an Ipython notebook
...
with open("epicyclic_gearing.html","wb") as outfile:
...
display(HTML('epicyclic_gearing.html'))
