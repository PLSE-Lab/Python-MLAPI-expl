...
# # KNN (K Neirest Neighbour) Algorithm Implementation on Cancer Dataset
...
# 4. Determine which class the point being tested belongs to.
...
# 4. Conclusion: our point belongs to the Malignant class.
...
# If our k value equals to 4, it gives best result.
