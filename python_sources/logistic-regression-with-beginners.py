...
# Firstly, 
# 
# import libraries, and read data, I choose (heart-disease-prediction-using-logistic-regression : framingham.csv)
...
# And we need to split our data and use sklearn.train_test_split, train_data is %80, test_data is %20
# 
