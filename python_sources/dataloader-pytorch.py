...
full_data = VowelConsonantDataset("../input/padhai-tamil-vow-cons-classification/train/train",train=True,transform=transform)
...
test_data = VowelConsonantDataset("../input/padhai-tamil-vow-cons-classification/test/test",train=False,transform=transform)
