...
# 
# ## Finding insights in the Titanic dataset using visualization techniques we introduced above
# 
# Requirements: 
# - Use at least two of: univaliate analysis, bivariate analysis, multivariate analysis.
# - Analyse at least 4 columns (features) in the dataset.
# - Submit a paragraph describing your findings along with the visulaization.
# 
# ---
# 
