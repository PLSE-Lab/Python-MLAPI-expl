...
get_ipython().run_line_magic('pinfo2', 'LogisticRegression.score')
...
models = pd.DataFrame(
    {'Models' : ['Support Vector Machine', 'KNN', 'Logistic Regression', 'Random Forest', 'Naive Bayes',
...
submission_df.to_csv('MyThirdSubmissionFile.csv', index_label = False, index = False)
