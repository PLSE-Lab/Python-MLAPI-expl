...
PATH = '../input/movie-review-sentiment-analysis-kernels-only'
os.listdir(PATH)
...
get_ipython().system('unzip ../input/movie-review-sentiment-analysis-kernels-only/train.tsv.zip')


# In[ ]:


get_ipython().system('unzip ../input/movie-review-sentiment-analysis-kernels-only/test.tsv.zip')
...
# ### Training Logistic Regression model and an SVM.
