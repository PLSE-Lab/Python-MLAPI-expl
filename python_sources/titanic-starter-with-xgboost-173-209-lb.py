...
get_ipython().run_cell_magic('time', '', 'cv_grid(tops, t_list=seq(0.5, 0.9, 0.1), kf=False)')


# In[ ]:


get_ipython().run_cell_magic('time', '', 'cv_grid(voters, t_list=seq(0.5, 0.9, 0.1), kf=False)')
