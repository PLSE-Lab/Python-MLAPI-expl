...
# 
# I am not going to repeat the theory behind what we are trying to do in this competition as that has been covered extensively in above kernels. 
...
# 
# I have shown how to load the model weights that I get from this code in another kernel here.
...
# **Let's look at the model performance from accuracy and loss point of view**
