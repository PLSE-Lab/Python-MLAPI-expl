...
# # **NOTE:** I have forked the Yassine Ghouzam kerner, in order to use his data preprocessing analysis
...
#Let's separate the train dataset and test
...
# ## 6. MODELING: Beginning of own ML architecture
...
clf=xgb_model(x_train,y_train,x_val, y_val)
...
y_test = pd.Series(clf.predict(x_test), name="Survived")
