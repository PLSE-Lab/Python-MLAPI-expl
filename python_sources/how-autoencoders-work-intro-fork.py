...
# * Fork from : https://www.kaggle.com/shivamb/how-autoencoders-work-intro-and-implementation
# * change hyperparams
# 
...
#     * Epoch 20/20 - loss: 0.0198 - val_loss: 0.0195
...
#     * Epoch 10/10  - loss: 0.0942 - val_loss: 0.0941

# In[ ]:


early_stopping = EarlyStopping(monitor='val_loss', min_delta=0, patience=2, verbose=5, mode='auto')
...
## Uncomment and run the predictions for the trained model
