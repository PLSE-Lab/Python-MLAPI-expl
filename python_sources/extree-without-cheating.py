...
print(target)
print('Training...')
# extc = ExtraTreesClassifier(n_estimators=850,max_features= 29,criterion= 'entropy',min_samples_split= 4,
#                             max_depth= 40, min_samples_leaf= 1, n_jobs = -1) 
                            
extc=RandomForestClassifier(n_estimators=1000,max_features='sqrt',criterion= 'gini',min_samples_split= 4,
                            max_depth= 40, min_samples_leaf= 1, n_jobs = -1)
