...
get_ipython().system('pip install python-vivid')
...
stacking_stacking_knn     = KNeighborRegressorOutOfFold(name='stacking_stacking_knn', parent=stackings)
