...
# #### This Kernel is base on [taqanori](https://www.kaggle.com/taqanori), here I applied CatBoostRegressor and RandomForestRegressor follow the discussion post from [tossy0917](https://www.kaggle.com/c/LANL-Earthquake-Prediction/discussion/89979#latest-520301) and [AC_datascientist](https://www.kaggle.com/azc2019) inspire by [this paper](https://agupubs.onlinelibrary.wiley.com/action/downloadSupplement?doi=10.1002%2F2017GL074677&file=grl56367-sup-0001-supinfo.pdf) and excellent comment from [BigIronSphere](https://www.kaggle.com/bigironsphere) and [Ehsan](https://www.kaggle.com/safavieh).
...
# ##Reference  
# [jazivxt](https://www.kaggle.com/jazivxt/aftershock)  
# [tossy0917](https://www.kaggle.com/toshiharuokada)  
# [BigIronSphere](https://www.kaggle.com/bigironsphere)  
# [Ehsan](https://www.kaggle.com/safavieh)
# [Andrew Lukyanenko](https://www.kaggle.com/artgor/feature-selection-model-interpretation-and-more)
