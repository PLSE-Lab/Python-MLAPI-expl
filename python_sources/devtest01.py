...
# Just this year
d=d[(d.Dispatch_Date_Time	 >= "2016-11-01 00:00:00")]
...
k=d[(d.Text_General_Code == 'Theft from Vehicle')]
...
for i in range(0,len(lat)):
    ...
    s+="['%s', %s, %s, %s,'https://storage.googleapis.com/montco-stats/images/theftFromVehicle.png'],\n" % (displayTitle,lat[i],lng[i],i)
